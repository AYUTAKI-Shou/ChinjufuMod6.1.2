...
public class KK_SwordfishEntity3 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_SwordfishEntity3.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.SWORDFISH);

	public KK_SwordfishEntity3(EntityType<KK_SwordfishEntity3> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_SwordfishEntity3(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
