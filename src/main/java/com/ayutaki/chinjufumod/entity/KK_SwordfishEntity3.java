...
public class KK_SwordfishEntity3 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_SwordfishEntity3.class, DataSerializers.VARINT);
	...
	public KK_SwordfishEntity3(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.SWORDFISH, entity, worldIn);
