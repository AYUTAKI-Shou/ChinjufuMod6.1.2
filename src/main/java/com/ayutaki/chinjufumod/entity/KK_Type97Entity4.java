...
public class KK_Type97Entity4 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_Type97Entity4.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.TYPE97KK);

	public KK_Type97Entity4(EntityType<KK_Type97Entity4> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_Type97Entity4(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
		super(EntityTypes_CM.TYPE97, entityIn, worldIn);
