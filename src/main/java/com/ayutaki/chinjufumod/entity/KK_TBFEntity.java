...
public class KK_TBFEntity extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_TBFEntity.class, DataSerializers.INT);
	...
	public KK_TBFEntity(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
