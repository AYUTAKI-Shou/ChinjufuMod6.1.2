...
public class EntitySittableBlock extends Entity {
	...
	public EntitySittableBlock(World worldIn, double x, double y, double z, double y0ffset) {
		this(worldIn);
	...
	public EntitySittableBlock(World worldIn, double x, double y, double z, double y0ffset, int rotation, double rotationOffset) {
		this(worldIn);
		this.blockPosX = (int) x;
		this.blockPosY = (int) y;
		this.blockPosZ = (int) z;
