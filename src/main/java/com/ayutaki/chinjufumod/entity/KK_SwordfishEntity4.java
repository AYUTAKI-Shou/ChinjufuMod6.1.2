...
public class KK_SwordfishEntity4 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_SwordfishEntity4.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.SWORDFISH);

	public KK_SwordfishEntity4(EntityType<KK_SwordfishEntity4> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_SwordfishEntity4(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
		super(EntityTypes_CM.SWORDFISH, entityIn, worldIn);
