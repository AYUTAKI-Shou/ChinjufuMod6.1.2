...
public class KK_SwordfishEntity4 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_SwordfishEntity4.class, DataSerializers.VARINT);
	...
	public KK_SwordfishEntity4(LivingEntity entity, World worldIn, ItemStack stack) {
