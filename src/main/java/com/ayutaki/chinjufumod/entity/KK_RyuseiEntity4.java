...
public class KK_RyuseiEntity4 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_RyuseiEntity4.class, DataSerializers.VARINT);
	...
	public KK_RyuseiEntity4(LivingEntity entity, World worldIn, ItemStack stack) {
