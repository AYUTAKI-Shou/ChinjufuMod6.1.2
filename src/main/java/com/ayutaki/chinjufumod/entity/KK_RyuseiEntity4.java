...
public class KK_RyuseiEntity4 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_RyuseiEntity4.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.RYUSEI);

	public KK_RyuseiEntity4(EntityType<KK_RyuseiEntity4> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_RyuseiEntity4(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
