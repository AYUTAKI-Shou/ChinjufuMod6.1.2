...
public class KK_TenzanEntity2 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_TenzanEntity2.class, DataSerializers.INT);
	...
	public KK_TenzanEntity2(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
