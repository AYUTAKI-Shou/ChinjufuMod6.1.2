...
public class KK_TenzanEntity2 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_TenzanEntity2.class, DataSerializers.VARINT);
	private ItemStack stack = new ItemStack(Items_Weapon.TENZAN);

	public KK_TenzanEntity2(EntityType<KK_TenzanEntity2> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_TenzanEntity2(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.TENZAN, entity, worldIn);
