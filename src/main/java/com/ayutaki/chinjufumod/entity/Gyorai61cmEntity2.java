...
public class Gyorai61cmEntity2 extends ThrowableEntity implements IRendersAsItem {

	private ItemStack stack = new ItemStack(Items_Weapon.GYORAI_61cm);

	public Gyorai61cmEntity2(EntityType<Gyorai61cmEntity2> type, World worldIn) {
		super(type, worldIn);
	}

	public Gyorai61cmEntity2(LivingEntity entity, World worldIn, ItemStack stack) {
