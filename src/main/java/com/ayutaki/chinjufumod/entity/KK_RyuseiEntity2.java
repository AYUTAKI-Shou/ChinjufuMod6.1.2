...
public class KK_RyuseiEntity2 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_RyuseiEntity2.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.RYUSEI);

	public KK_RyuseiEntity2(EntityType<KK_RyuseiEntity2> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_RyuseiEntity2(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
