...
public class KK_RyuseiEntity2 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_RyuseiEntity2.class, DataSerializers.VARINT);
	...
	public KK_RyuseiEntity2(LivingEntity entity, World worldIn, ItemStack stack) {
