...
public class KK_Ju87Entity3 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_Ju87Entity3.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.JU87);

	public KK_Ju87Entity3(EntityType<KK_Ju87Entity3> type, World world) {
		super(type, world);
	}

	public KK_Ju87Entity3(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
