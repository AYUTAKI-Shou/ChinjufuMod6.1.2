...
public class KK_Ju87Entity3 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_Ju87Entity3.class, DataSerializers.VARINT);
	private ItemStack stack = new ItemStack(Items_Weapon.JU87);

	public KK_Ju87Entity3(EntityType<KK_Ju87Entity3> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_Ju87Entity3(LivingEntity entity, World worldIn, ItemStack stack) {
