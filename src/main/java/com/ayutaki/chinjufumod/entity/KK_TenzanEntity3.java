...
public class KK_TenzanEntity3 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_TenzanEntity3.class, DataSerializers.VARINT);
	private ItemStack stack = new ItemStack(Items_Weapon.TENZAN);

	public KK_TenzanEntity3(EntityType<KK_TenzanEntity3> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_TenzanEntity3(LivingEntity entity, World worldIn, ItemStack stack) {
