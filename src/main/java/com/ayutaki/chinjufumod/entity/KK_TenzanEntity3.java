...
public class KK_TenzanEntity3 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_TenzanEntity3.class, DataSerializers.INT);
	...
	public KK_TenzanEntity3(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
