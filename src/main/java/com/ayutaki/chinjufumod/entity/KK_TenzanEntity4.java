...
public class KK_TenzanEntity4 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_TenzanEntity4.class, DataSerializers.VARINT);
	...
	public KK_TenzanEntity4(LivingEntity entity, World worldIn, ItemStack stack) {
