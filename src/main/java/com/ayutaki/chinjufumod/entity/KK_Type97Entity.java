...
public class KK_Type97Entity extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_Type97Entity.class, DataSerializers.VARINT);
	...
	public KK_Type97Entity(LivingEntity entity, World worldIn, ItemStack stack) {
