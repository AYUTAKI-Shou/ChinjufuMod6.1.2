...
public class KK_Type97Entity extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_Type97Entity.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.TYPE97KK);

	public KK_Type97Entity(EntityType<KK_Type97Entity> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_Type97Entity(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
