...
public class KK_SwordfishEntity2 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_SwordfishEntity2.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.SWORDFISH);

	public KK_SwordfishEntity2(EntityType<KK_SwordfishEntity2> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_SwordfishEntity2(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
