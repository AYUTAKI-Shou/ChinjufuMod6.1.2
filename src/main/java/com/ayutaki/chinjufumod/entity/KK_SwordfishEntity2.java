...
public class KK_SwordfishEntity2 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_SwordfishEntity2.class, DataSerializers.VARINT);
	...
	public KK_SwordfishEntity2(LivingEntity entity, World worldIn, ItemStack stack) {
