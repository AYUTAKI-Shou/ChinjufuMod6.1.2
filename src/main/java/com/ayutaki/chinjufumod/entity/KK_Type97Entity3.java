...
public class KK_Type97Entity3 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_Type97Entity3.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.TYPE97KK);

	public KK_Type97Entity3(EntityType<KK_Type97Entity3> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_Type97Entity3(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
