...
public class KK_Type97Entity3 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_Type97Entity3.class, DataSerializers.VARINT);
	...
	public KK_Type97Entity3(LivingEntity entity, World worldIn, ItemStack stack) {
