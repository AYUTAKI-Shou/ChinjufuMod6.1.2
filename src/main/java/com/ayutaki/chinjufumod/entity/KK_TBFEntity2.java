...
public class KK_TBFEntity2 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_TBFEntity2.class, DataSerializers.VARINT);
	...
	public KK_TBFEntity2(LivingEntity entity, World worldIn, ItemStack stack) {
