...
public class KK_TBFEntity2 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_TBFEntity2.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.TBF);

	public KK_TBFEntity2(EntityType<KK_TBFEntity2> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_TBFEntity2(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
