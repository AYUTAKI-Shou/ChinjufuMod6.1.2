...
public class KK_RyuseiEntity3 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_RyuseiEntity3.class, DataSerializers.VARINT);
	...
	public KK_RyuseiEntity3(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.RYUSEI, entity, worldIn);
