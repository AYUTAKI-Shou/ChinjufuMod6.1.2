...
public class KK_RyuseiEntity3 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_RyuseiEntity3.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.RYUSEI);

	public KK_RyuseiEntity3(EntityType<KK_RyuseiEntity3> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_RyuseiEntity3(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
		super(EntityTypes_CM.RYUSEI, entityIn, worldIn);
