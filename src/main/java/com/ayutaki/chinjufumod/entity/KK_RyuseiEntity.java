...
public class KK_RyuseiEntity extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_RyuseiEntity.class, DataSerializers.VARINT);
	...
	public KK_RyuseiEntity(LivingEntity entity, World worldIn, ItemStack stack) {
