...
public class KK_RyuseiEntity extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_RyuseiEntity.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.RYUSEI);

	public KK_RyuseiEntity(EntityType<KK_RyuseiEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_RyuseiEntity(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
