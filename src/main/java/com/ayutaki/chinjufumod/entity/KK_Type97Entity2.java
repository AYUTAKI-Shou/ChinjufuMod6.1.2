...
public class KK_Type97Entity2 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_Type97Entity2.class, DataSerializers.VARINT);
	...
	public KK_Type97Entity2(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.TYPE97, entity, worldIn);
