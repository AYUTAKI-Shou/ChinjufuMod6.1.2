...
/* エンティティなどで呼び出せば使える */
public class CMUchiwakaze extends Explosion {
	...
	public CMUchiwakaze(World worldIn, Entity entityIn, double x, double y, double z, float size, List<BlockPos> affectedPositions) {
		this(worldIn, entityIn, x, y, z, size, false, true, affectedPositions);
	}

	@SideOnly(Side.CLIENT)
	public CMUchiwakaze(World worldIn, Entity entityIn, double x, double y, double z, float size,
	...
	public CMUchiwakaze(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean damagesTerrain) {
