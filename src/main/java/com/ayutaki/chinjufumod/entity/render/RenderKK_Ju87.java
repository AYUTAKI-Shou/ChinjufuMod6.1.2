...
public class RenderKK_Ju87 extends EntityRenderer<KK_Ju87Entity> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKK_Ju87(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
		this.itemRenderer = itemRenderer;
		this.shadowSize = 0.3F; //EntityRenderer
		this.shadowOpaque = 1.0F;
	}

	public void render(KK_Ju87Entity entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
		matrixStack.push();
	...
	@Override
	public ResourceLocation getEntityTexture(KK_Ju87Entity entity) {
		return null;
	}
