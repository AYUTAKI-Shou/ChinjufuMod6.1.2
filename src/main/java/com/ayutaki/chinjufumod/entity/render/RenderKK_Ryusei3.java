...
public class RenderKK_Ryusei3 extends EntityRenderer<KK_RyuseiEntity3> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKK_Ryusei3(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_RyuseiEntity3 entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(KK_RyuseiEntity3 entity) {
		return null;
	}
