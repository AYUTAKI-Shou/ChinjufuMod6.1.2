...
public class RenderKK_Tenzan4 extends EntityRenderer<KK_TenzanEntity4> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKK_Tenzan4(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_TenzanEntity4 entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(KK_TenzanEntity4 entity) {
		return null;
	}
