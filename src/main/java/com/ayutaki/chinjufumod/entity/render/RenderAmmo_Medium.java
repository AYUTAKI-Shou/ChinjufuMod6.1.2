...
public class RenderAmmo_Medium<T extends AmmoAbstract_Entity> extends EntityRenderer<T> {

	public RenderAmmo_Medium(EntityRendererManager renderManager) {
		super(renderManager);
	}

	@Override
	public ResourceLocation getEntityTexture(AmmoAbstract_Entity entity) {
		return new ResourceLocation(ChinjufuMod.MOD_ID, "textures/entity/projectiles/ammunition_entity.png");
	}
