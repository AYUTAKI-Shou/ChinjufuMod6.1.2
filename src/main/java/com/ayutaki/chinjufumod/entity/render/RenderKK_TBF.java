...
public class RenderKK_TBF extends EntityRenderer<KK_TBFEntity> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKK_TBF(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_TBFEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(KK_TBFEntity entity) {
		return null;
	}
