...
public class RenderKK_Type97_4 extends EntityRenderer<KK_Type97Entity4> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKK_Type97_4(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_Type97Entity4 entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(KK_Type97Entity4 entity) {
		return null;
	}
