...
public class RenderKK_Swordfish2 extends EntityRenderer<KK_SwordfishEntity2> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKK_Swordfish2(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_SwordfishEntity2 entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
	...
	@Override
	public ResourceLocation getTextureLocation(KK_SwordfishEntity2 entity) {
		return null;
	}
