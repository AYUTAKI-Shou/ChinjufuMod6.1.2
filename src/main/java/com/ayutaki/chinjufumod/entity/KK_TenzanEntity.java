...
public class KK_TenzanEntity extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_TenzanEntity.class, DataSerializers.INT);
	...
	public KK_TenzanEntity(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
