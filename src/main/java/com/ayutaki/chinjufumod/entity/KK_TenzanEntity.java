...
public class KK_TenzanEntity extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_TenzanEntity.class, DataSerializers.VARINT);
	private ItemStack stack = new ItemStack(Items_Weapon.TENZAN);

	public KK_TenzanEntity(EntityType<KK_TenzanEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_TenzanEntity(LivingEntity entity, World worldIn, ItemStack stack) {
