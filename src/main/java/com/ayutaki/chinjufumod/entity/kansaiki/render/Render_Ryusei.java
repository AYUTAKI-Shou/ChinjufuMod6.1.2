...
public class Render_Ryusei<T extends Entity_Ryusei> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Ryusei(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
