...
public class Entity_Swordfish extends EntityThrowable {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(Entity_Swordfish.class, DataSerializers.VARINT);
	private ItemStack stack = ItemStack.EMPTY;

	public Entity_Swordfish(World worldIn) {
		super(worldIn);

		setSize(2.0F, 2.0F);
	}

	public Entity_Swordfish(World worldIn, EntityLivingBase entity, ItemStack stack) {
