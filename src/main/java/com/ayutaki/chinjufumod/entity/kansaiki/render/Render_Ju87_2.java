...
public class Render_Ju87_2<T extends Entity_Ju87_2> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Ju87_2(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
