...
public class Render_Tenzan4<T extends Entity_Tenzan4> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Tenzan4(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
