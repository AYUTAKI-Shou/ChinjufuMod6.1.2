...
public class Render_Tenzan2<T extends Entity_Tenzan2> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Tenzan2(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
