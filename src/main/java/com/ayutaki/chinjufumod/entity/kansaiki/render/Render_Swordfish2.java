...
public class Render_Swordfish2<T extends Entity_Swordfish2> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Swordfish2(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
