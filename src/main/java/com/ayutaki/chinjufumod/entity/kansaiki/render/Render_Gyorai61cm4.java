...
public class Render_Gyorai61cm4<T extends Entity_Gyorai61cm4> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Gyorai61cm4(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
