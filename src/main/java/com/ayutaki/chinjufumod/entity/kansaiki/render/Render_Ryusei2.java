...
public class Render_Ryusei2<T extends Entity_Ryusei2> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Ryusei2(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
