...
public class Render_Ryusei4<T extends Entity_Ryusei4> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Ryusei4(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
