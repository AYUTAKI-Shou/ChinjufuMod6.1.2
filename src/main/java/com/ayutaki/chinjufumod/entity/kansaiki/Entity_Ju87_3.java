...
public class Entity_Ju87_3 extends EntityThrowable {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(Entity_Ju87_3.class, DataSerializers.VARINT);
	private ItemStack stack = ItemStack.EMPTY;

	public Entity_Ju87_3(World worldIn) {
		super(worldIn);

		setSize(2.0F, 2.0F);
	}

	public Entity_Ju87_3(World worldIn, EntityLivingBase entity, ItemStack stack) {
