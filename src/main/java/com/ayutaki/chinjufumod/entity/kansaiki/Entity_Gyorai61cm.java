...
public class Entity_Gyorai61cm extends EntityThrowable {

	private ItemStack stack = ItemStack.EMPTY;

	public Entity_Gyorai61cm(World worldIn) {
		super(worldIn);

		setSize(1.0F, 1.0F);
	}

	public Entity_Gyorai61cm(World worldIn, EntityLivingBase entity, ItemStack stack) {
