...
public class Render_Type97_3<T extends Entity_Type97_3> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Type97_3(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
