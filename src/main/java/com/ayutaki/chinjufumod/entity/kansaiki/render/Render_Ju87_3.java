...
public class Render_Ju87_3<T extends Entity_Ju87_3> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Ju87_3(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
