...
public class Render_Swordfish3<T extends Entity_Swordfish3> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Swordfish3(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
