...
public class Render_Swordfish<T extends Entity_Swordfish> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Swordfish(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
