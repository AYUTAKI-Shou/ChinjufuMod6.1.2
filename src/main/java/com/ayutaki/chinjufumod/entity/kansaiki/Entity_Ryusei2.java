...
public class Entity_Ryusei2 extends EntityThrowable {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(Entity_Ryusei2.class, DataSerializers.VARINT);
	private ItemStack stack = ItemStack.EMPTY;

	public Entity_Ryusei2(World worldIn) {
		super(worldIn);

		setSize(2.0F, 2.0F);
	}

	public Entity_Ryusei2(World worldIn, EntityLivingBase entity, ItemStack stack) {
