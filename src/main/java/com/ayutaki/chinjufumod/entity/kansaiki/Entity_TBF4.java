...
public class Entity_TBF4 extends EntityThrowable {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(Entity_TBF4.class, DataSerializers.VARINT);
	private ItemStack stack = ItemStack.EMPTY;

	public Entity_TBF4(World worldIn) {
		super(worldIn);

		setSize(2.0F, 2.0F);
	}

	public Entity_TBF4(World worldIn, EntityLivingBase entity, ItemStack stack) {
