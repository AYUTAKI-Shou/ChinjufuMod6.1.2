...
public class Render_Swordfish4<T extends Entity_Swordfish4> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Swordfish4(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
