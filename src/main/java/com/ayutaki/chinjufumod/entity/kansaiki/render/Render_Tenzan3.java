...
public class Render_Tenzan3<T extends Entity_Tenzan3> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Tenzan3(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
