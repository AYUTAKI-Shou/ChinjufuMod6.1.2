...
public class Render_Type97_4<T extends Entity_Type97_4> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Type97_4(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
