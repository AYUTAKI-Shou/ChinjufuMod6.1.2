...
public class Render_Gyorai61cm<T extends Entity_Gyorai61cm> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Gyorai61cm(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
