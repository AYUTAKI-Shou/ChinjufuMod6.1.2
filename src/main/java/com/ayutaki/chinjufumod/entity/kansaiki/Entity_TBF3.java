...
public class Entity_TBF3 extends EntityThrowable {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(Entity_TBF3.class, DataSerializers.VARINT);
	private ItemStack stack = ItemStack.EMPTY;

	public Entity_TBF3(World worldIn) {
		super(worldIn);

		setSize(2.0F, 2.0F);
	}

	public Entity_TBF3(World worldIn, EntityLivingBase entity, ItemStack stack) {
