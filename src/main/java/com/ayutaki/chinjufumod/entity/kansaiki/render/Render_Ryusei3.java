...
public class Render_Ryusei3<T extends Entity_Ryusei3> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Ryusei3(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
