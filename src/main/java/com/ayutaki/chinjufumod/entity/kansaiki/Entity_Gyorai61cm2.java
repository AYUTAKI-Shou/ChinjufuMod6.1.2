...
public class Entity_Gyorai61cm2 extends EntityThrowable {

	private ItemStack stack = ItemStack.EMPTY;

	public Entity_Gyorai61cm2(World worldIn) {
		super(worldIn);

		setSize(1.0F, 1.0F);
	}

	public Entity_Gyorai61cm2(World worldIn, EntityLivingBase entity, ItemStack stack) {
