...
public class Render_Type97<T extends Entity_Type97> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Type97(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
