...
public class Render_Gyorai61cm2<T extends Entity_Gyorai61cm2> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public Render_Gyorai61cm2(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
