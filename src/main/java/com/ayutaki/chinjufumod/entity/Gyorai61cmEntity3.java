...
public class Gyorai61cmEntity3 extends ThrowableEntity implements IRendersAsItem {

	private ItemStack stack = new ItemStack(Items_Weapon.GYORAI_61cm);

	public Gyorai61cmEntity3(EntityType<Gyorai61cmEntity3> type, World worldIn) {
		super(type, worldIn);
	}

	public Gyorai61cmEntity3(LivingEntity entity, World worldIn, ItemStack stack) {
