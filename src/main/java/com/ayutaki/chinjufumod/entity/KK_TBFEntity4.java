...
public class KK_TBFEntity4 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_TBFEntity4.class, DataSerializers.VARINT);
	...
	public KK_TBFEntity4(LivingEntity entity, World worldIn, ItemStack stack) {
