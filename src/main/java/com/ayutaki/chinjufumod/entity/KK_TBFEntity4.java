...
public class KK_TBFEntity4 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_TBFEntity4.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.TBF);

	public KK_TBFEntity4(EntityType<KK_TBFEntity4> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_TBFEntity4(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
