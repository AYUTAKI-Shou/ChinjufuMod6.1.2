...
public class KK_SwordfishEntity extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_SwordfishEntity.class, DataSerializers.VARINT);
	...
	public KK_SwordfishEntity(LivingEntity entity, World worldIn, ItemStack stack) {
