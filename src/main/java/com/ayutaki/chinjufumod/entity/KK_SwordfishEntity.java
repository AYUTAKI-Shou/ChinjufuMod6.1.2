...
public class KK_SwordfishEntity extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_SwordfishEntity.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.SWORDFISH);

	public KK_SwordfishEntity(EntityType<KK_SwordfishEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_SwordfishEntity(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
