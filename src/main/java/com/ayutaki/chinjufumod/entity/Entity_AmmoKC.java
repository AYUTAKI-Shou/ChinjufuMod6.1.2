...
public class Entity_AmmoKC extends Base_EntityAmmo {

	public Entity_AmmoKC(World worldIn) {
		super(worldIn);
	}

	public Entity_AmmoKC(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	}

	public Entity_AmmoKC(World worldIn, EntityLivingBase shooter) {
	...
	public void onHit(RayTraceResult raytraceResultIn) {
		...
		if (!(entitylivingbase instanceof EntityPlayer)) {
			...
			CMExplosion explosion = new CMExplosion(worldIn, this, this.posX, this.posY, this.posZ, 2.5F, false, CMConfig_Core.blastBlockBreak);
