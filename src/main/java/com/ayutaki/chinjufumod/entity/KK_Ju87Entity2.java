...
public class KK_Ju87Entity2 extends ThrowableEntity implements IRendersAsItem {
	...
	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_Ju87Entity2.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.JU87);

	public KK_Ju87Entity2(EntityType<KK_Ju87Entity2> type, World world) {
		super(type, world);
	}

	public KK_Ju87Entity2(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
