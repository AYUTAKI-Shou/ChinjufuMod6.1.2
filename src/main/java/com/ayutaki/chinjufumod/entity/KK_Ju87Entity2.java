...
public class KK_Ju87Entity2 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.createKey(KK_Ju87Entity2.class, DataSerializers.VARINT);
	private ItemStack stack = new ItemStack(Items_Weapon.JU87);

	public KK_Ju87Entity2(EntityType<KK_Ju87Entity2> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_Ju87Entity2(LivingEntity entity, World worldIn, ItemStack stack) {
