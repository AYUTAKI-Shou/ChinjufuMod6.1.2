...
/* エンティティなどで呼び出せば使える */
public class CMExplosion extends Explosion {
	...
	public CMExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, List<BlockPos> affectedPositions) {
		this(worldIn, entityIn, x, y, z, size, false, true, affectedPositions);
	}

	@SideOnly(Side.CLIENT)
	public CMExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size,
	...
	public CMExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean damagesTerrain) {
	...
	public void doExplosionB(boolean spawnParticles) {
		...
		/** パーティクル **/
		this.world.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.x, this.y, this.z, 0.0D, 0.5D, 0.0D);
