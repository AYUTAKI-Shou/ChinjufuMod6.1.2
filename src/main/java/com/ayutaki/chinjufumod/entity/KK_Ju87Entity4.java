...
public class KK_Ju87Entity4 extends ThrowableEntity implements IRendersAsItem {

	private static final DataParameter<Integer> RETURN_TO = EntityDataManager.defineId(KK_Ju87Entity4.class, DataSerializers.INT);
	private ItemStack stack = new ItemStack(Items_Weapon.JU87);

	public KK_Ju87Entity4(EntityType<KK_Ju87Entity4> type, World world) {
		super(type, world);
	}

	public KK_Ju87Entity4(LivingEntity entityIn, World worldIn, ItemStack itemstack) {
