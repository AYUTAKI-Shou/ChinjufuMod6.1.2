...
public class GlassDoorHalf_seasonal extends BaseStage4_Face {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.GARASUDOH_SAKU) { stack.add(new ItemStack(Items_Seasonal.GARASUDOH_SAKU, 1, 0)); }
		if (this == Slidingdoor_Blocks.GARASUDOH_KAE) { stack.add(new ItemStack(Items_Seasonal.GARASUDOH_KAE, 1, 0)); }
		if (this == Slidingdoor_Blocks.GARASUDOH_ICH) { stack.add(new ItemStack(Items_Seasonal.GARASUDOH_ICH, 1, 0)); }
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if (this == Slidingdoor_Blocks.GARASUDOH_KAE) { return new ItemStack(Items_Seasonal.GARASUDOH_KAE, 1, 0); }
		if (this == Slidingdoor_Blocks.GARASUDOH_ICH) { return new ItemStack(Items_Seasonal.GARASUDOH_ICH, 1, 0); }
		return new ItemStack(Items_Seasonal.GARASUDOH_SAKU, 1, 0);
	}
