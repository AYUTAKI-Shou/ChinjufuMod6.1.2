...
public class Base_GlassDoor extends Block {

	/* Property */
	public static final PropertyDirection H_FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static final PropertyBool OPEN = PropertyBool.create("open");
	public static final PropertyEnum<Base_GlassDoor.EnumHingePosition> HINGE = PropertyEnum.
			<Base_GlassDoor.EnumHingePosition>create("hinge", Base_GlassDoor.EnumHingePosition.class);
	public static final PropertyBool POWERED = PropertyBool.create("powered");
	public static final PropertyEnum<Base_GlassDoor.EnumGarasudoHalf> HALF = PropertyEnum.
			<Base_GlassDoor.EnumGarasudoHalf>create("half", Base_GlassDoor.EnumGarasudoHalf.class);
	...
	protected Base_GlassDoor(Material materialIn) {
		super(materialIn);
		...
		setDefaultState(this.blockState.getBaseState().withProperty(H_FACING, EnumFacing.NORTH)
				...
				.withProperty(HINGE, Base_GlassDoor.EnumHingePosition.RIGHT)
				.withProperty(POWERED, Boolean.valueOf(false))
				.withProperty(HALF, Base_GlassDoor.EnumGarasudoHalf.LOWER));
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
		...
		boolean flag1 = state.getValue(HINGE) == Base_GlassDoor.EnumHingePosition.LEFT;
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		BlockPos blockpos = state.getValue(HALF) == Base_GlassDoor.EnumGarasudoHalf.LOWER ? pos : pos.down();
	...
	public void toggleDoor(World worldIn, BlockPos pos, boolean open) {
		...
		if (iblockstate.getBlock() == this) {
			...
			BlockPos blockpos = iblockstate.getValue(HALF) == BlockBaseGarasudo.EnumGarasudoHalf.LOWER ? pos : pos.down();
	...
	public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
		...
		if (state.getValue(HALF) == Base_GlassDoor.EnumGarasudoHalf.UPPER) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (playerIn.capabilities.isCreativeMode && state.getValue(HALF) == Base_GlassDoor.EnumGarasudoHalf.UPPER && worldIn.getBlockState(blockpos).getBlock() == this) {
			worldIn.setBlockToAir(blockpos);
		}

		if (state.getValue(HALF) == Base_GlassDoor.EnumGarasudoHalf.LOWER && worldIn.getBlockState(blockpos1).getBlock() == this) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return state.getValue(HALF) == Base_GlassDoor.EnumGarasudoHalf.UPPER ? Items.AIR : this.getItem();
	}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		if (state.getValue(HALF) == Base_GlassDoor.EnumGarasudoHalf.LOWER) {
	...
	public IBlockState withRotation(IBlockState state, Rotation rot) {
		return state.getValue(HALF) != Base_GlassDoor.EnumGarasudoHalf.LOWER ? state : state
	...
	public IBlockState getStateFromMeta(int meta) {
		...
		return (meta & 8) > 0 ? this.getDefaultState().withProperty(HALF, Base_GlassDoor.EnumGarasudoHalf.UPPER)
				.withProperty(HINGE, (meta & 1) > 0 ? Base_GlassDoor.EnumHingePosition.LEFT : Base_GlassDoor.EnumHingePosition.RIGHT)
	...
	public int getMetaFromState(IBlockState state) {
		...
		if (state.getValue(HALF) == Base_GlassDoor.EnumGarasudoHalf.UPPER) {
			...
			if (state.getValue(HINGE) == Base_GlassDoor.EnumHingePosition.LEFT) {
				i |= 1;
			}
	...
	public static enum EnumGarasudoHalf implements IStringSerializable {
		UPPER,
		LOWER;
