...
public class BambooFenceGate_K extends BlockFenceGate {

	public static final String ID = "block_bamboo_k_fencegate";
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Wadeco.TAKEFENCEGATE_K, 1, 0));
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Wadeco.TAKEFENCEGATE_K);
	}
