...
public class BambooFence extends BlockFence {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == JPDeco_Blocks.TAKEFENCE) { stack.add(new ItemStack(Items_Wadeco.TAKEFENCE, 1, 0)); }
		if (this == JPDeco_Blocks.TAKEFENCE_Y) { stack.add(new ItemStack(Items_Wadeco.TAKEFENCE_Y, 1, 0)); }
		if (this == JPDeco_Blocks.TAKEFENCE_K) { stack.add(new ItemStack(Items_Wadeco.TAKEFENCE_K, 1, 0)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == JPDeco_Blocks.TAKEFENCE_Y) { return new ItemStack(Items_Wadeco.TAKEFENCE_Y); }
		if (this == JPDeco_Blocks.TAKEFENCE_K) { return new ItemStack(Items_Wadeco.TAKEFENCE_K); }
		return new ItemStack(Items_Wadeco.TAKEFENCE);
	}
