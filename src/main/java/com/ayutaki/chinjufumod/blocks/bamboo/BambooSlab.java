...
public class BambooSlab extends BaseFacingSlabW {
	...
	public BambooSlab(String unlocalizedName) {
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
		...
		else { return (state.getValue(HALF) == BaseFacingSlabW.SlabHalf.TOP)? TOP_AABB : BOTTOM_AABB; }
	}
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (state.getValue(DOUBLE) != true) {
			if (this == JPDeco_Blocks.TAKE_SH) { stack.add(new ItemStack(Items_Wadeco.TAKE_SH, 1, 0)); }
			if (this == JPDeco_Blocks.TAKE_SHY) { stack.add(new ItemStack(Items_Wadeco.TAKE_SHY, 1, 0)); }
			if (this == JPDeco_Blocks.TAKE_SHK) { stack.add(new ItemStack(Items_Wadeco.TAKE_SHK, 1, 0)); }
		}
		
		/** Double **/
		if (state.getValue(DOUBLE) == true) {
			if (this == JPDeco_Blocks.TAKE_SH) { stack.add(new ItemStack(Items_Wadeco.TAKE_SH, 2, 0)); }
			if (this == JPDeco_Blocks.TAKE_SHY) { stack.add(new ItemStack(Items_Wadeco.TAKE_SHY, 2, 0)); }
			if (this == JPDeco_Blocks.TAKE_SHK) { stack.add(new ItemStack(Items_Wadeco.TAKE_SHK, 2, 0)); }
		}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == JPDeco_Blocks.TAKE_SHY) { return new ItemStack(Items_Wadeco.TAKE_SHY); }
		if (this == JPDeco_Blocks.TAKE_SHK) { return new ItemStack(Items_Wadeco.TAKE_SHK); }
		return new ItemStack(Items_Wadeco.TAKE_SH);
	}
