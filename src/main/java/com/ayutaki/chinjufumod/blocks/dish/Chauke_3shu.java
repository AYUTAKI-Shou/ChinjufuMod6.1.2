...
public class Chauke_3shu extends Block {
	...
	public static final String ID = "block_food_jpchauke";
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			if (i < 4) {
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.SENBEI, 1)); }

			if (i > 4 && i < 10) {
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.FOOD_MIKAN, 1)); }

			if (i > 10 && i < 15) {
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.SCONE, 1)); }

			if (i == 4 || i == 10 || i == 15) { CMEvents.textIsEmpty(worldIn, pos, playerIn); }
		}
