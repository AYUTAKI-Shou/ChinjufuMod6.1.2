...
public class Frypan_Nama_2 extends BaseStage4_Face {

	/**1=牛丼、2=親子丼、3=カツ、4=カツ丼**/
	public static final String ID = "block_food_frypan_n2";

	public Frypan_Nama_2() {
		super(Material.WOOD);
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) { stack.add(new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 1)); }
		if (i == 2) { stack.add(new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 2)); }
		if (i == 3) { stack.add(new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 3)); }
		if (i == 4) { stack.add(new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 4)); }
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if (i == 2) { return new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 2); }
		if (i == 3) { return new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 3); }
		if (i == 4) { return new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 4); }
		return new ItemStack(Items_Teatime.FRYPAN_NAMA_2, 1, 1);
	}
