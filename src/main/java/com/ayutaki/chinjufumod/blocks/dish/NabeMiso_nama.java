...
public class NabeMiso_nama extends BaseNabe_nama {

	public NabeMiso_nama(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
		...
		if (isCooking(worldIn, pos)) {
			...
			worldIn.setBlock(pos, Dish_Blocks.NABEMISO.defaultBlockState()
