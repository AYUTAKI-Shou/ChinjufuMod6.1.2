...
public class Hakusai_Duke extends BaseFood_Stage3Water {
	...
	public Hakusai_Duke(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i != 3) {
			...
			if (i == 1) {
				...
				playerIn.addEffect(new EffectInstance(Effects.DIG_SPEED, 300, 0));
	...
	public ItemStack getCloneItemStack(IBlockReader worldIn, BlockPos pos, BlockState state) {
		int i = state.getValue(STAGE_1_3);
		return (i == 1)? new ItemStack(Items_Teatime.HAKUSAIDUKE) : new ItemStack(Items_Teatime.SARA);
	}
