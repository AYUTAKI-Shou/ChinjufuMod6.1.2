...
public class SushiSet_Fish extends BaseStage4_FaceDown {

	public static final String ID = "block_food_sushiset_fish";
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) { stack.add(new ItemStack(Items_Teatime.SUSHISET_fish, 1, 0)); }
		if (i != 1) {
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Teatime.SUSHISET_fish, 1, 0);
	}
