...
public class NabeCooked_SNT extends Block {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) { stack.add(new ItemStack(Items_Teatime.NABE_SNT, 1, 1)); }
		if (i == 2) { stack.add(new ItemStack(Items_Teatime.NABE_SNT, 1, 2)); }
		if (i == 3) { stack.add(new ItemStack(Items_Teatime.NABE_SNT, 1, 3)); }
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		return new ItemStack(Items_Teatime.NABE_SNT, 1, 1);
	}
