...
public class Irori_Sakana_R2 extends BaseIrori_Sakana {
	...
	public static final String ID = "block_irori_sakana_r2";

	public Irori_Sakana_R2() {
		super();
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		default: //00 RCRR 北東南西
			...
			/** Place it. **/
			if (!itemstack.isEmpty() && item == Items_Teatime.KUSHI_SAKANA) { CMEvents.soundTouchBlock(worldIn, pos); }
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 0) { stack.add(new ItemStack(Items_Teatime.KUSHI_SAKANA, 3, 0));
		...
		if (i == 11) { stack.add(new ItemStack(Items_Teatime.KUSHI_SAKANA_C, 2, 0)); }
