...
public class SushiOke_kara extends Block {

	public static final String ID = "block_food_sushioke_kara";

	/* Property */
	public static final PropertyInteger STAGE_1_6 = PropertyInteger.create("stage", 1, 6);

	public SushiOke_kara() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty() && item != Items_Teatime.SUSHIOKE && facing == EnumFacing.UP) {
	...
	public int getComparatorInputOverride(IBlockState blockState, World worldIn, BlockPos pos) {
		return (6 - ((Integer)blockState.getValue(STAGE_1_6)).intValue()) * 2;
	}
