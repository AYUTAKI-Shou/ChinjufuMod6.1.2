...
public class Zundou4_Curry extends BaseZundou_4Stage {
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (item == Items_Teatime.RICE) {
			...
			if (itemstack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_Teatime.CURRY)); }
			else if (!playerIn.inventory.add(new ItemStack(Items_Teatime.CURRY))) {
				playerIn.drop(new ItemStack(Items_Teatime.CURRY), false); }
