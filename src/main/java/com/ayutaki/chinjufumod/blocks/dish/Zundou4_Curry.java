...
public class Zundou4_Curry extends BaseZundou_4Stage {
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (item == Items_Teatime.RICE) {
			...
			if (itemstack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.CURRY)); }
	...
	public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
		int i = state.get(STAGE_1_4);
		return (i == 1)? new ItemStack(Items_Teatime.ZUNDOU_CURRY) : new ItemStack(Items_Teatime.ZUNDOU);
	}
