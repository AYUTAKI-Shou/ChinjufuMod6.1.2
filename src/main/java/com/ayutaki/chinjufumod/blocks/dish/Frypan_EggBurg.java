...
public class Frypan_EggBurg extends BaseFrypan_Stage2 {

	public Frypan_EggBurg(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i != 1) {
			if (item == Items_Teatime.SARA) {
				...
				if (itemstack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_Teatime.EGGBURG)); }
				else if (!playerIn.inventory.add(new ItemStack(Items_Teatime.EGGBURG))) {
					playerIn.drop(new ItemStack(Items_Teatime.EGGBURG), false); }
