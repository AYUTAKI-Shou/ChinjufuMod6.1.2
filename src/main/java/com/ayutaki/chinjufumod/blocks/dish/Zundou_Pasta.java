...
public class Zundou_Pasta extends BaseStage4_Face {

	/** 1=生パスタ水、2=生パスタ湯、3＝茹でパスタ水、4=茹でパスタ湯 **/
	public static final String ID = "block_zundou_pasta";
		...
		if (item == Items_Teatime.Item_SARA) {
			if (i == 3) {
				...
				if (itemstack.isEmpty()) {
					playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.PASTA, 1, 2)); }
				else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.PASTA, 1, 2))) {
					playerIn.dropItem(new ItemStack(Items_Teatime.PASTA, 1, 2), false); }
