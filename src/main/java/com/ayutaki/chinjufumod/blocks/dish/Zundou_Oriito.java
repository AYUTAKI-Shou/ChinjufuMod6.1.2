...
public class Zundou_Oriito extends BaseStage4_Face {

	/** 1=草束水、2=草束湯、3＝織り糸水、4=織り糸湯 **/
	public static final String ID = "block_zundou_oriito";

	public Zundou_Oriito() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			if (i == 3) {
				...
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Seasonal.ORIITO, 10));
