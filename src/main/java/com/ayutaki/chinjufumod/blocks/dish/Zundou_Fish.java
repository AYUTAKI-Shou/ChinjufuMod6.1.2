...
public class Zundou_Fish extends BaseStage4_Face {

	/** 1=生魚水、塩湯→2=生魚湯、3=煮干し水、4=煮干し湯 **/
	public static final String ID = "block_zundou_fish";
		...
		if (item == Items.PAPER) {
			...
			if (i == 3) {
				...
				if (itemstack.isEmpty()) {
					playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.NIBOSHI)); }
