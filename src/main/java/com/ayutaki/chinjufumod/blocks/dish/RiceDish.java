...
public class RiceDish extends BaseFood_Stage3Water {
	...
	public RiceDish(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ItemStack getCloneItemStack(IBlockReader worldIn, BlockPos pos, BlockState state) {
		int i = state.getValue(STAGE_1_3);
		return (i == 1)? new ItemStack(Items_Teatime.RICE) : new ItemStack(Items_Teatime.SARA);
	}
