...
public class NabeNama_1_TMGC extends BaseStage4_Face {

	/** 1=鶏鍋、2=味噌、3=ご飯、4=コーンスープ **/
	public static final String ID = "block_food_nabenama_1";

	public NabeNama_1_TMGC() {
		super(Material.WOOD);
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (i == 2) {
			if (worldIn.getBlockState(pos.down()).getBlock() == Blocks.LIT_FURNACE || worldIn
				...
				worldIn.setBlockState(pos, Dish_Blocks.NABEMISO.getDefaultState()
						.withProperty(H_FACING, state.getValue(H_FACING)));
			}
		}
		...
		if (i == 3) {
			if (worldIn.getBlockState(pos.down()).getBlock() == Blocks.LIT_FURNACE || worldIn
				...
				worldIn.setBlockState(pos, Dish_Blocks.NABEGOHAN.getDefaultState()
						.withProperty(H_FACING, state.getValue(H_FACING)));
			}
		}
		...
		if (i == 4) {
			if (worldIn.getBlockState(pos.down()).getBlock() == Blocks.LIT_FURNACE || worldIn
				...
				worldIn.setBlockState(pos, Dish_Blocks.NABECORNSOUP.getDefaultState()
						.withProperty(H_FACING, state.getValue(H_FACING)));
			}
		}
		worldIn.scheduleUpdate(pos, this, this.tickRate(worldIn));
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) { stack.add(new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 1)); }
		if (i == 2) { stack.add(new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 2)); }
		if (i == 3) { stack.add(new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 3)); }
		if (i == 4) { stack.add(new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 4)); }
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if (i == 2) { return new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 2); }
		if (i == 3) { return new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 3); }
		if (i == 4) { return new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 4); }
		return new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 1);
	}
