...
public class Frypan_Tamago extends BaseFrypan_Stage2 {

	public Frypan_Tamago(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i != 1) {
			if (item == Items_Teatime.SARA) {
				...
				if (itemstack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_Teatime.TAMAGOYAKI)); }
				else if (!playerIn.inventory.add(new ItemStack(Items_Teatime.TAMAGOYAKI))) {
					playerIn.drop(new ItemStack(Items_Teatime.TAMAGOYAKI), false); }
