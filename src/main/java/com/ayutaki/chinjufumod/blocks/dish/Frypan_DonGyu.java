...
public class Frypan_DonGyu extends BaseFrypan_Stage2 {

	public Frypan_DonGyu(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i != 1) {
			if (item == Items_Teatime.DONBURI_MESHI) {
				...
				if (itemstack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_Teatime.DONBURI_GYU)); }
				else if (!playerIn.inventory.add(new ItemStack(Items_Teatime.DONBURI_GYU))) {
					playerIn.drop(new ItemStack(Items_Teatime.DONBURI_GYU), false); }
