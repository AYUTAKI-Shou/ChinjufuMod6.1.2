...
public class SushiOkeFull_1 extends BaseStage4_FaceDown {

	public static final String ID = "block_food_sushiokefull_1";
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			if (i == 4) {
				...
				worldIn.setBlockState(pos, Dish_Blocks.SUSHIOKE_FULL_5.getDefaultState().withProperty(H_FACING, state.getValue(H_FACING))); }
		}
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) { stack.add(new ItemStack(Items_Teatime.SUSHISET_1, 1, 0)); }
