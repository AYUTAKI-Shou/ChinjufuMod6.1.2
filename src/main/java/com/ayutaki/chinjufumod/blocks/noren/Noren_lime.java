...
public class Noren_lime extends BaseNoren {

	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);

	public Noren_lime(Material material, String unlocalizedName) {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Noren_lime && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Noren_lime && right_block.getValue(H_FACING).equals(facing);
