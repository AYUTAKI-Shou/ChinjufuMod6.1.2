...
public class Noren_cyan extends BaseNoren {

	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);

	public Noren_cyan(Material material, String unlocalizedName) {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Noren_cyan && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Noren_cyan && right_block.getValue(H_FACING).equals(facing);
