...
public class Noren_green extends BaseNoren {

	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);

	public Noren_green(Material material, String unlocalizedName) {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Noren_green && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Noren_green && right_block.getValue(H_FACING).equals(facing);
