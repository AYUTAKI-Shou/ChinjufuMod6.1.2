...
public class Noren_black extends BaseNoren {

	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);

	public Noren_black(Material material, String unlocalizedName) {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Noren_black && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Noren_black && right_block.getValue(H_FACING).equals(facing);
