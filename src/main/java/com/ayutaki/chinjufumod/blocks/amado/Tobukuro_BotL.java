...
public class Tobukuro_BotL extends BaseStage3_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_BOTL) {
			...
			default :
				if (eaststate.getMaterial().isReplaceable()) {
					...
					if (i != 3) {
						...
						worldIn.setBlockState(pos.up(), tobuTopL.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
								.withProperty(STAGE_1_3, Integer.valueOf(i + 1))); }

					if (i == 3) {
						worldIn.setBlockState(pos, tobuBotL2.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
								.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1)));
						worldIn.setBlockState(pos.up(), tobuTopL2.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
								.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1))); } }
		...
		if (this == Slidingdoor_Blocks.TOBUKUROS_BOTL) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (blockstate.getBlock() == Slidingdoor_Blocks.TOBUKURO_TOPL || blockstate.getBlock() == Slidingdoor_Blocks.TOBUKUROS_TOPL) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_BOTL) { stack.add(new ItemStack(Items_Wadeco.TOBUKURO_BOTR)); }
		if (this == Slidingdoor_Blocks.TOBUKUROS_BOTL) { stack.add(new ItemStack(Items_Wadeco.TOBUKUROS_BOTR)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == Slidingdoor_Blocks.TOBUKUROS_BOTL) { return new ItemStack(Items_Wadeco.TOBUKUROS_BOTR); }
