...
public class Tobukuro_spruce extends Base_Tobukuro {
	...
	public Tobukuro_spruce(Block.Properties properties) {
		super(properties);
	}
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		if (blockpos.getY() < 255 && context.getWorld().getBlockState(blockpos.up()).isReplaceable(context)) {
			if (playerIn.isSneaking()) {
				return Slidedoor_Blocks.TOBUKURO_SL.getDefaultState().with(H_FACING, context.getPlacementHorizontalFacing().getOpposite())
