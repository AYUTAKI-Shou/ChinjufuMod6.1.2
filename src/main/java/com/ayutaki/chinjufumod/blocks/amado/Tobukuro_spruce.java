...
public class Tobukuro_spruce extends Base_Tobukuro {

	/** 1=4枚、2=3枚、3=2枚、4=1枚、5=0枚 **/
	public Tobukuro_spruce(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		if (blockpos.getY() < 255 && context.getLevel().getBlockState(blockpos.above()).canBeReplaced(context)) {
			if (playerIn.isCrouching()) {
				return Slidedoor_Blocks.TOBUKURO_SL.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
