...
public class Tobukuro_BotR2 extends BaseStage2_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (i != 2) {
			...
			if (this == Slidingdoor_Blocks.TOBUKURO_BOTR2) {
			...
			if (this == Slidingdoor_Blocks.TOBUKUROS_BOTR2) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (blockstate.getBlock() == Slidingdoor_Blocks.TOBUKURO_TOPR2 || blockstate.getBlock() == Slidingdoor_Blocks.TOBUKUROS_TOPR2) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_BOTR2) { stack.add(new ItemStack(Items_Wadeco.TOBUKURO_BOTR)); }
		if (this == Slidingdoor_Blocks.TOBUKUROS_BOTR2) { stack.add(new ItemStack(Items_Wadeco.TOBUKUROS_BOTR)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == Slidingdoor_Blocks.TOBUKUROS_BOTR2) { return new ItemStack(Items_Wadeco.TOBUKUROS_BOTR); }
