...
public class Amado_Bot extends BaseStage4_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		/** DarkOak **/
		if (this == Slidingdoor_Blocks.AMADO_BOT) {
			Block tobuBotL2 = Slidingdoor_Blocks.TOBUKURO_BOTL2; /** 1=1枚、2=0枚 **/
			Block tobuBotL = Slidingdoor_Blocks.TOBUKURO_BOTL; /** 1=4枚、2=3枚、3=2枚 **/
				...
				default:
					...
					if (westblock == tobuBotL && weststate.getValue(BaseStage3_Face.STAGE_1_3) > 1) {
						...
						if ((playerfacing == EnumFacing.NORTH && hitX < 0.45D) || (playerfacing == EnumFacing.SOUTH && hitX < 0.45D)) {
							...
							worldIn.setBlockState(new BlockPos(x - 1, y, z), tobuBotL.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(weststate.getValue(BaseStage3_Face.STAGE_1_3) - 1)));
							worldIn.setBlockState(new BlockPos(x - 1, y + 1, z), tobuTopL.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(weststate.getValue(BaseStage3_Face.STAGE_1_3) - 1))); } }
					...
					/** RIGHT side is TOBUKURO.2 **/
						...
						if ((playerfacing == EnumFacing.NORTH && hitX < 0.45D) || (playerfacing == EnumFacing.SOUTH && hitX < 0.45D)) {
							...
							if (weststate.getValue(BaseStage2_Face.STAGE_1_2) != 1) {
								worldIn.setBlockState(new BlockPos(x - 1, y, z), tobuBotL2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1)));
								worldIn.setBlockState(new BlockPos(x - 1, y + 1, z), tobuTopL2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1))); } } }
					break;
				...
				case EAST :
					...
					if (northblock == tobuBotL && northstate.getValue(BaseStage3_Face.STAGE_1_3) > 1) {
						...
						if ((playerfacing == EnumFacing.EAST && hitZ < 0.45D) || (playerfacing == EnumFacing.WEST && hitZ < 0.45D)) {
							...
							worldIn.setBlockState(new BlockPos(x, y, z - 1), tobuBotL.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(northstate.getValue(BaseStage3_Face.STAGE_1_3) - 1)));
							worldIn.setBlockState(new BlockPos(x, y + 1, z - 1), tobuTopL.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(northstate.getValue(BaseStage3_Face.STAGE_1_3) - 1))); } }
					...
					/** RIGHT side is TOBUKURO.2 **/
						...
						if ((playerfacing == EnumFacing.EAST && hitZ < 0.45D) || (playerfacing == EnumFacing.WEST && hitZ < 0.45D)) {
							...
							if (northstate.getValue(BaseStage2_Face.STAGE_1_2) != 1) {
								worldIn.setBlockState(new BlockPos(x, y, z - 1), tobuBotL2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1)));
								worldIn.setBlockState(new BlockPos(x, y + 1, z - 1), tobuTopL2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1))); } } }
					break;
				...
				default:
					...
					if (eastblock == tobuBotR && eaststate.getValue(BaseStage3_Face.STAGE_1_3) > 1) {
						...
						if ((playerfacing == EnumFacing.NORTH && hitX > 0.55D) || (playerfacing == EnumFacing.SOUTH && hitX > 0.55D)) {
							...
							worldIn.setBlockState(new BlockPos(x + 1, y, z), tobuBotR.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(eaststate.getValue(BaseStage3_Face.STAGE_1_3) - 1)));
							worldIn.setBlockState(new BlockPos(x + 1, y + 1, z), tobuTopR.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(eaststate.getValue(BaseStage3_Face.STAGE_1_3) - 1))); } }
					...
					/** LEFT side is TOBUKURO.2 **/
						...
						if ((playerfacing == EnumFacing.NORTH && hitX > 0.55D) || (playerfacing == EnumFacing.SOUTH && hitX > 0.55D)) {
							...
							if (eaststate.getValue(BaseStage2_Face.STAGE_1_2) != 1) {
								worldIn.setBlockState(new BlockPos(x + 1, y, z), tobuBotR2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1)));
								worldIn.setBlockState(new BlockPos(x + 1, y + 1, z), tobuTopR2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1))); } } }
					break;
				...
				case EAST :
					...
					if (southblock == tobuBotR && southstate.getValue(BaseStage3_Face.STAGE_1_3) > 1) {
						...
						if ((playerfacing == EnumFacing.EAST && hitZ > 0.55D) || (playerfacing == EnumFacing.WEST && hitZ > 0.55D)) {
							...
							worldIn.setBlockState(new BlockPos(x, y, z + 1), tobuBotR.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(southstate.getValue(BaseStage3_Face.STAGE_1_3) - 1)));
							worldIn.setBlockState(new BlockPos(x, y + 1, z + 1), tobuTopR.getDefaultState()
									.withProperty(H_FACING, state.getValue(H_FACING))
									.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(southstate.getValue(BaseStage3_Face.STAGE_1_3) - 1))); } }
						...
						if ((playerfacing == EnumFacing.EAST && hitZ > 0.55D) || (playerfacing == EnumFacing.WEST && hitZ > 0.55D)) {
							...
							if (southstate.getValue(BaseStage2_Face.STAGE_1_2) != 1) {
								worldIn.setBlockState(new BlockPos(x, y, z + 1), tobuBotR2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1)));
								worldIn.setBlockState(new BlockPos(x, y + 1, z + 1), tobuTopR2.getDefaultState()
										.withProperty(H_FACING, state.getValue(H_FACING))
										.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1))); } } }
					break;
		...
		if (this == Slidingdoor_Blocks.AMADOS_BOT) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (blockstate.getBlock() == Slidingdoor_Blocks.AMADO_TOP || blockstate.getBlock() == Slidingdoor_Blocks.AMADOS_TOP) {
