...
public class TobukuroWindowL extends BaseStage3_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (i != 3) {
			...
			if (this == Slidingdoor_Blocks.TOBUKURO_WINL) {
				switch (direction) {
				case NORTH :
				default :
					if (eaststate.getMaterial().isReplaceable()) {
						...
						worldIn.setBlockState(pos.east(), Slidingdoor_Blocks.AMADO_WIN.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING)).withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(2))); }
			...
			if (this == Slidingdoor_Blocks.TOBUKUROS_WINL) {
				switch (direction) {
				case NORTH :
				default :
					if (eaststate.getMaterial().isReplaceable()) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_WINL) { stack.add(new ItemStack(Items_Wadeco.TOBUKURO_WINR)); }
		if (this == Slidingdoor_Blocks.TOBUKUROS_WINL) { stack.add(new ItemStack(Items_Wadeco.TOBUKUROS_WINR)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == Slidingdoor_Blocks.TOBUKUROS_WINL) { return new ItemStack(Items_Wadeco.TOBUKUROS_WINR); }
