...
public class Tobukuro_spruce_L extends Base_Tobukuro {

	/** 1=4枚、2=3枚、3=2枚、4=1枚、5=0枚 **/
	public Tobukuro_spruce_L(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		Block AMADO = Slidedoor_Blocks.AMADO_S;
				...
				default :
					if (worldIn.getBlockState(new BlockPos(x + 1, y, z)).getMaterial().isReplaceable() &&
						...
						worldIn.setBlock(new BlockPos(x + 1, y, z), AMADO.defaultBlockState()
								...
								.setValue(Amado.HALF, DoubleBlockHalf.LOWER).setValue(Amado.STAGE_1_4, Integer.valueOf(4)), 3);
						worldIn.setBlock(new BlockPos(x + 1, y + 1, z), AMADO.defaultBlockState()
								.setValue(Amado.H_FACING, state.getValue(H_FACING))
								.setValue(Amado.HALF, DoubleBlockHalf.UPPER).setValue(Amado.STAGE_1_4, Integer.valueOf(4)), 3); }
	...
	public ItemStack getCloneItemStack(IBlockReader worldIn, BlockPos pos, BlockState state) {
		return new ItemStack(Items_Wadeco.TOBUKURO_S);
	}
