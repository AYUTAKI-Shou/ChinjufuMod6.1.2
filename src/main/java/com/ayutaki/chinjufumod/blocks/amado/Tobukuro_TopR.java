...
public class Tobukuro_TopR extends BaseStage3_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_TOPR) {
			...
			default :
				if (weststate.getMaterial().isReplaceable()) {
					...
					if (i != 3) {
						...
						worldIn.setBlockState(pos.down(), tobuBotR.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
								.withProperty(STAGE_1_3, Integer.valueOf(i + 1))); }

					if (i == 3) {
						worldIn.setBlockState(pos, tobuTopR2.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
								.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1)));
						worldIn.setBlockState(pos.down(), tobuBotR2.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
								.withProperty(BaseStage2_Face.STAGE_1_2, Integer.valueOf(1))); } }
		...
		if (this == Slidingdoor_Blocks.TOBUKUROS_TOPR) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (blockstate.getBlock() == Slidingdoor_Blocks.TOBUKURO_BOTR || blockstate.getBlock() == Slidingdoor_Blocks.TOBUKUROS_BOTR) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_TOPR) { stack.add(new ItemStack(Items_Wadeco.TOBUKURO_BOTR)); }
		if (this == Slidingdoor_Blocks.TOBUKUROS_TOPR) { stack.add(new ItemStack(Items_Wadeco.TOBUKUROS_BOTR)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == Slidingdoor_Blocks.TOBUKUROS_TOPR) { return new ItemStack(Items_Wadeco.TOBUKUROS_BOTR); }
