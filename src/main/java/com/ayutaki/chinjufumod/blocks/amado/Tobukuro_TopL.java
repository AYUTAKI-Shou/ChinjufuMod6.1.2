...
public class Tobukuro_TopL extends BaseStage3_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_TOPL) {
			...
			default :
				if (eaststate.getMaterial().isReplaceable()) {
					...
					if (i != 3) {
						...
						worldIn.setBlockState(pos.down(), tobuBotL.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
								.withProperty(STAGE_1_3, Integer.valueOf(i + 1))); }

					if (i == 3) {
						worldIn.setBlockState(pos, tobuTopL2.getDefaultState()
								.withProperty(H_FACING, state.getValue(H_FACING))
		...
		if (this == Slidingdoor_Blocks.TOBUKUROS_TOPL) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (blockstate.getBlock() == Slidingdoor_Blocks.TOBUKURO_BOTL || blockstate.getBlock() == Slidingdoor_Blocks.TOBUKUROS_BOTL) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.TOBUKURO_TOPL) { stack.add(new ItemStack(Items_Wadeco.TOBUKURO_BOTR)); }
		if (this == Slidingdoor_Blocks.TOBUKUROS_TOPL) { stack.add(new ItemStack(Items_Wadeco.TOBUKUROS_BOTR)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == Slidingdoor_Blocks.TOBUKUROS_TOPL) { return new ItemStack(Items_Wadeco.TOBUKUROS_BOTR); }
