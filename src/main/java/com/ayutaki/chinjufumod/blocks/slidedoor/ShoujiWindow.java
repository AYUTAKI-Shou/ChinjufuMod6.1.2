	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		if (playerIn.isCrouching()) {
			...
			if (this == Slidedoor_Blocks.SHOUJI_WIN) {
				return Slidedoor_Blocks.SHOUJI_WINR.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
			...
			if (this == Slidedoor_Blocks.SHOUJI_WIN_SPRU) {
				return Slidedoor_Blocks.SHOUJI_WINR_SPRU.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }

			if (this == Slidedoor_Blocks.SHOUJI_WIN_BIR) {
				return Slidedoor_Blocks.SHOUJI_WINR_BIR.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }

			if (this == Slidedoor_Blocks.SHOUJI_WIN_JUN) {
				return Slidedoor_Blocks.SHOUJI_WINR_JUN.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }

			if (this == Slidedoor_Blocks.SHOUJI_WIN_ACA) {
				return Slidedoor_Blocks.SHOUJI_WINR_ACA.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }

			if (this == Slidedoor_Blocks.SHOUJI_WIN_DOAK) {
				return Slidedoor_Blocks.SHOUJI_WINR_DOAK.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }

			if (this == Slidedoor_Blocks.SHOUJI_WIN_SAKU) {
				return Slidedoor_Blocks.SHOUJI_WINR_SAKU.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }

			if (this == Slidedoor_Blocks.SHOUJI_WIN_KAE) {
				return Slidedoor_Blocks.SHOUJI_WINR_KAE.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }

			if (this == Slidedoor_Blocks.SHOUJI_WIN_ICH) {
				return Slidedoor_Blocks.SHOUJI_WINR_ICH.defaultBlockState().setValue(H_FACING, context.getHorizontalDirection().getOpposite())
					.setValue(STAGE_1_3, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER)); }
		}
