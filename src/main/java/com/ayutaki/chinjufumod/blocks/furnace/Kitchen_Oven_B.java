...
public class Kitchen_Oven_B extends BlockContainer {

	public static final PropertyDirection H_FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	private final boolean isBurning;
	private static boolean keepInventory;

	public Kitchen_Oven_B(boolean isBurning, String name) {
		super(Material.WOOD);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Items_Teatime.KIT_OVEN_B;
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		default:
			if ((worldIn.getBlockState(pos.north()).getMaterial().isReplaceable() || worldIn.getBlockState(pos.north()).getBlock() instanceof BlockCarpet) && 
					...
					if (tileentity instanceof TileEntityKitOven_B) {
						CMEvents.soundOpenOven(worldIn, pos);
						playerIn.displayGUIChest((TileEntityKitOven_B)tileentity);
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(pos, Kitchen_Blocks.LIT_KITOVEN_B.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
			worldIn.setBlockState(pos, Kitchen_Blocks.LIT_KITOVEN_B.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
		}
		else {
			worldIn.setBlockState(pos, Kitchen_Blocks.KIT_OVEN_B.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
			worldIn.setBlockState(pos, Kitchen_Blocks.KIT_OVEN_B.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
		}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityKitOven_B();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
			...
			if (tileentity instanceof TileEntityKitOven_B) {
				((TileEntityKitOven_B)tileentity).setCustomInventoryName(stack.getDisplayName());
			}
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (!keepInventory) {
			...
			if (tileentity instanceof TileEntityKitOven_B) {
				InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityKitOven_B)tileentity);
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(Kitchen_Blocks.KIT_OVEN_B);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_kit_oven", meta));
	}
