...
public class Lit_Irori extends Block {
	...
	public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos) {
		return worldIn.getBlockState(pos).getBlock() instanceof Nabe_kara || worldIn
				...
				.getBlockState(pos).getBlock() instanceof BlockBeseNabe || worldIn
	...
	public int getComparatorInputOverride(IBlockState blockState, World worldIn, BlockPos pos) {
		return (6 - ((Integer)blockState.getValue(STAGE_0_7)).intValue()) * 2;
	}
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (i == 0) {
			worldIn.setBlockState(pos, state.withProperty(STAGE_0_7, Integer.valueOf(1)), 3);
			worldIn.scheduleUpdate(pos, this, this.tickRate(worldIn));
		}

		if (i != 0 && rand.nextInt(1) == 0) {
