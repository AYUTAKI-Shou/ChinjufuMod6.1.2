...
public class Kitchen_Oven extends BlockContainer {
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(pos, Kitchen_Blocks.LIT_KITOVEN.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
			worldIn.setBlockState(pos, Kitchen_Blocks.LIT_KITOVEN.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
		}
		else {
			worldIn.setBlockState(pos, Kitchen_Blocks.KIT_OVEN.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
			worldIn.setBlockState(pos, Kitchen_Blocks.KIT_OVEN.getDefaultState().withProperty(H_FACING, iblockstate.getValue(H_FACING)), 3);
		}
