...
public class Kit_TanaDrinkglass_E extends BaseFacingSapo {

	public static final String ID = "block_kit_driglasse";
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			...
			worldIn.setBlockState(pos, Kitchen_Blocks.KIT_DRINKGLASSA.getDefaultState()
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Teatime.Item_DISH, 9, 7));
		return stack;
	}
