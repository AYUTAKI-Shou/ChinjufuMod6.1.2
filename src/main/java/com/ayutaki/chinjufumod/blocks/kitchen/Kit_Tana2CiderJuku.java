...
public class Kit_Tana2CiderJuku extends BaseKit_TanaWine {

	public static final String ID = "block_kit2_ciderjuku";

	public Kit_Tana2CiderJuku() {
		super(Material.WOOD);
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) {
			...
			stack.add(new ItemStack(Items_Teatime.JUKUCIDERBOT, 1)); }

		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.JUKUCIDERBOT, 2)); }

		if (i == 3) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.JUKUCIDERBOT, 3)); }

		if (i == 4) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.JUKUCIDERBOT, 4)); }
		return stack;
	}
