...
public class Kit_Tana2CiderJuku extends Base_WineTana {

	public Kit_Tana2CiderJuku(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (item != Items_Teatime.JUKUCIDERBOT) {
			if (itemstack.isEmpty()) {
				playerIn.inventory.add(new ItemStack(Items_Teatime.JUKUCIDERBOT));
