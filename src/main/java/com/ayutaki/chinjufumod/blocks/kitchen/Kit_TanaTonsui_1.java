...
public class Kit_TanaTonsui_1 extends BaseKit_Tana4Stage {
	...
	public static final String ID = "block_kit_tonsui1";

	public Kit_TanaTonsui_1() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != Items_Teatime.Item_DISH || k != 5) {
			if (itemstack.isEmpty()) {
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.Item_DISH, 1, 5));
		...
		if (item == Items_Teatime.Item_DISH && k == 5) {
			...
			if (i == 4) { worldIn.setBlockState(pos, Kitchen_Blocks.KIT_TONSUIA
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) {
			...
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 1, 5)); }

		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 2, 5)); }

		if (i == 3) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 3, 5)); }

		if (i == 4) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 4, 5)); }
		return stack;
	}
