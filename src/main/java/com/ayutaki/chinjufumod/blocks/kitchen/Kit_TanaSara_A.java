...
public class Kit_TanaSara_A extends BaseStage2_Face {

	public static final String ID = "block_kit_saraa";
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) {
			...
			stack.add(new ItemStack(Items_Teatime.Item_SARA, 5, 0)); }

		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_SARA, 6, 0)); }
		return stack;
	}
