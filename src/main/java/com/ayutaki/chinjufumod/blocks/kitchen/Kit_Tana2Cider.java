...
public class Kit_Tana2Cider extends Base_WineTana {

	public Kit_Tana2Cider(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (item != Items_Teatime.CIDERBOT) {
			if (itemstack.isEmpty()) {
				playerIn.inventory.add(new ItemStack(Items_Teatime.CIDERBOT));
