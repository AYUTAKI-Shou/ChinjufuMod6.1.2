...
public class Kit_Tana2Wine extends Base_WineTana {

	public Kit_Tana2Wine(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (item != Items_Teatime.WINEBOT) {
			if (itemstack.isEmpty()) {
				playerIn.inventory.add(new ItemStack(Items_Teatime.WINEBOT));
