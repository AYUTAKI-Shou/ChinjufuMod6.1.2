...
public class Kit_TanaTcup_A extends BaseStage3_Face {

	public static final String ID = "block_kit_tcupa";
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) {
			...
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 5, 2)); }

		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 6, 2)); }

		if (i == 3) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 6, 2));
			stack.add(new ItemStack(Items_Teatime.TEAPOT_kara, 1, 0)); }
		return stack;
	}
