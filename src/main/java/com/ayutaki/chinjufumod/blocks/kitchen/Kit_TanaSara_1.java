...
public class Kit_TanaSara_1 extends BaseKit_Tana4Stage {

	public static final String ID = "block_kit_sara1";

	public Kit_TanaSara_1() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != Items_Teatime.Item_SARA) {
			if (itemstack.isEmpty()) {
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.Item_SARA));
		...
		if (item == Items_Teatime.Item_SARA) {
			...
			if (i == 4) {
				worldIn.setBlockState(pos, Kitchen_Blocks.KIT_SARAA
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 3) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_SARA, 3, 0)); }

		if (i == 4) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_SARA, 4, 0)); }
		return stack;
	}
