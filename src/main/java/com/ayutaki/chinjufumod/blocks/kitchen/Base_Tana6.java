...
public class Base_Tana6 extends Block implements IWaterLoggable {
	...
	public Base_Tana6(AbstractBlock.Properties properties) {
		super(properties);
	...
	protected void createBlockStateDefinition(StateContainer.Builder<Block, BlockState> builder) {
		builder.add(H_FACING, STAGE_1_6, WATERLOGGED);
	}
