...
public class Kit_Tana2Sake extends BaseKit_TanaWine {
	...
	public static final String ID = "block_kit2_sake";

	public Kit_Tana2Sake() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != Items_Teatime.SHINSAKEBOT) {
			if (itemstack.isEmpty()) {
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.SHINSAKEBOT));
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) {
			...
			stack.add(new ItemStack(Items_Teatime.SHINSAKEBOT, 1)); }

		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.SHINSAKEBOT, 2)); }

		if (i == 3) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.SHINSAKEBOT, 3)); }

		if (i == 4) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.SHINSAKEBOT, 4)); }
		return stack;
	}
