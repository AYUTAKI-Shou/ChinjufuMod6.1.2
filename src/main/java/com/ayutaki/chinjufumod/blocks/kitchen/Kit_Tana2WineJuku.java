...
public class Kit_Tana2WineJuku extends BaseKit_TanaWine {

	public static final String ID = "block_kit2_winejuku";

	public Kit_Tana2WineJuku() {
		super(Material.WOOD);
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) {
			...
			stack.add(new ItemStack(Items_Teatime.JUKUWINEBOT, 1)); }

		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.JUKUWINEBOT, 2)); }

		if (i == 3) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.JUKUWINEBOT, 3)); }

		if (i == 4) {
			stack.add(new ItemStack(Items_Teatime.WINE_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.JUKUWINEBOT, 4)); }
		return stack;
	}
