...
public class Base_Tana9 extends Block implements IWaterLoggable {
	...
	public Base_Tana9(AbstractBlock.Properties properties) {
		super(properties);
	...
	protected void createBlockStateDefinition(StateContainer.Builder<Block, BlockState> builder) {
		builder.add(H_FACING, STAGE_1_9, WATERLOGGED);
	}
