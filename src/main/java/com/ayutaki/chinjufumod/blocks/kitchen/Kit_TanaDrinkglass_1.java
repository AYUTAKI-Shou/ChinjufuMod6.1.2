...
public class Kit_TanaDrinkglass_1 extends BaseKit_Tana4Stage {

	public static final String ID = "block_kit_driglass1";

	public Kit_TanaDrinkglass_1() {
		super(Material.WOOD);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item == Items_Teatime.Item_DISH && k == 7) {
			...
			if (i == 4) { worldIn.setBlockState(pos, Kitchen_Blocks.KIT_DRINKGLASSA
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 2, 7)); }

		if (i == 3) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 3, 7)); }

		if (i == 4) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 4, 7)); }
		return stack;
	}
