...
public class Kit_TanaShikki_A extends BaseStage2_Face {

	public static final String ID = "block_kit_shikkia";
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) {
			...
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 5, 4)); }

		if (i == 2) {
			stack.add(new ItemStack(Items_Teatime.KIT_TANA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.Item_DISH, 6, 4)); }
		return stack;
	}
