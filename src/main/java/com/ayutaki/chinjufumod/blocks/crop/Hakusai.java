...
public class Hakusai extends CropsBlock {
	...
	/* Collision */
	protected static final VoxelShape[] SHAPES = new VoxelShape[]{ Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 1.0D, 16.0D),
			...
			Block.makeCuboidShape(4.5D, 0.0D, 5.5D, 11.5D, 9.0D, 11.5D),
			Block.makeCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 10.0D, 12.0D) };

	public Hakusai(Block.Properties properties) {
		super(properties);
	}
