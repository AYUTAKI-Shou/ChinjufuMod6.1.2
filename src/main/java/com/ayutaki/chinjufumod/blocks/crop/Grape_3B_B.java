...
public class Grape_3B_B extends BaseStage4_Face {
	...
	/** 1、2、3、4完熟 **/
	public static final String ID = "block_wood_grape_b";
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (worldIn.getBlockState(pos.up()).getBlock() == Crop_Blocks.BUDOUTOP_B) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 4) { stack.add(new ItemStack(Items_Teatime.BUDOUNOKI, 3, 0)); }
		if (i != 4) { stack.add(new ItemStack(Items_Teatime.BUDOUNOKI, 1, 0)); }
		return stack;
	}
