...
public class Cabbage extends CropsBlock {
	...
	/* Collision */
	protected static final VoxelShape[] SHAPES = new VoxelShape[]{ Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 2.0D, 16.0D),
	...
	public Cabbage(Block.Properties properties) {
		super(properties);
	}
