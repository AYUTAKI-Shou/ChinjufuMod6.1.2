...
public class Grape_C_kare extends BaseStage3_Face {
	...
	/** 収穫後1、枯れ2、3→Bの1 **/
	public static final String ID = "block_wood_grape_c";
		...
		if (worldIn.getBlockState(pos.down()).getBlock() == Blocks.DIRT && worldIn
			...
			if (i == 2) {
				...
				worldIn.setBlockState(pos.up(), Crop_Blocks.BUDOUTOP_C.getDefaultState()
						...
						.withProperty(BaseStage3_Face.STAGE_1_3, Integer.valueOf(i + 1))); }
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (worldIn.getBlockState(pos.up()).getBlock() == Crop_Blocks.BUDOUTOP_C) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 3) { stack.add(new ItemStack(Items_Teatime.BUDOUNOKI, 1, 0)); }
		if (i != 3) { stack.add(new ItemStack(Items_Teatime.BUDOUNOKI, 3, 0)); }
		return stack;
	}
