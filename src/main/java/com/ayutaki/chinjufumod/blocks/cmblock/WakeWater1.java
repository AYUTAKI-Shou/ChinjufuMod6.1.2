...
public class WakeWater1 extends Block {

	public static final String ID = "block_wake_water1";
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (true) { worldIn.setBlockState(pos, Chinjufu_Blocks.WAKE_WATER2.getDefaultState()); }
		worldIn.scheduleUpdate(pos, this, this.tickRate(worldIn));
	}
