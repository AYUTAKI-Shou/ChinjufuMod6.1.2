...
public class WakeWater2 extends Block implements IBucketPickupHandler {
	...
	public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
		...
		worldIn.getBlockTicks().scheduleTick(pos, this, 10);
		worldIn.setBlock(pos, ChinjufuModBlocks.WAKE_WATER3.defaultBlockState(), 3); //must '3'. 4 does not work.
	}
