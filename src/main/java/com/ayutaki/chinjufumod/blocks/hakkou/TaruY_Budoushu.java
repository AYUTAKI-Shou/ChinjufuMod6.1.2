...
public class TaruY_Budoushu extends BlockLog {

	public static final String ID = "block_taru_budoushu_f";

	/* Property */
	public static final PropertyInteger STAGE_0_2 = PropertyInteger.create("stage", 0, 2);

	/** 0=未発酵、1=ワイン、2=熟成ワイン **/
	public TaruY_Budoushu() {
		super();
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side,
		...
		if (i == 2) {
			if (item == Items_Teatime.Item_DISH && k == 8) {
				...
				if (itemstack.isEmpty()) {
					playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.JUKUWINEBOT)); }
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 0) { stack.add(new ItemStack(Items_Teatime.BUDOUSHU_TARU, 1, 0)); }
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_taru_budoushu", meta));
	}
