...
public class Tana_Nori extends BaseTana_Stage05 {
	...
	public Tana_Nori(Block.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i == 5) {
			...
			if (itemstack.isEmpty()) {
				...
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.NORI_I, 4));
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add((new TranslationTextComponent("tips.block_taru_nori")).applyTextStyle(TextFormatting.GRAY));
	}
