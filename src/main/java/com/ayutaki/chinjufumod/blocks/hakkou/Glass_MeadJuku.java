...
public class Glass_MeadJuku extends Base_Glass {
	...
	public Glass_MeadJuku(Block.Properties properties) {
		super(properties);
	}
	...
	public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
		int i = state.get(STAGE_0_2);
		return (i == 0)? new ItemStack(Items_Teatime.JUKUMEADGLASS) : new ItemStack(Items_Teatime.DRINKGLASS);
	}
