...
public class TaruF_Shouyu extends Block implements IWaterLoggable {
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i > 4) {
			if (item == Items.GLASS_BOTTLE) {
				...
				if (itemstack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.SHOUYU_bot_1)); }
