...
public class TaruF_Hakusai1 extends Block implements IWaterLoggable {
	...
	public TaruF_Hakusai1(AbstractBlock.Properties properties) {
		super(properties);
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i == 5) {
			...
			if (itemstack.isEmpty()) {
				...
				playerIn.inventory.add(new ItemStack(Items_Teatime.FOOD_HAKUSAI2));
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add((new TranslationTextComponent("tips.block_taru_hakusai_f")).withStyle(TextFormatting.GRAY));
	}
