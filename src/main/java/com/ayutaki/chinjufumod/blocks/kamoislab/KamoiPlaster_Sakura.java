...
public class KamoiPlaster_Sakura extends BaseStage4_Face {

	public static final PropertyDirection H_FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static final PropertyInteger STAGE_1_4 = PropertyInteger.create("stage", 1, 4);

	public KamoiPlaster_Sakura(Material material, String unlocalizedName) {
		super(material);
