...
public class Nae_Sakura extends BlockBush implements IGrowable {

	public static final String ID = "block_tree_sakura_nae";
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		WorldGenerator worldgenerator =
				(WorldGenerator)(rand.nextInt(40) == 0 ? new WorldGenTree_SakuraBig(true) : new WorldGenTree_Sakura(true));
