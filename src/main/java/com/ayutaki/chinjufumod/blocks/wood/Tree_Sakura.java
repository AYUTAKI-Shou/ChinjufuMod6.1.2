...
public class Tree_Sakura extends Tree {
	...
	/* net.minecraft.world.biome.DefaultBiomeFeatures を参照
	 * 原木, 葉, 基本の高さ.ランダム高さの幅A.葉の高さ.苗木 */
	...
	protected ConfiguredFeature<TreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean b) {
		return randomIn.nextInt(20) == 0 ? TreeFeature.FANCY_TREE.withConfiguration(SAKURA_FANCY_CONFIG) : TreeFeature.NORMAL_TREE.withConfiguration(SAKURA_CONFIG);
	}
