...
public class WorldGenTree_Ichoh extends WorldGenAbstractTree {

	private IBlockState blockStateWood = Seasonal_Blocks.ICHOH_log.getDefaultState();
	private IBlockState blockStateLeaves =
			Seasonal_Blocks.ICHOH_leaf.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

	/*生成される木の高さの最小値 デフォルト4 → 5*/
	private final int minTreeHeight = 5;

	public WorldGenTree_Ichoh(boolean parShouldNotify) {
