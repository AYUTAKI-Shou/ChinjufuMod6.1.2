...
public class Leaf_Kaede extends BlockLeaves {

	public static final String ID = "block_tree_kaede_leaf";
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Items_Seasonal.KAEDE_nae;
	}
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		if (worldIn.isAirBlock(pos.down())) {
			...
			if (rand.nextInt(200) == 0) {
				...
				ChinjufuMod.proxy.spawnParticle(ParticleTypes_CM.FALLKAEDE, d0, d1, d2, d3, -d4, d5);
			}
		}
	}
