...
public class Nae_Kaede extends BlockBush implements IGrowable {

	public static final String ID = "block_tree_kaede_nae";
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		WorldGenerator worldgenerator =
				(WorldGenerator)(rand.nextInt(50) == 0 ? new WorldGenTree_KaedeBig(true) : new WorldGenTree_Kaede(true));
