...
public class WorldGenTree_OakKare extends WorldGenAbstractTree {
	...
	private IBlockState blockStateLeaves =
			Seasonal_Blocks.OAKKARE_leaf.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
