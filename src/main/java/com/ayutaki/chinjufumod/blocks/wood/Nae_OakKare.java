...
public class Nae_OakKare extends BlockBush implements IGrowable {

	public static final String ID = "block_tree_oakkare_nae";
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		WorldGenerator worldgenerator =
				(WorldGenerator)(rand.nextInt(10) == 0 ? new WorldGenTree_OakKareBig(true) : new WorldGenTree_OakKare(true));
