...
public class Leaf_Sakuraflower extends BlockLeaves {

	public static final String ID = "block_tree_sakura_flow";

	public static final PropertyBool DECAYABLE = PropertyBool.create("decayable");
	public static final PropertyBool CHECK_DECAY = PropertyBool.create("check_decay");

	public Leaf_Sakuraflower() {
		super();
	...
	public NonNullList<ItemStack> onSheared(ItemStack item,
			net.minecraft.world.IBlockAccess worldIn, BlockPos pos, int fortune) {
	...
	public java.util.List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (rand.nextInt(chance) == 0)
			stack.add(new ItemStack(Items_Seasonal.SAKURA_nae, 1, damageDropped(state)));

		if (rand.nextInt(chance) == 0)
			stack.add(new ItemStack(Items_Teatime.FOOD_CHERRY, 1, damageDropped(state)));
