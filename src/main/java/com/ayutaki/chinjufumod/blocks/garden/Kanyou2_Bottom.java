...
public class Kanyou2_Bottom extends Block {

	/* Property */
	public static final PropertyInteger STAGE_0_9 = PropertyInteger.create("stage", 0, 9);

	public static final String ID = "block_kanyou2_bottom";

	public Kanyou2_Bottom() {
		super(Material.WOOD);
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (worldIn.getBlockState(pos.up()).getBlock() == Garden_Blocks.KANYOU2_TOP) {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 0) { stack.add(new ItemStack(Items_Wadeco.KANYOU_BOT, 1, 0)); }
		if (i == 1) { stack.add(new ItemStack(Items_Wadeco.KANYOU_BOT, 1, 1)); }
		if (i == 2) { stack.add(new ItemStack(Items_Wadeco.KANYOU_BOT, 1, 2)); }
		if (i == 3) { stack.add(new ItemStack(Items_Wadeco.KANYOU_BOT, 1, 3)); }
		if (i == 4) { stack.add(new ItemStack(Items_Wadeco.KANYOU_BOT, 1, 4)); }
		if (i == 5) { stack.add(new ItemStack(Items_Wadeco.KANYOU_BOT, 1, 5)); }
		if (i == 6) { stack.add(new ItemStack(Items_Seasonal.SKANYOU_BOT, 1, 0)); }
		if (i == 7) { stack.add(new ItemStack(Items_Seasonal.SKANYOU_BOT, 1, 1)); }
		if (i == 8) { stack.add(new ItemStack(Items_Seasonal.SKANYOU_BOT, 1, 2)); }
		if (i == 9) { stack.add(new ItemStack(Items_Seasonal.SKANYOU_BOT, 1, 3)); }
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if (i == 9) { return new ItemStack(Items_Seasonal.SKANYOU_BOT, 1, 3); }
		return new ItemStack(Items_Wadeco.KANYOU_BOT, 1, 0);
	}
