...
public class Kanyou_Bottom extends Block {

	/* Property */
	public static final PropertyInteger STAGE_0_9 = PropertyInteger.create("stage", 0, 9);

	public static final String ID = "block_kanyou_bottom";

	public Kanyou_Bottom() {
		super(Material.WOOD);
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		...
		if (worldIn.getBlockState(pos.up()).getBlock() == Garden_Blocks.KANYOU_TOP) {
