...
public class Chabudai extends BaseUnitBlock {
	...
	/* Collision */
	protected static final VoxelShape TTTT = Block.box(0.0D, 7.0D, 0.0D, 16.0D, 8.0D, 16.0D);

	protected static final VoxelShape FFFF = VoxelShapes.or(Block.box(0.0D, 7.0D, 5.0D, 1.0D, 8.0D, 11.0D),
	...
	protected static final VoxelShape TTFF = VoxelShapes.or(Block.box(13.0D, 7.0D, 13.0D, 16.0D, 8.0D, 14.0D),
	...
	protected static final VoxelShape FTFT = VoxelShapes.or(Block.box(0.0D, 7.0D, 13.0D, 3.0D, 8.0D, 14.0D),
	...
	protected static final VoxelShape TFTF = VoxelShapes.or(Block.box(13.0D, 7.0D, 2.0D, 16.0D, 8.0D, 3.0D),
	...
	protected static final VoxelShape FFTT = VoxelShapes.or(Block.box(0.0D, 7.0D, 2.0D, 3.0D, 8.0D, 3.0D),
	...
	protected static final VoxelShape FTTT = VoxelShapes.or(Block.box(0.0D, 7.0D, 0.0D, 15.0D, 8.0D, 16.0D),
			Block.box(15.0D, 7.0D, 3.0D, 16.0D, 8.0D, 13.0D));
	protected static final VoxelShape TTTF = VoxelShapes.or(Block.box(1.0D, 7.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 7.0D, 3.0D, 1.0D, 8.0D, 13.0D));
	protected static final VoxelShape TTFT = VoxelShapes.or(Block.box(0.0D, 7.0D, 0.0D, 16.0D, 8.0D, 15.0D),
			Block.box(3.0D, 7.0D, 15.0D, 13.0D, 8.0D, 16.0D));
	protected static final VoxelShape TFTT = VoxelShapes.or(Block.box(0.0D, 7.0D, 1.0D, 16.0D, 8.0D, 16.0D),
			Block.box(3.0D, 7.0D, 0.0D, 13.0D, 8.0D, 1.0D));

	public Chabudai(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add((new TranslationTextComponent("tips.block_chabudai")).withStyle(TextFormatting.GRAY));
	}
