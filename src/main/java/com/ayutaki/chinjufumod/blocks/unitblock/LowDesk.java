...
public class LowDesk extends BaseUnitBlock {
	...
	protected static final VoxelShape FFFF = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
	...
	protected static final VoxelShape TTFF = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 13.0D, 3.0D, 6.0D, 16.0D));
	protected static final VoxelShape FTFT = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(13.0D, 0.0D, 13.0D, 16.0D, 6.0D, 16.0D));
	protected static final VoxelShape TFTF = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 3.0D, 6.0D, 3.0D));
	protected static final VoxelShape FFTT = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(13.0D, 0.0D, 0.0D, 16.0D, 6.0D, 3.0D));

	protected static final VoxelShape FTFF = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 14.0D, 2.0D, 6.0D, 16.0D),
			Block.box(14.0D, 0.0D, 14.0D, 16.0D, 6.0D, 16.0D));
	protected static final VoxelShape FFTF = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 2.0D, 6.0D, 2.0D),
			Block.box(14.0D, 0.0D, 0.0D, 16.0D, 6.0D, 2.0D));
	protected static final VoxelShape TFFF = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 2.0D, 6.0D, 2.0D),
			Block.box(0.0D, 0.0D, 14.0D, 2.0D, 6.0D, 16.0D));
	protected static final VoxelShape FFFT = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(14.0D, 0.0D, 0.0D, 16.0D, 6.0D, 2.0D),
			Block.box(14.0D, 0.0D, 14.0D, 16.0D, 6.0D, 16.0D));

	public LowDesk(AbstractBlock.Properties properties) {
		super(properties);
	}
