...
public class TrayFude extends Block implements IWaterLoggable {
	...
	public TrayFude(AbstractBlock.Properties properties) {
		super(properties);
					...
					if (Config_CM.getInstance().useMAKIMONO() == true) {
						...
						default :
							...
							if (eaststate.getMaterial().isReplaceable()) {
								...
								worldIn.setBlock(pos.east(), Unit_Blocks.WRITTEN_MAKIMONO.defaultBlockState()
							...
							if (!(eaststate.getMaterial().isReplaceable())) {
								...
								if (eastblock != Unit_Blocks.WRITTEN_MAKIMONO ||
									...
									if (southstate.getMaterial().isReplaceable()) {
										this.writebook(worldIn, pos, playerIn, hand);
										worldIn.setBlock(pos.south(), Unit_Blocks.WRITTEN_MAKIMONO.defaultBlockState()
												.setValue(WrittenMakimono.H_FACING, Direction.NORTH)
												.setValue(WrittenMakimono.DOWN, state.getValue(WrittenMakimono.DOWN))
												.setValue(WrittenMakimono.WATERLOGGED, state.getValue(WrittenMakimono.WATERLOGGED)), 3); }
									...
									if (!(southstate.getMaterial().isReplaceable())) {
										...
										if (southblock != Unit_Blocks.WRITTEN_MAKIMONO ||
											...
											if (weststate.getMaterial().isReplaceable()) {
												this.writebook(worldIn, pos, playerIn, hand);
												worldIn.setBlock(pos.west(), Unit_Blocks.WRITTEN_MAKIMONO.defaultBlockState()
														.setValue(WrittenMakimono.H_FACING, Direction.NORTH)
														.setValue(WrittenMakimono.DOWN, state.getValue(WrittenMakimono.DOWN))
														.setValue(WrittenMakimono.WATERLOGGED, state.getValue(WrittenMakimono.WATERLOGGED)), 3); }
							...
							if (!(weststate.getMaterial().isReplaceable())) {
								...
								if (westblock != Unit_Blocks.WRITTEN_MAKIMONO ||
									...
									if (northstate.getMaterial().isReplaceable()) {
										this.writebook(worldIn, pos, playerIn, hand);
										worldIn.setBlock(pos.north(), Unit_Blocks.WRITTEN_MAKIMONO.defaultBlockState()
												.setValue(WrittenMakimono.H_FACING, Direction.SOUTH)
												.setValue(WrittenMakimono.DOWN, state.getValue(WrittenMakimono.DOWN))
												.setValue(WrittenMakimono.WATERLOGGED, state.getValue(WrittenMakimono.WATERLOGGED)), 3); }
