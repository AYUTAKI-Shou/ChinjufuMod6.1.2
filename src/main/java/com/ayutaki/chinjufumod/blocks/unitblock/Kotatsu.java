...
public class Kotatsu extends BaseUnitDesk {

	/** 0=オーク、1=マツ、2=シラカバ、3=ジャングル、4=アカシア、5=ダークオーク、
	 ** 6=サクラ、7=カエデ、8=イチョウ **/
	public static final String ID = "block_kotatsu";
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (itemstack.isEmpty()) {
			if (playerIn.isSneaking()) {
				...
				if (i == 0) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(0))); }
				if (i == 1) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(1))); }
				if (i == 2) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(2))); }
				if (i == 3) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(3))); }
				if (i == 4) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(4))); }
				if (i == 5) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(5))); }
				if (i == 6) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(6))); }
				if (i == 7) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(7))); }
				if (i == 8) { worldIn.setBlockState(pos, Unit_Blocks.KOTATSU_sub.getDefaultState()
						.withProperty(Kotatsu_sub.STAGE_0_8, Integer.valueOf(8))); } }
