...
public class ShoujiHalf_seasonal extends BaseStage4_Face {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.SHOUJIH_SAKU) { stack.add(new ItemStack(Items_Seasonal.SHOUJIH_SAKU, 1, 0)); }
		if (this == Slidingdoor_Blocks.SHOUJIH_KAE) { stack.add(new ItemStack(Items_Seasonal.SHOUJIH_KAE, 1, 0)); }
		if (this == Slidingdoor_Blocks.SHOUJIH_ICH) { stack.add(new ItemStack(Items_Seasonal.SHOUJIH_ICH, 1, 0)); }
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if (this == Slidingdoor_Blocks.SHOUJIH_SAKU) { return new ItemStack(Items_Seasonal.SHOUJIH_SAKU, 1, 0); }
		if (this == Slidingdoor_Blocks.SHOUJIH_KAE) { return new ItemStack(Items_Seasonal.SHOUJIH_KAE, 1, 0); }
		if (this == Slidingdoor_Blocks.SHOUJIH_ICH) { return new ItemStack(Items_Seasonal.SHOUJIH_ICH, 1, 0); }
		return new ItemStack(Slidingdoor_Blocks.SHOUJIH, 1, 0);
	}
