...
public class ShoujiHalf extends BaseStage4_Face {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidingdoor_Blocks.SHOUJIH) { stack.add(new ItemStack(Items_Wadeco.SHOUJIH, 1, 0)); }
		if (this == Slidingdoor_Blocks.SHOUJIH_SPRU) { stack.add(new ItemStack(Items_Wadeco.SHOUJIH_SPRU, 1, 0)); }
		if (this == Slidingdoor_Blocks.SHOUJIH_BIR) { stack.add(new ItemStack(Items_Wadeco.SHOUJIH_BIR, 1, 0)); }
		if (this == Slidingdoor_Blocks.SHOUJIH_JUN) { stack.add(new ItemStack(Items_Wadeco.SHOUJIH_JUN, 1, 0)); }
		if (this == Slidingdoor_Blocks.SHOUJIH_ACA) { stack.add(new ItemStack(Items_Wadeco.SHOUJIH_ACA, 1, 0)); }
		if (this == Slidingdoor_Blocks.SHOUJIH_DOAK) { stack.add(new ItemStack(Items_Wadeco.SHOUJIH_DOAK, 1, 0)); }
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if (this == Slidingdoor_Blocks.SHOUJIH_SPRU) { return new ItemStack(Items_Wadeco.SHOUJIH_SPRU, 1, 0); }
		if (this == Slidingdoor_Blocks.SHOUJIH_BIR) { return new ItemStack(Items_Wadeco.SHOUJIH_BIR, 1, 0); }
		if (this == Slidingdoor_Blocks.SHOUJIH_JUN) { return new ItemStack(Items_Wadeco.SHOUJIH_JUN, 1, 0); }
		if (this == Slidingdoor_Blocks.SHOUJIH_ACA) { return new ItemStack(Items_Wadeco.SHOUJIH_ACA, 1, 0); }
		if (this == Slidingdoor_Blocks.SHOUJIH_DOAK) { return new ItemStack(Items_Wadeco.SHOUJIH_DOAK, 1, 0); }
		return new ItemStack(Items_Wadeco.SHOUJIH, 1, 0);
	}
