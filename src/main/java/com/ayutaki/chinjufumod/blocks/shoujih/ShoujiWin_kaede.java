...
public class ShoujiWin_kaede extends BaseShouji_Win {

	public ShoujiWin_kaede() {
		super(Material.WOOD);
	...
	public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing,
		...
		if (placer.isSneaking()) {
			return Slidingdoor_Blocks.SHOUJIWINR_kaede.getDefaultState()
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Seasonal.SHOUJIWIN_kaede, 1, 0));
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Seasonal.SHOUJIWIN_kaede);
	}
