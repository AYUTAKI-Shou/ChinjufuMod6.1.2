...
public class Sofa_lime extends BaseSofa {

	public static final String ID = "block_sofa_lime";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_lime && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_lime && right_block.getValue(H_FACING).equals(facing);
