...
public class Sofa_red extends BaseSofa {

	public static final String ID = "block_sofa_red";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_red && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_red && right_block.getValue(H_FACING).equals(facing);
