...
public class Sofa_magenta extends BaseSofa {

	public static final String ID = "block_sofa_magenta";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_magenta && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_magenta && right_block.getValue(H_FACING).equals(facing);
