...
public class Sofa_yellow extends BaseSofa {

	public static final String ID = "block_sofa_yellow";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_yellow && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_yellow && right_block.getValue(H_FACING).equals(facing);
