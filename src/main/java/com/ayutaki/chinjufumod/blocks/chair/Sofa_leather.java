...
public class Sofa_leather extends BaseSofa {
	...
	public static final String ID = "block_sofa_leather";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_leather && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_leather && right_block.getValue(H_FACING).equals(facing);
