...
public class Bench_acacia extends BaseBench {

	public static final String ID = "block_bench_aca";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_acacia && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_acacia && right_block.getValue(H_FACING).equals(facing);
