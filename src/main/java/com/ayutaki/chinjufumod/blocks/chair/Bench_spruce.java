...
public class Bench_spruce extends BaseBench {

	public static final String ID = "block_bench_spru";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_spruce && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_spruce && right_block.getValue(H_FACING).equals(facing);
