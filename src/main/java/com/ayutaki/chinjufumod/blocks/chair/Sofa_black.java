...
public class Sofa_black extends BaseSofa {

	public static final String ID = "block_sofa_black";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_black && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_black && right_block.getValue(H_FACING).equals(facing);
