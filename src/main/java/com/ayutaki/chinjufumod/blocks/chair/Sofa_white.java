...
public class Sofa_white extends BaseSofa {

	public static final String ID = "block_sofa_white";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_white && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_white && right_block.getValue(H_FACING).equals(facing);
