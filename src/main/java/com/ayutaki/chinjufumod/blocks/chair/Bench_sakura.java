...
public class Bench_sakura extends BaseBench {

	public static final String ID = "block_bench_saku";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_sakura && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_sakura && right_block.getValue(H_FACING).equals(facing);
