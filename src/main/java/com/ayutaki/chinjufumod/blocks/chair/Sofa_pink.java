...
public class Sofa_pink extends BaseSofa {

	public static final String ID = "block_sofa_pink";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_pink && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_pink && right_block.getValue(H_FACING).equals(facing);
