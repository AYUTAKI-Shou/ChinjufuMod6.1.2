...
public class BaseSofa extends Block implements IWaterLoggable {
	...
	public BaseSofa(AbstractBlock.Properties properties) {
		super(properties);
	...
	private BlockState getConnectState(BlockState state, IWorld worldIn, BlockPos pos, Direction dir) {
		...
		if(left && right) { return state.setValue(TYPE, Type.BOTH); }

		else if(left) { return state.setValue(TYPE, Type.RIGHT); }

		else if(right) { return state.setValue(TYPE, Type.LEFT); }
