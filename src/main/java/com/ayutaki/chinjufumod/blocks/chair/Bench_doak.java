...
public class Bench_doak extends BaseBench {

	public static final String ID = "block_bench_doak";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_doak && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_doak && right_block.getValue(H_FACING).equals(facing);
