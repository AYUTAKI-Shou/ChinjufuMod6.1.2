...
public class Sofa_green extends BaseSofa {

	public static final String ID = "block_sofa_green";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_green && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_green && right_block.getValue(H_FACING).equals(facing);
