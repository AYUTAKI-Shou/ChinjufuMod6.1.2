...
public class Sofa_lightgray extends BaseSofa {

	public static final String ID = "block_sofa_lightgray";
	/* つなげたくないから旧式のまま */
	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);

	public Sofa_lightgray() {
		super();
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_lightgray && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_lightgray && right_block.getValue(H_FACING).equals(facing);
