...
public class Sofa_gray extends BaseSofa {

	public static final String ID = "block_sofa_gray";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_gray && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_gray && right_block.getValue(H_FACING).equals(facing);
