...
public class Bench_jungle extends BaseBench {

	public static final String ID = "block_bench_jun";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_jungle && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_jungle && right_block.getValue(H_FACING).equals(facing);
