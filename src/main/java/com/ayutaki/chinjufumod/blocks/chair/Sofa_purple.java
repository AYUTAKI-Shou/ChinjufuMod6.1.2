...
public class Sofa_purple extends BaseSofa {

	public static final String ID = "block_sofa_purple";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_purple && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_purple && right_block.getValue(H_FACING).equals(facing);
