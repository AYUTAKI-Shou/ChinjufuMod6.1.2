...
public class Sofa_blue extends BaseSofa {

	public static final String ID = "block_sofa_blue";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_blue && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_blue && right_block.getValue(H_FACING).equals(facing);
