...
public class Bench_birch extends BaseBench {

	public static final String ID = "block_bench_bir";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_birch && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_birch && right_block.getValue(H_FACING).equals(facing);
