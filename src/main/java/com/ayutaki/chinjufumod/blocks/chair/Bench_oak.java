...
public class Bench_oak extends BaseBench {

	public static final String ID = "block_bench";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_oak && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_oak && right_block.getValue(H_FACING).equals(facing);
