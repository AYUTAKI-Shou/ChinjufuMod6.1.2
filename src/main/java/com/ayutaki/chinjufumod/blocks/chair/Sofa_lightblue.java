...
public class Sofa_lightblue extends BaseSofa {

	public static final String ID = "block_sofa_lightblue";
	/* つなげたくないから旧式のまま */
	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);

	public Sofa_lightblue() {
		super();
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_lightblue && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_lightblue && right_block.getValue(H_FACING).equals(facing);
