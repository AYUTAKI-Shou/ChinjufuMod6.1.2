...
public class Sofa_orange extends BaseSofa {

	public static final String ID = "block_sofa_orange";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_orange && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_orange && right_block.getValue(H_FACING).equals(facing);
