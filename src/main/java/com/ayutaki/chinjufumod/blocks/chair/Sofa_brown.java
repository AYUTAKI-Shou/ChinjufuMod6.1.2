...
public class Sofa_brown extends BaseSofa {

	public static final String ID = "block_sofa_brown";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Sofa_brown && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Sofa_brown && right_block.getValue(H_FACING).equals(facing);
