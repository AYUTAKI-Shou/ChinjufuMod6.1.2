...
public class LogChair extends BaseWaterLoggable {

	/* Collision */
	protected static final VoxelShape AABB_BOX = Block.makeCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 10.0D, 12.0D);

	public LogChair(Block.Properties properties) {
		super(properties);
	}
