...
public class Bench_ichoh extends BaseBench {

	public static final String ID = "block_bench_ich";
	/* つなげたくないから旧式のまま */
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Bench_ichoh && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Bench_ichoh && right_block.getValue(H_FACING).equals(facing);
