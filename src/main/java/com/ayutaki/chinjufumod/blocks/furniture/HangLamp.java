...
public class HangLamp extends Block {

	public static final String ID = "block_lamp";
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		worldIn.setBlockState(pos, Lamp_Blocks.LIT_LAMP.getDefaultState().withProperty(FACING, state.getValue(FACING)), 3);
	...
	public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing,
		...
		if (iblockstate.getBlock() == Lamp_Blocks.LAMP) {
