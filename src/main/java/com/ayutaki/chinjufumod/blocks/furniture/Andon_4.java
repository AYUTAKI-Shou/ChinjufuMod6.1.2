...
public class Andon_4 extends BaseStage4_Face {

	public static final String ID = "block_andon_4";
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) { stack.add(new ItemStack(Items_Wadeco.ANDON_4, 1, 1)); }
		if (i == 2) { stack.add(new ItemStack(Items_Wadeco.ANDON_4, 1, 2)); }
		if (i == 3) { stack.add(new ItemStack(Items_Wadeco.ANDON_4, 1, 3)); }
		if (i == 4) { stack.add(new ItemStack(Items_Wadeco.ANDON_4, 1, 4)); }
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		return new ItemStack(Items_Wadeco.ANDON_4, 1, 1);
	}
