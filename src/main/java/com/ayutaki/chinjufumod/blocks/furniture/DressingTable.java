...
public class DressingTable extends Block implements IWaterLoggable {
	...
	protected static final VoxelShape BOT_SOUTH = VoxelShapes.or(BASE, Block.box(1.0D, 12.0D, 0.0D, 15.0D, 16.0D, 2.0D));
	protected static final VoxelShape BOT_WEST = VoxelShapes.or(BASE, Block.box(14.0D, 12.0D, 1.0D, 16.0D, 16.0D, 15.0D));
	protected static final VoxelShape BOT_NORTH = VoxelShapes.or(BASE, Block.box(1.0D, 12.0D, 14.0D, 15.0D, 16.0D, 16.0D));
	protected static final VoxelShape BOT_EAST = VoxelShapes.or(BASE, Block.box(0.0D, 12.0D, 1.0D, 2.0D, 16.0D, 15.0D));
	...
	public DressingTable(AbstractBlock.Properties properties) {
		super(properties);
