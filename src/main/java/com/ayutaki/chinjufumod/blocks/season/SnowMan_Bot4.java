...
public class SnowMan_Bot4 extends Base_SnowManBot {

	/** TOP4 LightGray=9, Cyan=10, Purple=11, Blue=12 **/
	public static final String ID = "block_snowman_bot4";
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item == Item.getItemFromBlock(Blocks.SNOW_LAYER)) {
			...
			case 1 :
			default :
				worldIn.setBlockState(pos, Seasonal_Blocks.SNOWMAN_BOT4D.getDefaultState()
