...
public class SnowMan_Bot2 extends Base_SnowManBot {

	/** TOP2 White=1, Orange=2, Magenta=3, LightBlue=4 **/
	public static final String ID = "block_snowman_bot2";
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item == Item.getItemFromBlock(Blocks.SNOW_LAYER)) {
			...
			case 1 :
			default :
				worldIn.setBlockState(pos, Seasonal_Blocks.SNOWMAN_BOT2D.getDefaultState()
