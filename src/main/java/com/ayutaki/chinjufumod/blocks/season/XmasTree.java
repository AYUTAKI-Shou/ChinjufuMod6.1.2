...
public class XmasTree extends Block implements IWaterLoggable {
	...
	/* Collision */
	protected static final VoxelShape AABB_BOT = VoxelShapes.or(Block.box(1.5D, 12.0D, 1.5D, 14.5D, 16.0D, 14.5D),
	...
	protected static final VoxelShape AABB_TOP = VoxelShapes.or(Block.box(6.0D, 8.0D, 6.0D, 10.0D, 12.0D, 10.0D),
			Block.box(4.5D, 4.0D, 4.5D, 11.5D, 8.0D, 11.5D),
			Block.box(3.0D, 0.0D, 3.0D, 13.0D, 4.0D, 13.0D));

	public XmasTree(AbstractBlock.Properties properties) {
		super(properties);
