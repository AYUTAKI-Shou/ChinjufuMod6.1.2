...
public class Kamoi_Oak extends Base_Kamoi {
	...
	public Kamoi_Oak(Block.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (!playerIn.isSneaking()) {
			...
			if (item == Items_Wablock.SHIKKUI_SH_white) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_white_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_orange) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_orange_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lightb) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_lightb_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_yellow) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_yellow_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lime) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_lime_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_pink) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_pink_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_gray) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_gray_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lightg) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_lightg_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_cyan) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_cyan_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_purple) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_purple_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_blue) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_blue_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_brown) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_brown_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_green) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_red) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_red_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_black) {
				...
				worldIn.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_black_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items.OAK_SLAB) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_oak_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items.SPRUCE_SLAB) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_spru_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items.BIRCH_SLAB) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_bir_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items.JUNGLE_SLAB) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_jun_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items.ACACIA_SLAB) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_aca_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items.DARK_OAK_SLAB) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_doak_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.SAKURA_slabhalf) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_saku_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.KAEDE_slabhalf) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_kae_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.ICHOH_slabhalf) {
				...
				worldIn.setBlockState(pos, KamoiPlanks_Blocks.KAMOI_ich_oak.getDefaultState()
						.with(H_FACING, state.get(H_FACING))
						.with(STAGE_1_4, state.get(STAGE_1_4)), 3);
