...
public class Kamoi_DarkOak extends Base_Kamoi {
	...
	public Kamoi_DarkOak(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (!playerIn.isCrouching()) {
			if (item == Items_Wablock.DIRTWALL_SH) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_dirt_doak.defaultBlockState()
			...
			if (item == Items_Wablock.SHIKKUI_SH_white) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_white_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_orange) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_orange_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_magenta) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_magenta_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lightb) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_yellow) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_yellow_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lime) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lime_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_pink) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_pink_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_gray) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_gray_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lightg) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_cyan) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_cyan_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_purple) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_blue) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_blue_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_brown) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_brown_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_green) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_green_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_red) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_red_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_black) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_black_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.OAK_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_oak_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.SPRUCE_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_spru_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.BIRCH_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_bir_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.JUNGLE_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_jun_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.ACACIA_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_aca_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.DARK_OAK_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_doak_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.SAKURA_slabhalf) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_saku_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.KAEDE_slabhalf) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_kae_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.ICHOH_slabhalf) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_ich_doak.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
