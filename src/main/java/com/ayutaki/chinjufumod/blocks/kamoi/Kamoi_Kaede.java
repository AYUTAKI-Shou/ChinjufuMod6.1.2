...
public class Kamoi_Kaede extends Base_Kamoi {
	...
	public Kamoi_Kaede(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (!playerIn.isCrouching()) {
			if (item == Items_Wablock.DIRTWALL_SH) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_dirt_kaede.defaultBlockState()
			...
			if (item == Items_Wablock.SHIKKUI_SH_white) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_white_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_orange) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_orange_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_magenta) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_magenta_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lightb) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_yellow) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_yellow_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lime) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lime_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_pink) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_pink_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_gray) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_gray_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_lightg) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_cyan) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_cyan_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_purple) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_blue) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_blue_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_brown) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_brown_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_green) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_green_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_red) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_red_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Wablock.SHIKKUI_SH_black) {
				...
				worldIn.setBlock(pos, KamoiPlaster_Blocks.KAMOI_black_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.OAK_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_oak_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.SPRUCE_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_spru_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.BIRCH_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_bir_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.JUNGLE_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_jun_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.ACACIA_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_aca_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items.DARK_OAK_SLAB) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_doak_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.SAKURA_slabhalf) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_saku_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.KAEDE_slabhalf) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_kae_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
			...
			if (item == Items_Seasonal.ICHOH_slabhalf) {
				...
				worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_ich_kaede.defaultBlockState()
						.setValue(H_FACING, state.getValue(H_FACING))
						.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
