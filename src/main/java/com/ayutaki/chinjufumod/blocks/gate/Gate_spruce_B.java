...
public class Gate_spruce_B extends BaseGate {

	public static final String ID = "block_gate_spruce_b";
	...
	private SoundEvent getCloseSound() {
		return SoundEvents_CM.GATE_WOOD;
	}
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return state.getValue(HALF) == BlockStateHalf.UPPER ? Items.AIR : Items_Wadeco.GATE_SPRUCE_B;
	}

	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(Items_Wadeco.GATE_SPRUCE_B);
	}
