...
public class Gate_spruce extends BaseGate {
	...
	public static final String ID = "block_gate_spruce";
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return state.getValue(HALF) == BlockStateHalf.UPPER ? Items.AIR : Items_Wadeco.GATE_SPRUCE;
	}

	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(Items_Wadeco.GATE_SPRUCE);
	}
