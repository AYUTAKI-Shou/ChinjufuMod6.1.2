...
public class Gate_irongrill extends BaseGate {
	...
	/* Collision */
	protected static final VoxelShape CLOSEL_SOUTH = Block.box(0.0D, 0.0D, 7.5D, 32.0D, 32.0D, 8.5D);
	protected static final VoxelShape CLOSEL_WEST = Block.box(7.5D, 0.0D, 0.0D, 8.5D, 32.0D, 32.0D);
	protected static final VoxelShape CLOSEL_NORTH = Block.box(-16.0D, 0.0D, 7.5D, 16.0D, 32.0D, 8.5D);
	protected static final VoxelShape CLOSEL_EAST = Block.box(7.5D, 0.0D, -16.0D, 8.5D, 32.0D, 16.0D);

	protected static final VoxelShape OPENL_SOUTH = Block.box(15.9D, 0.0D, 8.0D, 32.0D, 32.0D, 36.0D);
	protected static final VoxelShape OPENL_WEST = Block.box(-20.0D, 0.0D, 15.9D, 8.0D, 32.0D, 32.0D);
	protected static final VoxelShape OPENL_NORTH = Block.box(-16.0D, 0.0D, -20.0D, 0.1D, 32.0D, 8.0D);
	protected static final VoxelShape OPENL_EAST = Block.box(8.0D, 0.0D, -16.0D, 36.0D, 32.0D, 0.1D);

	protected static final VoxelShape CLOSER_SOUTH = Block.box(-16.0D, 0.0D, 7.5D, 16.0D, 32.0D, 8.5D);
	protected static final VoxelShape CLOSER_WEST = Block.box(7.5D, 0.0D, -16.0D, 8.5D, 32.0D, 16.0D);
	protected static final VoxelShape CLOSER_NORTH = Block.box(0.0D, 0.0D, 7.5D, 32.0D, 32.0D, 8.5D);
	protected static final VoxelShape CLOSER_EAST = Block.box(7.5D, 0.0D, 0.0D, 8.5D, 32.0D, 32.0D);

	protected static final VoxelShape OPENR_SOUTH = Block.box(-16.0D, 0.0D, 8.0D, 0.1D, 32.0D, 36.0D);
	protected static final VoxelShape OPENR_WEST = Block.box(-20.0D, 0.0D, -16.0D, 8.0D, 32.0D, 0.1D);
	protected static final VoxelShape OPENR_NORTH = Block.box(15.9D, 0.0D, -20.0D, 32.0D, 32.0D, 8.0D);
	protected static final VoxelShape OPENR_EAST = Block.box(8.0D, 0.0D, 15.9D, 36.0D, 32.0D, 32.0D);
