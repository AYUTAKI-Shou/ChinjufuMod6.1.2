...
public class RanmaC_doak extends BaseRanma {

	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);
	public static final PropertyInteger VER = PropertyInteger.create("ver", 1, 2);

	public RanmaC_doak(Material material, String unlocalizedName) {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof RanmaC_doak && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof RanmaC_doak && right_block.getValue(H_FACING).equals(facing);
