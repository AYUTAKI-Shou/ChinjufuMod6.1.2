...
public class Kanki_ich extends BaseRanma {

	public static final PropertyEnum<Type> TYPE = PropertyEnum.create("type", Type.class);
	public static final PropertyInteger VER = PropertyInteger.create("ver", 1, 2);

	public Kanki_ich(Material material, String unlocalizedName) {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		boolean left = left_block.getBlock() instanceof Kanki_ich && left_block.getValue(H_FACING).equals(facing);
		boolean right = right_block.getBlock() instanceof Kanki_ich && right_block.getValue(H_FACING).equals(facing);
