...
public class Tatami_Y extends BaseFacingSlab_Water {

	public Tatami_Y(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add((new TranslationTextComponent("tips.block_tatami")).withStyle(TextFormatting.GRAY));
	}
