...
public class BambooCube extends RotatedPillarBlock implements IWaterLoggable {
	...
	public BambooCube(AbstractBlock.Properties properties) {
		super(properties);
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		return this.defaultBlockState().setValue(AXIS, context.getClickedFace().getAxis()).setValue(WATERLOGGED, Boolean.valueOf(fluid.getType() == Fluids.WATER));
	}
