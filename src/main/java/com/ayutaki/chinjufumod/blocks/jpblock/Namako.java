...
public class Namako extends Base_JpFull {

	public static final String ID = "block_namako";
		...
		if (item instanceof Base_ItemHake) { return false; }
			...
			if (itemstack.isEmpty()) {
				if (playerIn.isSneaking()) {
					...
					if (i == 0) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(0))); }
					if (i == 1) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(1))); }
					if (i == 2) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(2))); }
					if (i == 3) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(3))); }
					if (i == 4) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(4))); }
					if (i == 5) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(5))); }
					if (i == 6) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(6))); }
					if (i == 7) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(7))); }
					if (i == 8) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(8))); }
					if (i == 9) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(9))); }
					if (i == 10) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(10))); }
					if (i == 11) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(11))); }
					if (i == 12) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(12))); }
					if (i == 13) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(13))); }
					if (i == 14) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
							.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(14))); }
					if (i == 15) { worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_CR.getDefaultState()
