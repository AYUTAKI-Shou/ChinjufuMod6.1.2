...
public class BaseStage2_WP extends BaseFacingSapo {
	...
	protected int getLog(IBlockState state) {
		return ((Integer)state.getValue(STAGE_1_2)).intValue() * 2;
	}
	...
	protected BlockStateContainer createBlockState() {
		return new BlockStateContainer(this, new IProperty[] { H_FACING, STAGE_1_2 });
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.wp_stage2", meta));
	}
