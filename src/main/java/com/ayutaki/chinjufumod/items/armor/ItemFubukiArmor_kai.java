...
public class ItemFubukiArmor_kai extends ItemArmor {

	public ItemFubukiArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.FUBUKI, renderIndexIn, equipmentSlotIn);
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.FUBUKI_BOOTS_KAI) {}
