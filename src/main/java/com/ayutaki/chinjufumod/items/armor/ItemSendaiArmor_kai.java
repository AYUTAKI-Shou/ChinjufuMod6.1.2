...
import com.ayutaki.chinjufumod.items.armor.model.ModelSendaiBody;
...
public class ItemSendaiArmor_kai extends ItemArmor {

	public ItemSendaiArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.SENDAI, renderIndexIn, equipmentSlotIn);
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.SENDAI_BOOTS_KAI) {}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
		...
		if (!itemStack.isEmpty()) {
			...
			if (itemStack.getItem() instanceof ItemArmor) {
				...
				ModelSendaiBody armorModel = new ModelSendaiBody(1.0f);
				ModelSendaiBody armorModelLegs = new ModelSendaiBody(0.5f);
