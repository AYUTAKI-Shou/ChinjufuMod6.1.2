...
public class ItemKasumiArmor_kai extends ItemArmor {

	public ItemKasumiArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.KASUMI_BOOTS_KAI) {}
