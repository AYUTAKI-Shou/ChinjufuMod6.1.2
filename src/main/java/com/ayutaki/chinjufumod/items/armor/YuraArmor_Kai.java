...
public class YuraArmor_Kai extends ArmorItem {

	public YuraArmor_Kai(IArmorMaterial material, EquipmentSlotType slot, Properties properties) {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entity, int slot, boolean selected) {
		...
		if(entity instanceof PlayerEntity) {
			...
			if(playerIn.getItemStackFromSlot(EquipmentSlotType.FEET).getItem() == Items_Armor.YURA_BOOTS_KAI) {
