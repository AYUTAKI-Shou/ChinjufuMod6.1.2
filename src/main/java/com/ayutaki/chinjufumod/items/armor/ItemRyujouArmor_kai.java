...
import com.ayutaki.chinjufumod.items.armor.model.ModelRJBody;
...
public class ItemRyujouArmor_kai extends ItemArmor {

	public ItemRyujouArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.RJ, renderIndexIn, equipmentSlotIn);
	}
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.RJ_BOOTS_KAI) {}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
		...
		if (!itemStack.isEmpty()) {
			...
			if (itemStack.getItem() instanceof ItemArmor) {
				...
				ModelRJBody armorModel = new ModelRJBody(1.0f);
				ModelRJBody armorModelLegs = new ModelRJBody(0.5f);
