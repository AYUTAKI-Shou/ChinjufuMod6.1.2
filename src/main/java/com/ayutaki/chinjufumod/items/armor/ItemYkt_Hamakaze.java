...
public class ItemYkt_Hamakaze extends ItemArmor {

	public ItemYkt_Hamakaze(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.HAMAKAZEYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if (this == Items_Seasonal.HAMAKAZEYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}

		if (this == Items_Seasonal.HAMAKAZEYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}
	}
	...
	public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
		...
		if (this == Items_Seasonal.HAMAKAZEYKT_HELMET) {
			...
			if (k == 0) {
			return (repair.getItem() == Item.getItemFromBlock(Blocks.RED_FLOWER)); }
