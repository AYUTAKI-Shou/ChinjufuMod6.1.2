...
public class ItemShiratsuyuArmor_kai extends ItemArmor {

	public ItemShiratsuyuArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.SHIRATSUYU, renderIndexIn, equipmentSlotIn);
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.SHIRATSUYU_BOOTS_KAI) {}
