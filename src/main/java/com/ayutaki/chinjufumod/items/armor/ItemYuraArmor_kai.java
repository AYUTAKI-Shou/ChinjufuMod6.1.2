...
public class ItemYuraArmor_kai extends ItemArmor {

	public ItemYuraArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.YURA, renderIndexIn, equipmentSlotIn);
	}
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.YURA_BOOTS_KAI) {}
