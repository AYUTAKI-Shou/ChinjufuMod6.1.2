...
public class ItemAkagiArmor_kai extends ItemArmor {

	public ItemAkagiArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.AKAGI, renderIndexIn, equipmentSlotIn);
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.AKAGI_BOOTS_KAI) {}
