...
public enum CMArmorMaterial implements IArmorMaterial {
	...
	/* 0.42×50=21 */
	RJ("ryujou", 21, new int[]{ 2, 6, 7, 3 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, () -> {
		return Ingredient.fromItems(Items.IRON_INGOT); }),
	/* 0.42×50=21 */
	...
	/* 0.42×72=30.24 */
	KAGA("kaga", 30, new int[]{ 2, 6, 7, 2 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.0F, () -> {
		return Ingredient.fromItems(Items.IRON_INGOT); }),
	/* 0.42×69=28.98 */
	...
	AKASHISANTA("santaakashi", 6, new int[]{ 1, 2, 2, 1 }, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, () -> {
		return Ingredient.fromItems(Items_Chinjufu.EMBLEM_C); }),
