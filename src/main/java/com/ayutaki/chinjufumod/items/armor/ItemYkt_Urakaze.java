...
public class ItemYkt_Urakaze extends ItemArmor {

	public ItemYkt_Urakaze(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.URAKAZEYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if (this == Items_Seasonal.URAKAZEYKT_HELMET) { }

		if (this == Items_Seasonal.URAKAZEYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}

		if (this == Items_Seasonal.URAKAZEYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}
	}
