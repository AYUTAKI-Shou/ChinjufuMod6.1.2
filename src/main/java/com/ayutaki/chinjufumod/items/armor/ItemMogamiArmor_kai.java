...
public class ItemMogamiArmor_kai extends ItemArmor {

	public ItemMogamiArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.MOGAMI, renderIndexIn, equipmentSlotIn);
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.MOGAMI_BOOTS_KAI) {}
