...
public class ItemYkt_Inaduma extends ItemArmor {

	public ItemYkt_Inaduma(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.INADUMAYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if (this == Items_Seasonal.INADUMAYKT_HELMET) { }

		if (this == Items_Seasonal.INADUMAYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}

		if (this == Items_Seasonal.INADUMAYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}
	}
