...
public class AkagiArmor_Kai extends ArmorItem {

	public AkagiArmor_Kai(IArmorMaterial material, EquipmentSlotType slot, Properties properties) {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entity, int slot, boolean selected) {
		...
		if(entity instanceof PlayerEntity) {
			...
			if(playerIn.getItemStackFromSlot(EquipmentSlotType.FEET).getItem() == Items_Armor.AKAGI_BOOTS_KAI) {
