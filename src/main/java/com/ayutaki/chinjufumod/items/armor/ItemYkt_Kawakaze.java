...
public class ItemYkt_Kawakaze extends ItemArmor {

	public ItemYkt_Kawakaze(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.KAWAKAZEYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if (this == Items_Seasonal.KAWAKAZEYKT_HELMET) { }

		if (this == Items_Seasonal.KAWAKAZEYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}

		if (this == Items_Seasonal.KAWAKAZEYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}
	}
