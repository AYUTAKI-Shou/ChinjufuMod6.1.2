...
public class ItemKongouArmor_kai extends ItemArmor {

	public ItemKongouArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.KONGOU_BOOTS_KAI) {}
