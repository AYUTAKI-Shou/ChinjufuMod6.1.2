...
public class ItemYkt_Teitoku extends ItemArmor {

	public ItemYkt_Teitoku(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.TTOKUYKT, renderIndexIn, equipmentSlotIn);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if (this == Items_Seasonal.TTOKUYKT_CHESTPLATE) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}

		if (this == Items_Seasonal.TTOKUYKT_LEGGINGS) {
			tooltip.add(I18n.format("tips.item_ykt", meta));
		}
	}
	...
	public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
		...
		if (this == Items_Seasonal.YKTO_BOOTS) {
			int k;
