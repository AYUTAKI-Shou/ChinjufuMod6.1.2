...
public class ItemKagaArmor_kai extends ItemArmor {

	public ItemKagaArmor_kai(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(Items_ArmorMaterial.KAGA, renderIndexIn, equipmentSlotIn);
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		...
		if (this != Items_Armor.KAGA_BOOTS_KAI) {}
