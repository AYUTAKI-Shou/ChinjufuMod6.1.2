...
public class ItemShigureHou extends ItemBow {

	public ItemShigureHou() {
		this.maxStackSize = 1;
		setMaxDamage(1000);
		...
		this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter()
		{
			...
			public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn)
			{
				...
				{
					return entityIn.getActiveItemStack().getItem() != Items_Weapon.SHIGUREHOU ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
				}
			}
		});
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(TextFormatting.DARK_GREEN + I18n.format("tips.item_shigurehou", meta));
	}
}
