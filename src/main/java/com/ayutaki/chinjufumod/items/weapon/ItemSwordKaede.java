...
public class ItemSwordKaede extends ItemSword {
	...
	public ItemSwordKaede(ToolMaterial material) {
		super(material);
	...
	public void onCreated(ItemStack itemstack, World worldIn, EntityPlayer entity) {
		...
		if (this == Items_Weapon.SWORD_kaede) {
	...
	public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
		return (repair.getItem() == Items_Seasonal.PLANKS_kaede);
	}
