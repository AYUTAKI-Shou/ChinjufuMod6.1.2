...
public class ItemDinnerChair_kaede extends ItemBlockBace {

	public ItemDinnerChair_kaede() {
		super(Furniture_Blocks.DININGCHAIR);
		setUnlocalizedName("block_diningchair_kae");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_diningchair_kae"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Furniture_Blocks.DININGCHAIR_kae, pos, false, facing, (Entity)null)) {

			/** 設置するブロックのクラス **/
			worldIn.setBlockState(pos, Furniture_Blocks.DININGCHAIR_kae.getDefaultState()
					.withProperty(Base_DiningChair.H_FACING, direction)
					.withProperty(Base_DiningChair.HALF, Half.LOWER), 10);
			worldIn.setBlockState(pos.up(), Furniture_Blocks.DININGCHAIR_kae.getDefaultState()
					.withProperty(Base_DiningChair.H_FACING, direction)
