...
public class ItemDinnerChair_oak extends ItemBlockBace {

	public ItemDinnerChair_oak() {
		super(Furniture_Blocks.DININGCHAIR);
		setUnlocalizedName("block_diningchair");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_diningchair"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Furniture_Blocks.DININGCHAIR, pos, false, facing, (Entity)null)) {

			/** 設置するブロックのクラス **/
			worldIn.setBlockState(pos, Furniture_Blocks.DININGCHAIR.getDefaultState()
					.withProperty(Base_DiningChair.H_FACING, direction)
					.withProperty(Base_DiningChair.HALF, Half.LOWER), 10);
			worldIn.setBlockState(pos.up(), Furniture_Blocks.DININGCHAIR.getDefaultState()
					.withProperty(Base_DiningChair.H_FACING, direction)
