...
public class ItemDinnerChair_spruce extends ItemBlockBace {

	public ItemDinnerChair_spruce() {
		super(Furniture_Blocks.DININGCHAIR);
		setUnlocalizedName("block_diningchair_s");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_diningchair_s"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Furniture_Blocks.DININGCHAIR_s, pos, false, facing, (Entity)null)) {

			/** 設置するブロックのクラス **/
			worldIn.setBlockState(pos, Furniture_Blocks.DININGCHAIR_s.getDefaultState()
					.withProperty(Base_DiningChair.H_FACING, direction)
					.withProperty(Base_DiningChair.HALF, Half.LOWER), 10);
			worldIn.setBlockState(pos.up(), Furniture_Blocks.DININGCHAIR_s.getDefaultState()
					.withProperty(Base_DiningChair.H_FACING, direction)
