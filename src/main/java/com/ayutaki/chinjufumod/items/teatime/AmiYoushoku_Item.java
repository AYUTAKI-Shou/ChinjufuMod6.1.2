...
public class AmiYoushoku_Item extends BlockNamedItem {
	...
	public AmiYoushoku_Item(Block block, Item.Properties builder) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add((new TranslationTextComponent("tips.block_ami_youshoku")).applyTextStyle(TextFormatting.GRAY));
