...
public class ItemTest_2 extends ItemBlockBace {

	public ItemTest_2() {
		super(Crop_Blocks.MIKAN);
		setUnlocalizedName("2");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "2"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (iblockstate.getBlock() == Blocks.DIRT && facing == EnumFacing.UP) {
			...
			if (playerIn.canPlayerEdit(pos, facing, itemstack)) {
				...
				/** 生成するブロック **/
				IBlockState iblockstate1 = Crop_Blocks.BUDOUNOKI_B.getDefaultState()
