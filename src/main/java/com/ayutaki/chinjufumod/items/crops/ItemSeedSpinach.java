...
public class ItemSeedSpinach extends ItemBlockBace {

	public ItemSeedSpinach() {
		super(Crop_Blocks.SPINACH);
		setUnlocalizedName("item_seeds_spinach");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "item_seeds_spinach"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (iblockstate.getBlock() == Blocks.FARMLAND && facing == EnumFacing.UP) {
			...
			if (playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.getBlockState(pos.up()).getMaterial().isReplaceable()) {
				...
				/** 生成するブロック **/
				IBlockState iblockstate1 = Crop_Blocks.SPINACH.getDefaultState()
