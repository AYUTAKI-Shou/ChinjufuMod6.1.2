...
public class ItemSeedHakusai extends ItemBlockBace {

	public ItemSeedHakusai() {
		super(Crop_Blocks.HAKUSAI);
		setUnlocalizedName("item_seeds_hakusai");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "item_seeds_hakusai"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (iblockstate.getBlock() == Blocks.FARMLAND && facing == EnumFacing.UP) {
			...
			if (playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.getBlockState(pos.up()).getMaterial().isReplaceable()) {
				...
				/** 生成するブロック **/
				IBlockState iblockstate1 = Crop_Blocks.HAKUSAI.getDefaultState()
