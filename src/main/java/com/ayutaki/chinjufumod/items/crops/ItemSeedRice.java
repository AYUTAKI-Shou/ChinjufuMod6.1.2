...
public class ItemSeedRice extends ItemBlockBace {

	public ItemSeedRice() {
		super(Crop_Blocks.RICE);
		setUnlocalizedName("item_seeds_rice");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "item_seeds_rice"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (iblockstate.getBlock() == Blocks.FARMLAND && facing == EnumFacing.UP) {
			...
			if (playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.getBlockState(pos.up()).getMaterial().isReplaceable()) {
				...
				/** 生成するブロック **/
				IBlockState iblockstate1 = Crop_Blocks.RICE.getDefaultState()
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_rice", meta));
	}
