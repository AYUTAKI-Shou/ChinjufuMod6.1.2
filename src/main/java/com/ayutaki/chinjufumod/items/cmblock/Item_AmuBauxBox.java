...
public class Item_AmuBauxBox extends ItemBlockBace {

	public Item_AmuBauxBox() {
		super(Chinjufu_Blocks.AMUBAUX);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, AmuBauxBox.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Chinjufu_Blocks.AMUBAUX, pos, false, facing, (Entity)null)) {

			if (k == 1) {
			/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Chinjufu_Blocks.AMUBAUX.getDefaultState().withProperty(BaseStage2_Face.H_FACING, direction)
