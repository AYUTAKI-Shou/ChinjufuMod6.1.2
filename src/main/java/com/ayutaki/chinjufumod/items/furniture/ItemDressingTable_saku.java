...
public class ItemDressingTable_saku extends ItemBlockBace {

	public ItemDressingTable_saku() {
		super(Furniture_Blocks.DRESSINGTABLE);
		setUnlocalizedName("block_dressingtable_saku");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_dressingtable_saku"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Furniture_Blocks.DRESSINGTABLE_saku, pos, false, facing, (Entity)null)) {

			/** 設置するブロックのクラス **/
			worldIn.setBlockState(pos, Furniture_Blocks.DRESSINGTABLE_saku.getDefaultState()
