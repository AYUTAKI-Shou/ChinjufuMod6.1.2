package com.ayutaki.chinjufumod.items.kitchen;
...
public class ItemKit_sink extends ItemBlockBace {

	public ItemKit_sink() {
		super(Kitchen_Blocks.KIT_SINK_BOT);
		setUnlocalizedName("block_kit_sink");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Kit_sink_bot.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Kitchen_Blocks.KIT_SINK_BOT, pos, false, facing, (Entity)null)) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_kit_sink", meta));
	}
