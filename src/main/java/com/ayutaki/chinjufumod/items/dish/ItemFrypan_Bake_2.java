...
public class ItemFrypan_Bake_2 extends ItemBlockBace {

	public ItemFrypan_Bake_2() {
		super(Dish_Blocks.FRYPAN_BAKE_2);
		setCreativeTab(ChinjufuModTabs.TEATIME);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Frypan_Bake_2.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Dish_Blocks.FRYPAN_BAKE_2, pos, false, facing, (Entity)null)) {

			if (k == 1) {
			/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Dish_Blocks.FRYPAN_BAKE_2.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		if (stack.getMetadata() == 1 || stack.getMetadata() == 2 || stack.getMetadata() == 4) { tooltip.add(I18n.format("tips.block_food_frypan_donburi")); }
	}
