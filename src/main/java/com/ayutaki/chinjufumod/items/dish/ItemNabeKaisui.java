...
public class ItemNabeKaisui extends ItemBlockBace {

	public ItemNabeKaisui() {
		super(Dish_Blocks.NABE_nama_2);
		setCreativeTab(ChinjufuModTabs.TEATIME);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_food_nabeshio_n"));
		setUnlocalizedName("block_food_nabeshio_n");
	}
