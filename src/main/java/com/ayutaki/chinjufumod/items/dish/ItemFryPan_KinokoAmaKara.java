...
public class ItemFryPan_KinokoAmaKara extends ItemBlockBace {

	public ItemFryPan_KinokoAmaKara() {
		super(Dish_Blocks.FPKINOKOAK_nama);
		setCreativeTab(ChinjufuModTabs.TEATIME);
		setUnlocalizedName(Frypan_KinokoAmaKara.ID);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Frypan_KinokoAmaKara.ID));
	}
