...
public class ItemFrypan_Nama_2 extends ItemBlockBace {

	public ItemFrypan_Nama_2() {
		super(Dish_Blocks.FRYPAN_NAMA_2);
		setCreativeTab(ChinjufuModTabs.TEATIME);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Frypan_Nama_2.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Dish_Blocks.FRYPAN_NAMA_2, pos, false, facing, (Entity)null)) {

			if (k == 1) {
			/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Dish_Blocks.FRYPAN_NAMA_2.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
