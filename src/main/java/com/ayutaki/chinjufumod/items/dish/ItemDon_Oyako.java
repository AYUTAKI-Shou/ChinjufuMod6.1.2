...
public class ItemDon_Oyako extends ItemFood {

	public ItemDon_Oyako(int amount, float saturation, boolean isWolfFood) {
		super(amount, saturation, isWolfFood);
		setCreativeTab(ChinjufuModTabs.TEATIME);
		setUnlocalizedName(Don_Oyako.ID);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Don_Oyako.ID));
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_food_donoyako_1", meta));
	}
