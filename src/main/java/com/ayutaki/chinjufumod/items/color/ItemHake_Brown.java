...
public class ItemHake_Brown extends Base_ItemHake {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (block == Blocks.WHITE_WOOL || block == Blocks.ORANGE_WOOL || block == Blocks.MAGENTA_WOOL ||
			...
			iworld.setBlockState(blockpos, Blocks.BROWN_WOOL.getDefaultState(), 3);
		...
		if (block == Blocks.WHITE_CONCRETE || block == Blocks.ORANGE_CONCRETE || block == Blocks.MAGENTA_CONCRETE ||
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.BROWN_CONCRETE.getDefaultState(), 3);
		...
		if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA ||
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.BROWN_TERRACOTTA.getDefaultState(), 3);
		...
		if (block instanceof ConcretePowderBlock && block != Blocks.BROWN_CONCRETE_POWDER) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.BROWN_CONCRETE_POWDER.getDefaultState(), 3);
		...
		if ((block instanceof StainedGlassBlock && block != Blocks.BROWN_STAINED_GLASS) || block == Blocks.GLASS) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.BROWN_STAINED_GLASS.getDefaultState(), 3);
		...
		if (block instanceof GlazedTerracottaBlock && block != Blocks.BROWN_GLAZED_TERRACOTTA) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.BROWN_GLAZED_TERRACOTTA.getDefaultState()
		...
		if ((block instanceof StainedGlassPaneBlock && block != Blocks.BROWN_STAINED_GLASS_PANE) || block == Blocks.GLASS_PANE) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.BROWN_STAINED_GLASS_PANE.getDefaultState()
		...
		if (block instanceof CarpetBlock && block != Blocks.BROWN_CARPET) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.BROWN_CARPET.getDefaultState(), 3);
		...
		if (block instanceof Full_Kawara && block != JP_Blocks.KAWARA_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_brown.getDefaultState()
		...
		if (block instanceof Full_Plaster && block != JP_Blocks.SHIKKUI_brown && block != JP_Blocks.DIRTWALL) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_brown.getDefaultState()
					.with(Base_Full_JP.CRACK, blockstate.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako && block != JP_Blocks.NAMAKO_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_brown.getDefaultState()
					.with(Base_Full_JP.CRACK, blockstate.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako_B && block != JP_Blocks.NAMAKOB_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_brown.getDefaultState()
					.with(Base_Full_JP.CRACK, blockstate.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Stairs_Kawara && block != JP_Blocks.KAWARA_ST_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_ST_brown.getDefaultState()
		...
		if (block instanceof Stairs_Plaster && block != JP_Blocks.SHIKKUI_ST_brown && block != JP_Blocks.DIRTWALL_stairs) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_ST_brown.getDefaultState()
					.with(StairsBlock.FACING, blockstate.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, blockstate.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, blockstate.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, blockstate.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako && block != JP_Blocks.NAMAKO_ST_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_ST_brown.getDefaultState()
					.with(StairsBlock.FACING, blockstate.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, blockstate.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, blockstate.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, blockstate.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako_B && block != JP_Blocks.NAMAKOB_ST_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_ST_brown.getDefaultState()
					.with(StairsBlock.FACING, blockstate.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, blockstate.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, blockstate.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, blockstate.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Kawara && block != JP_Blocks.KAWARA_SH_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_SH_brown.getDefaultState()
		...
		if (block instanceof Slab_Plaster && block != JP_Blocks.SHIKKUI_SH_brown && block != JP_Blocks.DIRTWALL_SH) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_SH_brown.getDefaultState()
					.with(Base_Slab_JP.TYPE, blockstate.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, blockstate.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, blockstate.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako && block != JP_Blocks.NAMAKO_SH_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_SH_brown.getDefaultState()
					.with(Base_Slab_JP.TYPE, blockstate.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, blockstate.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, blockstate.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako_B && block != JP_Blocks.NAMAKOB_SH_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_SH_brown.getDefaultState()
					.with(Base_Slab_JP.TYPE, blockstate.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, blockstate.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, blockstate.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof CTruss && block != Harbor_Blocks.TRUSS_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Harbor_Blocks.TRUSS_brown.getDefaultState()
		...
		if (block instanceof CafeChair && block != Chair_Blocks.CAFECHAIR_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Chair_Blocks.CAFECHAIR_brown.getDefaultState(), 3);
		...
		if (block instanceof Zabuton && block != JPChair_Blocks.ZABUTON_brown && block != JPChair_Blocks.WARAZABUTON) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPChair_Blocks.ZABUTON_brown.getDefaultState(), 3);
		...
		if (block instanceof Candle && block != Furniture_Blocks.CANDLE_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Furniture_Blocks.CANDLE_brown.getDefaultState()
		...
		if (block instanceof Andon && block != JPdeco_Blocks.ANDON_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.ANDON_brown.getDefaultState()
		...
		if (block instanceof Sofa && block != Chair_Blocks.SOFA_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Chair_Blocks.SOFA_brown.getDefaultState()
		...
		if (block instanceof Zaisu && block != JPChair_Blocks.ZAISU_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPChair_Blocks.ZAISU_brown.getDefaultState()
					.with(BaseFacingWater.H_FACING, blockstate.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, blockstate.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof Noren && block != Ranma_Blocks.NOREN_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Ranma_Blocks.NOREN_brown.getDefaultState()
		...
		if (block instanceof Futon && block != JPdeco_Blocks.FUTON_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.FUTON_brown.getDefaultState()
		...
		if (block instanceof Tatami && block != JPdeco_Blocks.TATAMI_H_brown && block != JPdeco_Blocks.TATAMI_H) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.TATAMI_H_brown.getDefaultState()
		...
		if (block instanceof Tatami_Y && block != JPdeco_Blocks.TATAMI_HY_brown && block != JPdeco_Blocks.TATAMI_HY) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.TATAMI_HY_brown.getDefaultState()
					.with(BaseFacingSlab_Water.TYPE, blockstate.get(BaseFacingSlab_Water.TYPE))
					.with(BaseFacingSlab_Water.H_FACING, blockstate.get(BaseFacingSlab_Water.H_FACING))
					.with(BaseFacingSlab_Water.WATERLOGGED, blockstate.get(BaseFacingSlab_Water.WATERLOGGED)), 3);
		...
		if (block instanceof Wagasa && block != Unit_Blocks.KASA_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Unit_Blocks.KASA_brown.getDefaultState()
		...
		if (block instanceof Fusuma && block != Slidedoor_Blocks.FUSUMA_brown) {
			...
			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMA_brown.getDefaultState()
				...
				iworld.setBlockState(blockpos.up(), Slidedoor_Blocks.FUSUMA_brown.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
			...
			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMA_brown.getDefaultState()
						...
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.with(BaseSlidedoor.WATERLOGGED, blockstate.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(blockpos.down(), Slidedoor_Blocks.FUSUMA_brown.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
		...
		if (block instanceof Fusuma_B && block != Slidedoor_Blocks.FUSUMAB_brown) {
			...
			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMAB_brown.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.LOWER)
						.with(BaseSlidedoor.WATERLOGGED, blockstate.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(blockpos.up(), Slidedoor_Blocks.FUSUMAB_brown.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
			...
			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMAB_brown.getDefaultState()
						...
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.with(BaseSlidedoor.WATERLOGGED, blockstate.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(blockpos.down(), Slidedoor_Blocks.FUSUMAB_brown.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
		...
		if (block instanceof KamoiPlaster_Oak && block != KamoiPlaster_Blocks.KAMOI_brown_oak) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_oak.getDefaultState()
		...
		if (block instanceof KamoiPlaster_Spruce && block != KamoiPlaster_Blocks.KAMOI_brown_spru) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_spru.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Birch && block != KamoiPlaster_Blocks.KAMOI_brown_bir) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_bir.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Jungle && block != KamoiPlaster_Blocks.KAMOI_brown_jun) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_jun.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Acacia && block != KamoiPlaster_Blocks.KAMOI_brown_aca) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_aca.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_DarkOak && block != KamoiPlaster_Blocks.KAMOI_brown_doak) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_doak.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Sakura && block != KamoiPlaster_Blocks.KAMOI_brown_sakura) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_sakura.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Kaede && block != KamoiPlaster_Blocks.KAMOI_brown_kaede) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_kaede.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Ichoh && block != KamoiPlaster_Blocks.KAMOI_brown_ichoh) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_brown_ichoh.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		///////////////////////
		/** 粘土 **/
		if (block instanceof WallPane_Clay && block != WallPane_Blocks.WP_CLAY_brown) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_CLAY_brown.getDefaultState()
					.with(BaseFacingWater.H_FACING, blockstate.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, blockstate.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		/** ガラス **/
		if (block instanceof WallPane_Glass && block != WallPane_Blocks.WP_GLASS_brown) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_GLASS_brown.getDefaultState()
					.with(BaseFacingWater.H_FACING, blockstate.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, blockstate.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		/** しっくい **/
		if (block instanceof WallPane_Plaster && block != WallPane_Blocks.WP_PLASTER_brown) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_PLASTER_brown.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, blockstate.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, blockstate.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, blockstate.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		/** なまこ **/
		if (block instanceof WallPane_Namako && block != WallPane_Blocks.WP_NAMAKO_brown) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_NAMAKO_brown.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, blockstate.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, blockstate.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, blockstate.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako_B && block != WallPane_Blocks.WP_NAMAKOB_brown) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_NAMAKOB_brown.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, blockstate.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, blockstate.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, blockstate.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof Wall_Plaster && block != JP_Blocks.SHIKKUI_WALL_brown && block != JP_Blocks.DIRTWALL_WALL) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_WALL_brown.getDefaultState()
		...
		if (block instanceof Wall_Sama && block != JP_Blocks.SHIKKUI_SAMA_brown && block != JP_Blocks.DIRTWALL_SAMA) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_SAMA_brown.getDefaultState()
		...
		if (block instanceof Wall_Kawara && block != JP_Blocks.KAWARA_WALL_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_WALL_brown.getDefaultState()
		...
		if (block instanceof Wall_Namako && block != JP_Blocks.NAMAKO_WALL_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_WALL_brown.getDefaultState()
		...
		if (block instanceof Wall_NamakoB && block != JP_Blocks.NAMAKOB_WALL_brown) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_WALL_brown.getDefaultState()
