...
public class ItemHake_Lime extends Base_ItemHake {

	public ItemHake_Lime(Properties builder) {
		super(builder);
	}
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (block == Blocks.WHITE_WOOL || block == Blocks.ORANGE_WOOL || block == Blocks.MAGENTA_WOOL ||
				block == Blocks.LIGHT_BLUE_WOOL || block == Blocks.YELLOW_WOOL || block == Blocks.PINK_WOOL ||
			...
			iworld.setBlockState(blockpos, Blocks.LIME_WOOL.getDefaultState(), 3);
		...
		if (block == Blocks.WHITE_CONCRETE || block == Blocks.ORANGE_CONCRETE || block == Blocks.MAGENTA_CONCRETE ||
				block == Blocks.LIGHT_BLUE_CONCRETE || block == Blocks.YELLOW_CONCRETE || block == Blocks.PINK_CONCRETE ||
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.LIME_CONCRETE.getDefaultState(), 3);
		...
		if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA ||
				block == Blocks.LIGHT_BLUE_TERRACOTTA || block == Blocks.YELLOW_TERRACOTTA || block == Blocks.PINK_TERRACOTTA ||
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.LIME_TERRACOTTA.getDefaultState(), 3);
		...
		if (block instanceof ConcretePowderBlock && block != Blocks.LIME_CONCRETE_POWDER) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.LIME_CONCRETE_POWDER.getDefaultState(), 3);
		...
		if ((block instanceof StainedGlassBlock && block != Blocks.LIME_STAINED_GLASS) || block == Blocks.GLASS) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.LIME_STAINED_GLASS.getDefaultState(), 3);
		...
		/** テラコッタ **/
		if (block instanceof GlazedTerracottaBlock && block != Blocks.LIME_GLAZED_TERRACOTTA) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.LIME_GLAZED_TERRACOTTA.getDefaultState()
		...
		/** 板ガラス **/
		if ((block instanceof StainedGlassPaneBlock && block != Blocks.LIME_STAINED_GLASS_PANE) || block == Blocks.GLASS_PANE) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.LIME_STAINED_GLASS_PANE.getDefaultState()
		...
		/**カーペット **/
		if (block instanceof CarpetBlock && block != Blocks.LIME_CARPET) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Blocks.LIME_CARPET.getDefaultState(), 3);
		...
		/** 瓦・漆喰・なまこ壁 **/
		if (block instanceof Full_Kawara && block != JP_Blocks.KAWARA_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_lime.getDefaultState()
		...
		if (block instanceof Full_Plaster && block != JP_Blocks.SHIKKUI_lime && block != JP_Blocks.DIRTWALL) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_lime.getDefaultState()
					.with(Base_Full_JP.CRACK, blockstate.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako && block != JP_Blocks.NAMAKO_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_lime.getDefaultState()
					.with(Base_Full_JP.CRACK, blockstate.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako_B && block != JP_Blocks.NAMAKOB_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_lime.getDefaultState()
					.with(Base_Full_JP.CRACK, blockstate.get(Base_Full_JP.CRACK)), 3);
		...
		/** 階段 **/
		if (block instanceof Stairs_Kawara && block != JP_Blocks.KAWARA_ST_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_ST_lime.getDefaultState()
		...
		if (block instanceof Stairs_Plaster && block != JP_Blocks.SHIKKUI_ST_lime && block != JP_Blocks.DIRTWALL_stairs) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_ST_lime.getDefaultState()
					.with(StairsBlock.FACING, blockstate.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, blockstate.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, blockstate.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, blockstate.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako && block != JP_Blocks.NAMAKO_ST_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_ST_lime.getDefaultState()
					.with(StairsBlock.FACING, blockstate.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, blockstate.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, blockstate.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, blockstate.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako_B && block != JP_Blocks.NAMAKOB_ST_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_ST_lime.getDefaultState()
					.with(StairsBlock.FACING, blockstate.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, blockstate.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, blockstate.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, blockstate.get(StairsBlock.WATERLOGGED)), 3);
		...
		/** ハーフブロック **/
		if (block instanceof Slab_Kawara && block != JP_Blocks.KAWARA_SH_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_SH_lime.getDefaultState()
		...
		if (block instanceof Slab_Plaster && block != JP_Blocks.SHIKKUI_SH_lime && block != JP_Blocks.DIRTWALL_SH) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_SH_lime.getDefaultState()
					.with(Base_Slab_JP.TYPE, blockstate.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, blockstate.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, blockstate.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako && block != JP_Blocks.NAMAKO_SH_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_SH_lime.getDefaultState()
					.with(Base_Slab_JP.TYPE, blockstate.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, blockstate.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, blockstate.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako_B && block != JP_Blocks.NAMAKOB_SH_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_SH_lime.getDefaultState()
					.with(Base_Slab_JP.TYPE, blockstate.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, blockstate.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, blockstate.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		///////////////////////
		/** トラス **/
		if (block instanceof CTruss && block != Harbor_Blocks.TRUSS_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Harbor_Blocks.TRUSS_lime.getDefaultState()
		...
		/** 椅子・座布団・キャンドル **/
		if (block instanceof CafeChair && block != Chair_Blocks.CAFECHAIR_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Chair_Blocks.CAFECHAIR_lime.getDefaultState(), 3);
		...
		if (block instanceof Zabuton && block != JPChair_Blocks.ZABUTON_lime && block != JPChair_Blocks.WARAZABUTON) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPChair_Blocks.ZABUTON_lime.getDefaultState(), 3);
		...
		if (block instanceof Candle && block != Furniture_Blocks.CANDLE_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Furniture_Blocks.CANDLE_lime.getDefaultState()
		...
		/** 行灯 **/
		if (block instanceof Andon && block != JPdeco_Blocks.ANDON_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.ANDON_lime.getDefaultState()
		...
		/** ソファ **/
		if (block instanceof Sofa && block != Chair_Blocks.SOFA_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Chair_Blocks.SOFA_lime.getDefaultState()
		...
		/** 座椅子 **/
		if (block instanceof Zaisu && block != JPChair_Blocks.ZAISU_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPChair_Blocks.ZAISU_lime.getDefaultState()
					.with(BaseFacingWater.H_FACING, blockstate.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, blockstate.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		/** のれん **/
		if (block instanceof Noren && block != Ranma_Blocks.NOREN_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Ranma_Blocks.NOREN_lime.getDefaultState()
		...
		/** 布団 **/
		if (block instanceof Futon && block != JPdeco_Blocks.FUTON_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.FUTON_lime.getDefaultState()
		...
		/** 畳 **/
		if (block instanceof Tatami && block != JPdeco_Blocks.TATAMI_H_lime && block != JPdeco_Blocks.TATAMI_H) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.TATAMI_H_lime.getDefaultState()
		...
		if (block instanceof Tatami_Y && block != JPdeco_Blocks.TATAMI_HY_lime && block != JPdeco_Blocks.TATAMI_HY) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JPdeco_Blocks.TATAMI_HY_lime.getDefaultState()
					.with(BaseFacingSlab_Water.TYPE, blockstate.get(BaseFacingSlab_Water.TYPE))
					.with(BaseFacingSlab_Water.H_FACING, blockstate.get(BaseFacingSlab_Water.H_FACING))
					.with(BaseFacingSlab_Water.WATERLOGGED, blockstate.get(BaseFacingSlab_Water.WATERLOGGED)), 3);
		...
		/** 傘 **/
		if (block instanceof Wagasa && block != Unit_Blocks.KASA_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, Unit_Blocks.KASA_lime.getDefaultState()
		...
		///////////////////////
		/** ふすま **/
		if (block instanceof Fusuma && block != Slidedoor_Blocks.FUSUMA_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);

			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMA_lime.getDefaultState()
				...
				iworld.setBlockState(blockpos.up(), Slidedoor_Blocks.FUSUMA_lime.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
			...
			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMA_lime.getDefaultState()
						...
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.with(BaseSlidedoor.WATERLOGGED, blockstate.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(blockpos.down(), Slidedoor_Blocks.FUSUMA_lime.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
		...
		if (block instanceof Fusuma_B && block != Slidedoor_Blocks.FUSUMAB_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);

			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMAB_lime.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.LOWER)
						.with(BaseSlidedoor.WATERLOGGED, blockstate.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(blockpos.up(), Slidedoor_Blocks.FUSUMAB_lime.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
			...
			if (blockstate.get(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlockState(blockpos, Slidedoor_Blocks.FUSUMAB_lime.getDefaultState()
						...
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.with(BaseSlidedoor.WATERLOGGED, blockstate.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(blockpos.down(), Slidedoor_Blocks.FUSUMAB_lime.getDefaultState()
						.with(BaseSlidedoor.H_FACING, blockstate.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, blockstate.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, blockstate.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, blockstate.get(BaseSlidedoor.POWERED))
		...
		///////////////////////
		/** 鴨居 **/
		if (block instanceof KamoiPlaster_Oak && block != KamoiPlaster_Blocks.KAMOI_lime_oak) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_oak.getDefaultState()
		...
		if (block instanceof KamoiPlaster_Spruce && block != KamoiPlaster_Blocks.KAMOI_lime_spru) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_spru.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Birch && block != KamoiPlaster_Blocks.KAMOI_lime_bir) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_bir.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Jungle && block != KamoiPlaster_Blocks.KAMOI_lime_jun) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_jun.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Acacia && block != KamoiPlaster_Blocks.KAMOI_lime_aca) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_aca.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_DarkOak && block != KamoiPlaster_Blocks.KAMOI_lime_doak) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_doak.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Sakura && block != KamoiPlaster_Blocks.KAMOI_lime_sakura) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_sakura.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Kaede && block != KamoiPlaster_Blocks.KAMOI_lime_kaede) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_kaede.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Ichoh && block != KamoiPlaster_Blocks.KAMOI_lime_ichoh) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, KamoiPlaster_Blocks.KAMOI_lime_ichoh.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, blockstate.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, blockstate.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		///////////////////////
		/** 粘土 **/
		if (block instanceof WallPane_Clay && block != WallPane_Blocks.WP_CLAY_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_CLAY_lime.getDefaultState()
					.with(BaseFacingWater.H_FACING, blockstate.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, blockstate.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		/** ガラス **/
		if (block instanceof WallPane_Glass && block != WallPane_Blocks.WP_GLASS_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_GLASS_lime.getDefaultState()
					.with(BaseFacingWater.H_FACING, blockstate.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, blockstate.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		/** しっくい **/
		if (block instanceof WallPane_Plaster && block != WallPane_Blocks.WP_PLASTER_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_PLASTER_lime.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, blockstate.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, blockstate.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, blockstate.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		/** なまこ **/
		if (block instanceof WallPane_Namako && block != WallPane_Blocks.WP_NAMAKO_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_NAMAKO_lime.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, blockstate.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, blockstate.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, blockstate.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako_B && block != WallPane_Blocks.WP_NAMAKOB_lime) {

			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, WallPane_Blocks.WP_NAMAKOB_lime.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, blockstate.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, blockstate.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, blockstate.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		///6.1.2////////////////////
		if (block instanceof Wall_Plaster && block != JP_Blocks.SHIKKUI_WALL_lime && block != JP_Blocks.DIRTWALL_WALL) {
			
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_WALL_lime.getDefaultState()
		...
		if (block instanceof Wall_Sama && block != JP_Blocks.SHIKKUI_SAMA_lime && block != JP_Blocks.DIRTWALL_SAMA) {
			
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.SHIKKUI_SAMA_lime.getDefaultState()
		...
		if (block instanceof Wall_Kawara && block != JP_Blocks.KAWARA_WALL_lime) {
			
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.KAWARA_WALL_lime.getDefaultState()
		...
		if (block instanceof Wall_Namako && block != JP_Blocks.NAMAKO_WALL_lime) {
			
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKO_WALL_lime.getDefaultState()
		...
		if (block instanceof Wall_NamakoB && block != JP_Blocks.NAMAKOB_WALL_lime) {
			
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlockState(blockpos, JP_Blocks.NAMAKOB_WALL_lime.getDefaultState()
