...
public class ItemHake_Magenta extends Base_ItemHake {
	...
	public ItemHake_Magenta(String unlocalizedName) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (blockIn instanceof Plaster || blockIn instanceof Plaster_Crash ||
			...
			if (color != 2) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, stateIn.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(2)), 11);
		...
		if (blockIn instanceof BaseFuton) {
			if (blockIn != Futon_Blocks.FUTON_magenta) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, Futon_Blocks.FUTON_magenta.getDefaultState()
		...
		if (blockIn instanceof Tatami_H) {
			if (blockIn != JPDeco_Blocks.TATAMI_H_magenta && blockIn != JPDeco_Blocks.TATAMI_H) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPDeco_Blocks.TATAMI_H_magenta.getDefaultState()
		...
		if (blockIn instanceof Tatami_HY) {
			if (blockIn != JPDeco_Blocks.TATAMI_HY_magenta && blockIn != JPDeco_Blocks.TATAMI_HY) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPDeco_Blocks.TATAMI_HY_magenta.getDefaultState()
						.withProperty(BaseFacingSlabW.H_FACING, stateIn.getValue(BaseFacingSlabW.H_FACING))
						.withProperty(BaseFacingSlabW.DOUBLE, stateIn.getValue(BaseFacingSlabW.DOUBLE))
						.withProperty(BaseFacingSlabW.HALF, stateIn.getValue(BaseFacingSlabW.HALF)), 11);
		...
		if (blockIn instanceof BaseMKasa) {
			if (blockIn != Garden_Blocks.KASA_magenta) {
				...
				worldIn.setBlockState(pos, Garden_Blocks.KASA_magenta.getDefaultState(), 11);
		...
		if (blockIn instanceof KamoiPlaster_Oak) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_o) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_magenta_o.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
		...
		if (blockIn instanceof KamoiPlaster_Spruce) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_s) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_magenta_s.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Birch) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_b) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_magenta_b.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Jungle) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_j) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_magenta_j.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Acacia) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_a) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_magenta_a.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_DarkOak) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_d) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_magenta_d.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Sakura) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_saku) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof KamoiPlaster_Kaede) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_kae) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof KamoiPlaster_Ichoh) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_magenta_ich) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof WP_clay_color) {
			if (blockIn != WallPane_Blocks.WP_CLAY_magenta) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPane_Blocks.WP_CLAY_magenta.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof WP_glass_stained) {
			if (blockIn != WallPane_Blocks.WP_GLASS_magenta) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPane_Blocks.WP_GLASS_magenta.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof WP_plaster) {
			if (blockIn != WallPaneJP_Blocks.WP_PLASTER_magenta && blockIn != WallPaneJP_Blocks.WP_DIRTWALL) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPaneJP_Blocks.WP_PLASTER_magenta.getDefaultState()
		...
		if (blockIn instanceof WP_namako) {
			if (blockIn != WallPaneJP_Blocks.WP_NAMAKO_magenta) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPaneJP_Blocks.WP_NAMAKO_magenta.getDefaultState()
						.withProperty(BaseStage2_WP.H_FACING, stateIn.getValue(BaseStage2_WP.H_FACING))
						.withProperty(BaseStage2_WP.STAGE_1_2, stateIn.getValue(BaseStage2_WP.STAGE_1_2)), 11);
		...
		if (blockIn instanceof WP_namako_B) {
			if (blockIn != WallPaneJP_Blocks.WP_NAMAKOB_magenta) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPaneJP_Blocks.WP_NAMAKOB_magenta.getDefaultState()
						.withProperty(BaseStage2_WP.H_FACING, stateIn.getValue(BaseStage2_WP.H_FACING))
						.withProperty(BaseStage2_WP.STAGE_1_2, stateIn.getValue(BaseStage2_WP.STAGE_1_2)), 11);
