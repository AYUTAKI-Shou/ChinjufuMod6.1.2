...
public class ItemHake_Red extends Base_ItemHake {
	...
	public ActionResultType useOn(ItemUseContext context) {
		...
		if (block == Blocks.WHITE_WOOL || block == Blocks.ORANGE_WOOL || block == Blocks.MAGENTA_WOOL ||
			...
			iworld.setBlock(blockpos, Blocks.RED_WOOL.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_CONCRETE || block == Blocks.ORANGE_CONCRETE || block == Blocks.MAGENTA_CONCRETE ||
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Blocks.RED_CONCRETE.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA ||
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Blocks.RED_TERRACOTTA.defaultBlockState(), 3);
		...
		if (block instanceof ConcretePowderBlock && block != Blocks.RED_CONCRETE_POWDER) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Blocks.RED_CONCRETE_POWDER.defaultBlockState(), 3);
		...
		if ((block instanceof StainedGlassBlock && block != Blocks.RED_STAINED_GLASS) || block == Blocks.GLASS) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Blocks.RED_STAINED_GLASS.defaultBlockState(), 3);
		...
		if (block instanceof GlazedTerracottaBlock && block != Blocks.RED_GLAZED_TERRACOTTA) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Blocks.RED_GLAZED_TERRACOTTA.defaultBlockState()
		...
		if ((block instanceof StainedGlassPaneBlock && block != Blocks.RED_STAINED_GLASS_PANE) || block == Blocks.GLASS_PANE) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Blocks.RED_STAINED_GLASS_PANE.defaultBlockState()
		...
		if (block instanceof CarpetBlock && block != Blocks.RED_CARPET) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Blocks.RED_CARPET.defaultBlockState(), 3);
		...
		if (block instanceof Full_Kawara && block != JP_Blocks.KAWARA_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.KAWARA_red.defaultBlockState()
		...
		if (block instanceof Full_Plaster && block != JP_Blocks.SHIKKUI_red && block != JP_Blocks.DIRTWALL) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.SHIKKUI_red.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, blockstate.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako && block != JP_Blocks.NAMAKO_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKO_red.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, blockstate.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako_B && block != JP_Blocks.NAMAKOB_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKOB_red.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, blockstate.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Stairs_Kawara && block != JP_Blocks.KAWARA_ST_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.KAWARA_ST_red.defaultBlockState()
		...
		if (block instanceof Stairs_Plaster && block != JP_Blocks.SHIKKUI_ST_red && block != JP_Blocks.DIRTWALL_stairs) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.SHIKKUI_ST_red.defaultBlockState()
					.setValue(StairsBlock.FACING, blockstate.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, blockstate.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, blockstate.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, blockstate.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako && block != JP_Blocks.NAMAKO_ST_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKO_ST_red.defaultBlockState()
					.setValue(StairsBlock.FACING, blockstate.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, blockstate.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, blockstate.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, blockstate.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako_B && block != JP_Blocks.NAMAKOB_ST_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKOB_ST_red.defaultBlockState()
					.setValue(StairsBlock.FACING, blockstate.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, blockstate.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, blockstate.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, blockstate.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Kawara && block != JP_Blocks.KAWARA_SH_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.KAWARA_SH_red.defaultBlockState()
		...
		if (block instanceof Slab_Plaster && block != JP_Blocks.SHIKKUI_SH_red && block != JP_Blocks.DIRTWALL_SH) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.SHIKKUI_SH_red.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, blockstate.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, blockstate.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, blockstate.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako && block != JP_Blocks.NAMAKO_SH_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKO_SH_red.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, blockstate.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, blockstate.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, blockstate.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako_B && block != JP_Blocks.NAMAKOB_SH_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKOB_SH_red.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, blockstate.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, blockstate.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, blockstate.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof CTruss && block != Harbor_Blocks.TRUSS_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Harbor_Blocks.TRUSS_red.defaultBlockState()
		...
		if (block instanceof CafeChair && block != Chair_Blocks.CAFECHAIR_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Chair_Blocks.CAFECHAIR_red.defaultBlockState(), 3);
		...
		if (block instanceof Zabuton && block != JPChair_Blocks.ZABUTON_red && block != JPChair_Blocks.WARAZABUTON) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JPChair_Blocks.ZABUTON_red.defaultBlockState(), 3);
		...
		if (block instanceof Candle && block != Furniture_Blocks.CANDLE_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Furniture_Blocks.CANDLE_red.defaultBlockState()
		...
		if (block instanceof Andon && block != JPDeco_Blocks.ANDON_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JPDeco_Blocks.ANDON_red.defaultBlockState()
		...
		if (block instanceof Sofa && block != Chair_Blocks.SOFA_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Chair_Blocks.SOFA_red.defaultBlockState()
		...
		if (block instanceof Zaisu && block != JPChair_Blocks.ZAISU_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JPChair_Blocks.ZAISU_red.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, blockstate.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, blockstate.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof Noren && block != Ranma_Blocks.NOREN_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Ranma_Blocks.NOREN_red.defaultBlockState()
		...
		if (block instanceof Futon && block != JPDeco_Blocks.FUTON_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JPDeco_Blocks.FUTON_red.defaultBlockState()
		...
		if (block instanceof Tatami && block != JPDeco_Blocks.TATAMI_H_red && block != JPDeco_Blocks.TATAMI_H) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JPDeco_Blocks.TATAMI_H_red.defaultBlockState()
		...
		if (block instanceof Tatami_Y && block != JPDeco_Blocks.TATAMI_HY_red && block != JPDeco_Blocks.TATAMI_HY) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JPDeco_Blocks.TATAMI_HY_red.defaultBlockState()
					.setValue(BaseFacingSlab_Water.TYPE, blockstate.getValue(BaseFacingSlab_Water.TYPE))
					.setValue(BaseFacingSlab_Water.H_FACING, blockstate.getValue(BaseFacingSlab_Water.H_FACING))
					.setValue(BaseFacingSlab_Water.WATERLOGGED, blockstate.getValue(BaseFacingSlab_Water.WATERLOGGED)), 3);
		...
		if (block instanceof Wagasa && block != Unit_Blocks.KASA_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, Unit_Blocks.KASA_red.defaultBlockState()
		...
		if (block instanceof Fusuma && block != Slidedoor_Blocks.FUSUMA_red) {
			...
			if (blockstate.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(blockpos, Slidedoor_Blocks.FUSUMA_red.defaultBlockState()
				...
				iworld.setBlock(blockpos.above(), Slidedoor_Blocks.FUSUMA_red.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, blockstate.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, blockstate.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, blockstate.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, blockstate.getValue(BaseSlidedoor.POWERED))
			...
			if (blockstate.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(blockpos, Slidedoor_Blocks.FUSUMA_red.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, blockstate.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(blockpos.below(), Slidedoor_Blocks.FUSUMA_red.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, blockstate.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, blockstate.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, blockstate.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, blockstate.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof Fusuma_B && block != Slidedoor_Blocks.FUSUMAB_red) {
			...
			if (blockstate.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(blockpos, Slidedoor_Blocks.FUSUMAB_red.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, blockstate.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, blockstate.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, blockstate.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, blockstate.getValue(BaseSlidedoor.POWERED))
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.LOWER)
						.setValue(BaseSlidedoor.WATERLOGGED, blockstate.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(blockpos.above(), Slidedoor_Blocks.FUSUMAB_red.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, blockstate.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, blockstate.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, blockstate.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, blockstate.getValue(BaseSlidedoor.POWERED))
			...
			if (blockstate.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(blockpos, Slidedoor_Blocks.FUSUMAB_red.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, blockstate.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(blockpos.below(), Slidedoor_Blocks.FUSUMAB_red.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, blockstate.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, blockstate.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, blockstate.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, blockstate.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof KamoiPlaster_Oak && block != KamoiPlaster_Blocks.KAMOI_red_oak) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_oak.defaultBlockState()
		...
		if (block instanceof KamoiPlaster_Spruce && block != KamoiPlaster_Blocks.KAMOI_red_spru) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_spru.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Birch && block != KamoiPlaster_Blocks.KAMOI_red_bir) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_bir.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Jungle && block != KamoiPlaster_Blocks.KAMOI_red_jun) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_jun.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Acacia && block != KamoiPlaster_Blocks.KAMOI_red_aca) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_aca.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_DarkOak && block != KamoiPlaster_Blocks.KAMOI_red_doak) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_doak.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Sakura && block != KamoiPlaster_Blocks.KAMOI_red_sakura) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_sakura.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Kaede && block != KamoiPlaster_Blocks.KAMOI_red_kaede) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_kaede.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Ichoh && block != KamoiPlaster_Blocks.KAMOI_red_ichoh) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, KamoiPlaster_Blocks.KAMOI_red_ichoh.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, blockstate.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, blockstate.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof WallPane_Clay && block != WallPanel_Blocks.WP_CLAY_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, WallPanel_Blocks.WP_CLAY_red.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, blockstate.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, blockstate.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Glass && block != WallPanel_Blocks.WP_GLASS_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, WallPanel_Blocks.WP_GLASS_red.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, blockstate.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, blockstate.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Plaster && block != WallPanel_Blocks.WP_PLASTER_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, WallPanel_Blocks.WP_PLASTER_red.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, blockstate.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, blockstate.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, blockstate.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako && block != WallPanel_Blocks.WP_NAMAKO_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, WallPanel_Blocks.WP_NAMAKO_red.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, blockstate.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, blockstate.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, blockstate.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako_B && block != WallPanel_Blocks.WP_NAMAKOB_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, WallPanel_Blocks.WP_NAMAKOB_red.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, blockstate.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, blockstate.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, blockstate.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof Wall_Plaster && block != JP_Blocks.SHIKKUI_WALL_red && block != JP_Blocks.DIRTWALL_WALL) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.SHIKKUI_WALL_red.defaultBlockState()
		...
		if (block instanceof Wall_Sama && block != JP_Blocks.SHIKKUI_SAMA_red && block != JP_Blocks.DIRTWALL_SAMA) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.SHIKKUI_SAMA_red.defaultBlockState()
		...
		if (block instanceof Wall_Kawara && block != JP_Blocks.KAWARA_WALL_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.KAWARA_WALL_red.defaultBlockState()
		...
		if (block instanceof Wall_Namako && block != JP_Blocks.NAMAKO_WALL_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKO_WALL_red.defaultBlockState()
		...
		if (block instanceof Wall_NamakoB && block != JP_Blocks.NAMAKOB_WALL_red) {
			...
			CMEvents.soundPaint(iworld, playerIn, blockpos);
			iworld.setBlock(blockpos, JP_Blocks.NAMAKOB_WALL_red.defaultBlockState()
