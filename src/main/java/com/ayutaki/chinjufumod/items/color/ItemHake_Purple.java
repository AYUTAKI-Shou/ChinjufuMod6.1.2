...
public class ItemHake_Purple extends Base_ItemHake {
	...
	public ItemHake_Purple(String unlocalizedName) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (blockIn instanceof BlockColored || blockIn instanceof BlockConcretePowder ||
			...
			if (color != 10) {
				...
				worldIn.setBlockState(pos, stateIn.withProperty(BlockColored.COLOR, EnumDyeColor.PURPLE), 11);
		...
		if (blockIn == Blocks.GLASS) {
			...
			worldIn.setBlockState(pos, Blocks.STAINED_GLASS.getDefaultState()
					.withProperty(BlockStainedGlass.COLOR, EnumDyeColor.PURPLE), 11);
		...
		if (blockIn == Blocks.GLASS_PANE) {
			...
			worldIn.setBlockState(pos, Blocks.STAINED_GLASS_PANE.getDefaultState()
					.withProperty(BlockStainedGlassPane.COLOR, EnumDyeColor.PURPLE), 11);
		...
		if (blockIn instanceof BlockHardenedClay) {
			...
			worldIn.setBlockState(pos, Blocks.STAINED_HARDENED_CLAY.getDefaultState()
					.withProperty(BlockStainedHardenedClay.COLOR, EnumDyeColor.PURPLE), 11);
		...
		if (blockIn instanceof BlockGlazedTerracotta) {
			if (blockIn != Blocks.PURPLE_GLAZED_TERRACOTTA) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, Blocks.PURPLE_GLAZED_TERRACOTTA.getDefaultState()
		...
		if (blockIn instanceof Plaster || blockIn instanceof Plaster_Crash ||
			...
			if (color != 10) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, stateIn.withProperty(Base_JpFull.STAGE_0_15, Integer.valueOf(10)), 11);
		...
		if (blockIn instanceof Kawara_Slab) {
			if (blockIn != JPBlock_Blocks.KAWARA_SH_purple) {

				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, JPBlock_Blocks.KAWARA_SH_purple.getDefaultState()
		...
		if (blockIn instanceof Plaster_Slab) {
			if (blockIn != JPBlock_Blocks.SHIKKUI_SH_purple) {

				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, JPBlock_Blocks.SHIKKUI_SH_purple.getDefaultState()
						.withProperty(BaseSlabWType2.CRA, stateIn.getValue(BaseSlabWType2.CRA))
						.withProperty(BaseSlabWType2.DOUBLE, stateIn.getValue(BaseSlabWType2.DOUBLE))
						.withProperty(BaseSlabWType2.HALF, stateIn.getValue(BaseSlabWType2.HALF)), 11);
		...
		if (blockIn instanceof Namako_Slab) {
			if (blockIn != JPBlock_Blocks.NAMAKO_SH_purple) {

				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_SH_purple.getDefaultState()
						.withProperty(BaseSlabWType2.CRA, stateIn.getValue(BaseSlabWType2.CRA))
						.withProperty(BaseSlabWType2.DOUBLE, stateIn.getValue(BaseSlabWType2.DOUBLE))
						.withProperty(BaseSlabWType2.HALF, stateIn.getValue(BaseSlabWType2.HALF)), 11);
		...
		if (blockIn instanceof NamakoB_Slab) {
			if (blockIn != JPBlock_Blocks.NAMAKOB_SH_purple) {

				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKOB_SH_purple.getDefaultState()
						.withProperty(BaseSlabWType2.CRA, stateIn.getValue(BaseSlabWType2.CRA))
						.withProperty(BaseSlabWType2.DOUBLE, stateIn.getValue(BaseSlabWType2.DOUBLE))
						.withProperty(BaseSlabWType2.HALF, stateIn.getValue(BaseSlabWType2.HALF)), 11);
		...
		if (blockIn instanceof Kawara_Stairs) {
			if (blockIn != JPBlock_Blocks.KAWARA_ST_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPBlock_Blocks.KAWARA_ST_purple.getDefaultState()
		...
		if (blockIn instanceof Plaster_Stairs) {
			if (blockIn != JPBlock_Blocks.SHIKKUI_ST_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPBlock_Blocks.SHIKKUI_ST_purple.getDefaultState()
						.withProperty(BlockStairs.FACING, stateIn.getValue(BlockStairs.FACING))
						.withProperty(BlockStairs.HALF, stateIn.getValue(BlockStairs.HALF))
						.withProperty(BlockStairs.SHAPE, stateIn.getValue(BlockStairs.SHAPE)), 11);
		...
		if (blockIn instanceof NamakoStairs) {
			if (blockIn != JPBlock_Blocks.NAMAKO_ST_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKO_ST_purple.getDefaultState()
						.withProperty(BlockStairs.FACING, stateIn.getValue(BlockStairs.FACING))
						.withProperty(BlockStairs.HALF, stateIn.getValue(BlockStairs.HALF))
						.withProperty(BlockStairs.SHAPE, stateIn.getValue(BlockStairs.SHAPE)), 11);
		...
		if (blockIn instanceof NamakoB_Stairs) {
			if (blockIn != JPBlock_Blocks.NAMAKOB_ST_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPBlock_Blocks.NAMAKOB_ST_purple.getDefaultState()
						.withProperty(BlockStairs.FACING, stateIn.getValue(BlockStairs.FACING))
						.withProperty(BlockStairs.HALF, stateIn.getValue(BlockStairs.HALF))
						.withProperty(BlockStairs.SHAPE, stateIn.getValue(BlockStairs.SHAPE)), 11);
		...
		if (blockIn instanceof CTruss) {
			if (blockIn != Harbor_Blocks.TRUSS_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, Harbor_Blocks.TRUSS_purple.getDefaultState()
		...
		if (blockIn instanceof CafeChair || blockIn instanceof Zabuton ||
			...
			if (stage != 10) {
				...
				worldIn.setBlockState(pos, stateIn.withProperty(CafeChair.STAGE_0_15, Integer.valueOf(10)), 11);
		...
		if (blockIn instanceof Andon_1 || blockIn instanceof Andon_2 ||
			...
			if (!(blockIn == Lamp_Blocks.ANDON_3 && stage == 3)) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof Lit_Andon_1 || blockIn instanceof Lit_Andon_2 ||
			...
			if (!(blockIn == Lamp_Blocks.LIT_ANDON_3 && stage == 3)) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof BaseSofa) {
			if (blockIn != Furniture_Blocks.SOFA_purple && blockIn != Furniture_Blocks.SOFA_leather) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, Furniture_Blocks.SOFA_purple.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof Zaisu) {
			if (blockIn != JPDeco_Blocks.ZAISU_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPDeco_Blocks.ZAISU_purple.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof BaseNoren) {
			if (blockIn != JPDeco_Blocks.NOREN_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPDeco_Blocks.NOREN_purple.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof BaseFuton) {
			if (blockIn != Futon_Blocks.FUTON_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, Futon_Blocks.FUTON_purple.getDefaultState()
		...
		if (blockIn instanceof Tatami_H) {
			if (blockIn != JPDeco_Blocks.TATAMI_H_purple && blockIn != JPDeco_Blocks.TATAMI_H) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPDeco_Blocks.TATAMI_H_purple.getDefaultState()
		...
		if (blockIn instanceof Tatami_HY) {
			if (blockIn != JPDeco_Blocks.TATAMI_HY_purple && blockIn != JPDeco_Blocks.TATAMI_HY) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, JPDeco_Blocks.TATAMI_HY_purple.getDefaultState()
						.withProperty(BaseFacingSlabW.H_FACING, stateIn.getValue(BaseFacingSlabW.H_FACING))
						.withProperty(BaseFacingSlabW.DOUBLE, stateIn.getValue(BaseFacingSlabW.DOUBLE))
						.withProperty(BaseFacingSlabW.HALF, stateIn.getValue(BaseFacingSlabW.HALF)), 11);
		...
		if (blockIn instanceof BaseMKasa) {
			if (blockIn != Garden_Blocks.KASA_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, Garden_Blocks.KASA_purple.getDefaultState(), 11);
		...
		if (blockIn instanceof BaseFusuma) {
			if (blockIn != Fusuma_Blocks.FUSUMA_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				if (stateIn.getValue(BaseFusuma.HALF) == BlockStateHalf.LOWER) {
					worldIn.setBlockState(pos, Fusuma_Blocks.FUSUMA_purple.getDefaultState()
					...
					worldIn.setBlockState(pos.up(), Fusuma_Blocks.FUSUMA_purple.getDefaultState()
							.withProperty(BaseFusuma.H_FACING, stateIn.getValue(BaseFusuma.H_FACING))
							.withProperty(BaseFusuma.OPEN, stateIn.getValue(BaseFusuma.OPEN))
							.withProperty(BaseFusuma.HINGE, upstate.getValue(BaseFusuma.HINGE))
							.withProperty(BaseFusuma.POWERED, upstate.getValue(BaseFusuma.POWERED))
				...
				if (stateIn.getValue(BaseFusuma.HALF) == BlockStateHalf.UPPER) {
					worldIn.setBlockState(pos, Fusuma_Blocks.FUSUMA_purple.getDefaultState()
							...
							.withProperty(BaseFusuma.HALF, BlockStateHalf.UPPER), 11);
					worldIn.setBlockState(pos.down(), Fusuma_Blocks.FUSUMA_purple.getDefaultState()
							.withProperty(BaseFusuma.H_FACING, downstate.getValue(BaseFusuma.H_FACING))
							.withProperty(BaseFusuma.OPEN, downstate.getValue(BaseFusuma.OPEN))
							.withProperty(BaseFusuma.HINGE, stateIn.getValue(BaseFusuma.HINGE))
							.withProperty(BaseFusuma.POWERED, stateIn.getValue(BaseFusuma.POWERED))
		...
		if (blockIn instanceof BaseFusuma_B) {
			if (blockIn != Fusuma_Blocks.FUSUMAB_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				if (stateIn.getValue(BaseFusuma_B.HALF) == BlockStateHalf.LOWER) {
					worldIn.setBlockState(pos, Fusuma_Blocks.FUSUMAB_purple.getDefaultState()
					...
					worldIn.setBlockState(pos.up(), Fusuma_Blocks.FUSUMAB_purple.getDefaultState()
							.withProperty(BaseFusuma_B.H_FACING, stateIn.getValue(BaseFusuma_B.H_FACING))
							.withProperty(BaseFusuma_B.OPEN, stateIn.getValue(BaseFusuma_B.OPEN))
							.withProperty(BaseFusuma_B.HINGE, upstate.getValue(BaseFusuma_B.HINGE))
							.withProperty(BaseFusuma_B.POWERED, upstate.getValue(BaseFusuma_B.POWERED))
				...
				if (stateIn.getValue(BaseFusuma_B.HALF) == BlockStateHalf.UPPER) {
					worldIn.setBlockState(pos, Fusuma_Blocks.FUSUMAB_purple.getDefaultState()
							...
							.withProperty(BaseFusuma_B.HALF, BlockStateHalf.UPPER), 11);
					worldIn.setBlockState(pos.down(), Fusuma_Blocks.FUSUMAB_purple.getDefaultState()
							.withProperty(BaseFusuma_B.H_FACING, downstate.getValue(BaseFusuma_B.H_FACING))
							.withProperty(BaseFusuma_B.OPEN, downstate.getValue(BaseFusuma_B.OPEN))
							.withProperty(BaseFusuma_B.HINGE, stateIn.getValue(BaseFusuma_B.HINGE))
							.withProperty(BaseFusuma_B.POWERED, stateIn.getValue(BaseFusuma_B.POWERED))
		...
		if (blockIn instanceof KamoiPlaster_Oak) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_o) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_purple_o.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
		...
		if (blockIn instanceof KamoiPlaster_Spruce) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_s) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_purple_s.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Birch) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_b) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_purple_b.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Jungle) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_j) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_purple_j.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Acacia) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_a) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_purple_a.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_DarkOak) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_d) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, KamoiShikkui_Blocks.KAMOI_purple_d.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, stateIn.getValue(BaseStage4_Face.H_FACING))
						.withProperty(BaseStage4_Face.STAGE_1_4, stateIn.getValue(BaseStage4_Face.STAGE_1_4)), 11);
		...
		if (blockIn instanceof KamoiPlaster_Sakura) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_saku) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof KamoiPlaster_Kaede) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_kae) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof KamoiPlaster_Ichoh) {
			if (blockIn != KamoiShikkui_Blocks.KAMOI_purple_ich) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
		...
		if (blockIn instanceof WP_clay_color) {
			if (blockIn != WallPane_Blocks.WP_CLAY_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPane_Blocks.WP_CLAY_purple.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof WP_glass_stained) {
			if (blockIn != WallPane_Blocks.WP_GLASS_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPane_Blocks.WP_GLASS_purple.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof WP_plaster) {
			if (blockIn != WallPaneJP_Blocks.WP_PLASTER_purple && blockIn != WallPaneJP_Blocks.WP_DIRTWALL) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPaneJP_Blocks.WP_PLASTER_purple.getDefaultState()
		...
		if (blockIn instanceof WP_namako) {
			if (blockIn != WallPaneJP_Blocks.WP_NAMAKO_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPaneJP_Blocks.WP_NAMAKO_purple.getDefaultState()
						.withProperty(BaseStage2_WP.H_FACING, stateIn.getValue(BaseStage2_WP.H_FACING))
						.withProperty(BaseStage2_WP.STAGE_1_2, stateIn.getValue(BaseStage2_WP.STAGE_1_2)), 11);
		...
		if (blockIn instanceof WP_namako_B) {
			if (blockIn != WallPaneJP_Blocks.WP_NAMAKOB_purple) {
				CMEvents.soundPaint(worldIn, playerIn, pos);

				worldIn.setBlockState(pos, WallPaneJP_Blocks.WP_NAMAKOB_purple.getDefaultState()
						.withProperty(BaseStage2_WP.H_FACING, stateIn.getValue(BaseStage2_WP.H_FACING))
						.withProperty(BaseStage2_WP.STAGE_1_2, stateIn.getValue(BaseStage2_WP.STAGE_1_2)), 11);
		...
		if (blockIn instanceof Wall_Plaster || blockIn instanceof Wall_PlasterCrash ||
			...
			if (color != 10) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, stateIn.withProperty(Base_Wall.STAGE_0_15, Integer.valueOf(10))
		...
		if (blockIn instanceof Wall_Kawara) {
			...
			if (color != 10) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, stateIn.withProperty(Base_WallKawara.STAGE_0_15, Integer.valueOf(10))
		...
		if (blockIn instanceof Wall_Sama) {
			if (blockIn != JPBlock_Blocks.SHIKKUI_SAMA_purple && blockIn != JPBlock_Blocks.DIRTWALL_SAMA) {
				CMEvents.soundPaint(worldIn, playerIn, pos);
				worldIn.setBlockState(pos, JPBlock_Blocks.SHIKKUI_SAMA_purple.getDefaultState()
