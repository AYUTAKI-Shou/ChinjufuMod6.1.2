...
public class ItemPresent_B extends ItemBlockBace {

	public ItemPresent_B() {
		super(Seasonal_Blocks.PRESENT_B);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Present_B.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Seasonal_Blocks.PRESENT_B, pos, false, facing, (Entity)null)) {

			if (k == 1) {
			/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Seasonal_Blocks.PRESENT_B.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
