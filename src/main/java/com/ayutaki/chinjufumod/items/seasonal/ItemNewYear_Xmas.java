...
public class ItemNewYear_Xmas extends ItemBlockBace {

	public ItemNewYear_Xmas() {
		super(Seasonal_Blocks.NEWYEAR_XMAS);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, NewYear_Xmas.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Seasonal_Blocks.NEWYEAR_XMAS, pos, false, facing, (Entity)null)) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		if (stack.getMetadata() == 1) { tooltip.add(I18n.format("tips.block_kadomatsu")); }
		if (stack.getMetadata() == 2) { tooltip.add(I18n.format("tips.block_kagamimochi")); }
	}
