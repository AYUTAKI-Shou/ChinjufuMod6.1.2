...
public class ItemLongtourou extends ItemBlockBace {

	public ItemLongtourou() {
		super(Garden_Blocks.LONGTOUROU_BOT);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Longtourou_Bottom.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Garden_Blocks.LONGTOUROU_BOT, pos, false, facing, (Entity)null)) {

			if (k == 1) {
				/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Garden_Blocks.LONGTOUROU_BOT.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, direction)
						.withProperty(BaseStage4_Face.STAGE_1_4, Integer.valueOf(1));
				IBlockState iblockstate2 = Garden_Blocks.LONGTOUROU_TOP.getDefaultState()
						.withProperty(BaseStage4_Face.H_FACING, direction)
						.withProperty(BaseStage4_Face.STAGE_1_4, Integer.valueOf(1));
