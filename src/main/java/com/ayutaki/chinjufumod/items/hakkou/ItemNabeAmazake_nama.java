...
public class ItemNabeAmazake_nama extends ItemBlockBace {

	public ItemNabeAmazake_nama() {
		super(Dish_Blocks.NABE_nama_2);
		setCreativeTab(ChinjufuModTabs.TEATIME);
		setUnlocalizedName("block_food_nabeaz_n");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_food_nabeaz_n"));
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Dish_Blocks.NABE_nama_2, pos, false, facing, (Entity)null)) {
			...
			/** 設置するブロックのクラス **/
			IBlockState iblockstate1 = Dish_Blocks.NABE_nama_2.getDefaultState()
					.withProperty(BlockBeseNabe.H_FACING, direction)
					.withProperty(BlockBeseNabe.STAGE_1_4, Integer.valueOf(4));
