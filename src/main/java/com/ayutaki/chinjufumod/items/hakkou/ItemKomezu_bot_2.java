...
public class ItemKomezu_bot_2 extends ItemBlockBace {

	public ItemKomezu_bot_2() {
		super(Hakkou_Blocks.KOMEZU_bot);
		setUnlocalizedName("block_komezu_bot_2");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_komezu_bot_2"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Hakkou_Blocks.KOMEZU_bot, pos, false, facing, (Entity)null)) {
			...
			IBlockState iblockstate1 = Hakkou_Blocks.KOMEZU_bot.getDefaultState()
					...
					.withProperty(Bin_Komezu.STAGE_1_2, Integer.valueOf(2));
