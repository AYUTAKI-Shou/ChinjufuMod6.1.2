...
public class ItemDashi_bot_4 extends ItemBlockBace {

	public ItemDashi_bot_4() {
		super(Hakkou_Blocks.DASHI_bot);
		setUnlocalizedName("block_dashi_bot_4");
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, "block_dashi_bot_4"));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Hakkou_Blocks.DASHI_bot, pos, false, facing, (Entity)null)) {
			...
			IBlockState iblockstate1 = Hakkou_Blocks.DASHI_bot.getDefaultState()
					...
					.withProperty(Bin_Dashi.STAGE_1_4, Integer.valueOf(4));
