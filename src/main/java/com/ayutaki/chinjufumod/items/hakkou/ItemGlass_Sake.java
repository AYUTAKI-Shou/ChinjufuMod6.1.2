...
public class ItemGlass_Sake extends ItemBlockBace {

	public ItemGlass_Sake() {
		super(Hakkou_Blocks.SAKEGLASS);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Glass_Sake.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && facing == EnumFacing.UP && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn
			...
			if (k == 1) {
				/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Hakkou_Blocks.SAKEGLASS.getDefaultState().withProperty(Glass_Sake.STAGE_1_15, Integer.valueOf(1));
				worldIn.setBlockState(pos, iblockstate1, 10); }
			if (k == 2) {
				IBlockState iblockstate1 = Hakkou_Blocks.SAKEGLASS.getDefaultState().withProperty(Glass_Sake.STAGE_1_15, Integer.valueOf(4));
				worldIn.setBlockState(pos, iblockstate1, 10); }
			if (k == 3) {
				IBlockState iblockstate1 = Hakkou_Blocks.SAKEGLASS.getDefaultState().withProperty(Glass_Sake.STAGE_1_15, Integer.valueOf(7));
				worldIn.setBlockState(pos, iblockstate1, 10); }
			if (k == 4) {
				IBlockState iblockstate1 = Hakkou_Blocks.WINEGLASS.getDefaultState().withProperty(Glass_Wine.STAGE_1_15, Integer.valueOf(13));
				worldIn.setBlockState(pos, iblockstate1, 10); }
