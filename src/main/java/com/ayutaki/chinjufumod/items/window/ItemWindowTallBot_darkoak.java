...
public class ItemWindowTallBot_darkoak extends ItemBaseWindowTall_Bot {

	public ItemWindowTallBot_darkoak() {
		super(Window_Blocks.WINDOWTALLBOT_darkoak);
		setUnlocalizedName(WindowTallBot_darkoak.ID);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, WindowTallBot_darkoak.ID));
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Window_Blocks.WINDOWTALLBOT_darkoak, pos, false, facing, (Entity)null)) {

			/** 設置するブロックのクラス **/
			IBlockState iblockstate1 = Window_Blocks.WINDOWTALLBOT_darkoak.getDefaultState()
					.withProperty(BaseWindowTall_Bottom.H_FACING, direction)
					.withProperty(BaseWindowTall_Bottom.STAGE_1_3, Integer.valueOf(1));
			IBlockState iblockstate2 = Window_Blocks.WINDOWTALLTOP_darkoak.getDefaultState()
