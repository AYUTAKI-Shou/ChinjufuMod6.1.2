...
public class ItemWindowTallBot_birch extends ItemBaseWindowTall_Bot {

	public ItemWindowTallBot_birch() {
		super(Window_Blocks.WINDOWTALLBOT_birch);
		setUnlocalizedName(WindowTallBot_birch.ID);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, WindowTallBot_birch.ID));
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Window_Blocks.WINDOWTALLBOT_birch, pos, false, facing, (Entity)null)) {

			/** 設置するブロックのクラス **/
			IBlockState iblockstate1 = Window_Blocks.WINDOWTALLBOT_birch.getDefaultState()
					.withProperty(BaseWindowTall_Bottom.H_FACING, direction)
					.withProperty(BaseWindowTall_Bottom.STAGE_1_3, Integer.valueOf(1));
			IBlockState iblockstate2 = Window_Blocks.WINDOWTALLTOP_birch.getDefaultState()
