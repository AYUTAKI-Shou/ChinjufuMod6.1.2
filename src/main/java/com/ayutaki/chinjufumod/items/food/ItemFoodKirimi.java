...
public class ItemFoodKirimi extends ItemFood {

	public ItemFoodKirimi(String unlocalizedName, int amount, float saturation, boolean isWolfFood) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.item_food_kirimi", meta));
	}
