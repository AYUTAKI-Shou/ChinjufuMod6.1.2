...
public class ItemAndon_3 extends ItemBlockBace {

	public ItemAndon_3() {
		super(Lamp_Blocks.ANDON_3);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Andon_3.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Lamp_Blocks.ANDON_3, pos, false, facing, (Entity)null)) {

			if (k == 1) {
			/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Lamp_Blocks.ANDON_3.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
