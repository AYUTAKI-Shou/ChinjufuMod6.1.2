...
public class ItemAndon_4 extends ItemBlockBace {

	public ItemAndon_4() {
		super(Lamp_Blocks.ANDON_4);
		setRegistryName(new ResourceLocation(ChinjufuMod.MOD_ID, Andon_4.ID));
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!itemstack.isEmpty() && playerIn.canPlayerEdit(pos, facing, itemstack) && worldIn.mayPlace(Lamp_Blocks.ANDON_4, pos, false, facing, (Entity)null)) {

			if (k == 1) {
			/** 設置するブロックのクラス **/
				IBlockState iblockstate1 = Lamp_Blocks.ANDON_4.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
