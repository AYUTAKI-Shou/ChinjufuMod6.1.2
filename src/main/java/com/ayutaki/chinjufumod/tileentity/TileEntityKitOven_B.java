...
public class TileEntityKitOven_B extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				Kitchen_Oven_B.setState(this.isBurning(), this.world, this.pos);
			}
		}
