...
@OnlyIn(Dist.CLIENT)
public class IchohParticle extends SpriteTexturedParticle {

	private final float rotSpeed;

	private IchohParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn,
	...
	public static class Factory implements IParticleFactory<BasicParticleType> {
		...
		public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z,
			...
			IchohParticle particle = new IchohParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
