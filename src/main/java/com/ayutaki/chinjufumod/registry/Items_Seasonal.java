...
import com.ayutaki.chinjufumod.items.armor.SantaCos;
import com.ayutaki.chinjufumod.items.armor.Yukata;
...
public class Items_Seasonal {
	...
	public static Item SAKURA_slabhalf = register("block_slabhalf_sakura", new Seasonal_noFuel(Wood_Blocks.SAKURA_slabhalf, new Item.Properties()));
	public static Item KAEDE_slabhalf = register("block_slabhalf_kaede", new Seasonal_noFuel(Wood_Blocks.KAEDE_slabhalf, new Item.Properties()));
	public static Item ICHOH_slabhalf = register("block_slabhalf_ichoh", new Seasonal_noFuel(Wood_Blocks.ICHOH_slabhalf, new Item.Properties()));
