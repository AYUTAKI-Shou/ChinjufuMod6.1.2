...
public class JPBlock_Blocks {
	...
	public static void init() {
		...
		DUMMY = new Dummy().setRegistryName("block_dummy_jp").setUnlocalizedName("block_dummy_jp");

		KAWARA = new Kawara();
		KAWARA_CR = new Kawara_Crash();
		...
		NAMAKO_ST_white = new NamakoStairs("block_nst_white", DUMMY.getDefaultState());
		NAMAKO_ST_orange = new NamakoStairs("block_nst_orange", DUMMY.getDefaultState());
		NAMAKO_ST_magenta = new NamakoStairs("block_nst_magenta", DUMMY.getDefaultState());
		NAMAKO_ST_lightb = new NamakoStairs("block_nst_lightb", DUMMY.getDefaultState());
		NAMAKO_ST_yellow = new NamakoStairs("block_nst_yellow", DUMMY.getDefaultState());
		NAMAKO_ST_lime = new NamakoStairs("block_nst_lime", DUMMY.getDefaultState());
		NAMAKO_ST_pink = new NamakoStairs("block_nst_pink", DUMMY.getDefaultState());
		NAMAKO_ST_gray = new NamakoStairs("block_nst_gray", DUMMY.getDefaultState());
		NAMAKO_ST_lightg = new NamakoStairs("block_nst_lightg", DUMMY.getDefaultState());
		NAMAKO_ST_cyan = new NamakoStairs("block_nst_cyan", DUMMY.getDefaultState());
		NAMAKO_ST_purple = new NamakoStairs("block_nst_purple", DUMMY.getDefaultState());
		NAMAKO_ST_blue = new NamakoStairs("block_nst_blue", DUMMY.getDefaultState());
		NAMAKO_ST_brown = new NamakoStairs("block_nst_brown", DUMMY.getDefaultState());
		NAMAKO_ST_green = new NamakoStairs("block_nst_green", DUMMY.getDefaultState());
		NAMAKO_ST_red = new NamakoStairs("block_nst_red", DUMMY.getDefaultState());
		NAMAKO_ST_black = new NamakoStairs("block_nst_black", DUMMY.getDefaultState());

		NAMAKOB = new NamakoB();
		NAMAKOB_CR = new NamakoB_Crash();
		...
		DIRTWALL_WALL = new Wall_DirtWall();
		SHIKKUI_WALL = new Wall_Plaster();
		SHIKKUI_WALL_CR = new Wall_PlasterCrash();
		NAMAKO_WALL = new Wall_Namako();
		NAMAKO_WALL_CR = new Wall_NamakoCrash();
		NAMAKOB_WALL = new Wall_NamakoB();
		NAMAKOB_WALL_CR = new Wall_NamakoBCrash();
