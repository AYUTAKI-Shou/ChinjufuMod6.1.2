...
public class Items_ArmorMaterial {
	...
	public static ArmorMaterial RJ = EnumHelper
			.addArmorMaterial("RJ", "chinjufumod:ryujou", 21, new int[] { 2, 6, 7, 3 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0);
	...
	public static ArmorMaterial KAGA = EnumHelper
			.addArmorMaterial("KAGA", "chinjufumod:kaga", 30, new int[] { 2, 6, 7, 2 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1);
