...
public class WallBrick_Blocks {
	...
	public static void init() {
		...
		DUMMY = new Dummy().setRegistryName("block_dummy").setUnlocalizedName("block_dummy");
		...
		BRICK_STONE_PIL = new Stone_Pillar().setRegistryName("block_brick_stone_pil_c").setUnlocalizedName("block_brick_stone_pil_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		BRICK_GRA_PIL = new Stone_Pillar().setRegistryName("block_brick_gra_pil_c").setUnlocalizedName("block_brick_gra_pil_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		BRICK_DIO_PIL = new Stone_Pillar().setRegistryName("block_brick_dio_pil_c").setUnlocalizedName("block_brick_dio_pil_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		BRICK_AND_PIL = new Stone_Pillar().setRegistryName("block_brick_and_pil_c").setUnlocalizedName("block_brick_and_pil_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);

		PILLAR_oak = new BlockPlank_Pillar().setRegistryName("block_pillar_oak_c").setUnlocalizedName("block_pillar_oak_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLAR_spru = new BlockPlank_Pillar().setRegistryName("block_pillar_spru_c").setUnlocalizedName("block_pillar_spru_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLAR_bir = new BlockPlank_Pillar().setRegistryName("block_pillar_bir_c").setUnlocalizedName("block_pillar_bir_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLAR_jun = new BlockPlank_Pillar().setRegistryName("block_pillar_jun_c").setUnlocalizedName("block_pillar_jun_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLAR_aca = new BlockPlank_Pillar().setRegistryName("block_pillar_aca_c").setUnlocalizedName("block_pillar_aca_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLAR_doak = new BlockPlank_Pillar().setRegistryName("block_pillar_doak_c").setUnlocalizedName("block_pillar_doak_c").setCreativeTab(ChinjufuModTabs.WALLPANEL);

		PILLARSLAB_oak = new Kamoi_Oak(Material.WOOD, "block_kamoi_oak").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLARSLAB_spru = new Kamoi_Spruce(Material.WOOD, "block_kamoi_spruce").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLARSLAB_bir = new Kamoi_Birch(Material.WOOD, "block_kamoi_birch").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLARSLAB_jun = new Kamoi_Jungle(Material.WOOD, "block_kamoi_jungle").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLARSLAB_aca = new Kamoi_Acacia(Material.WOOD, "block_kamoi_acacia").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		PILLARSLAB_doak = new Kamoi_DarkOak(Material.WOOD, "block_kamoi_darkoak").setCreativeTab(ChinjufuModTabs.WALLPANEL);
