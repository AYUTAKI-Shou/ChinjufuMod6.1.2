...
public class EntityTypes_CM {
	...
	public static EntityType<KK_Type97Entity> TYPE97 = register("type97", EntityType.Builder.<KK_Type97Entity>create(KK_Type97Entity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_Type97Entity2> TYPE97_2 = register("type97_2", EntityType.Builder.<KK_Type97Entity2>create(KK_Type97Entity2::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_Type97Entity3> TYPE97_3 = register("type97_3", EntityType.Builder.<KK_Type97Entity3>create(KK_Type97Entity3::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_Type97Entity4> TYPE97_4 = register("type97_4", EntityType.Builder.<KK_Type97Entity4>create(KK_Type97Entity4::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	...
	public static EntityType<KK_TenzanEntity> TENZAN = register("tenzan", EntityType.Builder.<KK_TenzanEntity>create(KK_TenzanEntity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_TenzanEntity2> TENZAN2 = register("tenzan2", EntityType.Builder.<KK_TenzanEntity2>create(KK_TenzanEntity2::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_TenzanEntity3> TENZAN3 = register("tenzan3", EntityType.Builder.<KK_TenzanEntity3>create(KK_TenzanEntity3::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_TenzanEntity4> TENZAN4 = register("tenzan4", EntityType.Builder.<KK_TenzanEntity4>create(KK_TenzanEntity4::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	...
	public static EntityType<KK_RyuseiEntity> RYUSEI = register("ryusei", EntityType.Builder.<KK_RyuseiEntity>create(KK_RyuseiEntity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_RyuseiEntity2> RYUSEI2 = register("ryusei2", EntityType.Builder.<KK_RyuseiEntity2>create(KK_RyuseiEntity2::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_RyuseiEntity3> RYUSEI3 = register("ryusei3", EntityType.Builder.<KK_RyuseiEntity3>create(KK_RyuseiEntity3::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_RyuseiEntity4> RYUSEI4 = register("ryusei4", EntityType.Builder.<KK_RyuseiEntity4>create(KK_RyuseiEntity4::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	
	public static EntityType<KK_Ju87Entity> JU87 = register("ju87", EntityType.Builder.<KK_Ju87Entity>create(KK_Ju87Entity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_Ju87Entity2> JU87_2 = register("ju87_2", EntityType.Builder.<KK_Ju87Entity2>create(KK_Ju87Entity2::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_Ju87Entity3> JU87_3 = register("ju87_3", EntityType.Builder.<KK_Ju87Entity3>create(KK_Ju87Entity3::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_Ju87Entity4> JU87_4 = register("ju87_4", EntityType.Builder.<KK_Ju87Entity4>create(KK_Ju87Entity4::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	...
	public static EntityType<KK_TBFEntity> TBF = register("tbf", EntityType.Builder.<KK_TBFEntity>create(KK_TBFEntity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_TBFEntity2> TBF2 = register("tbf2", EntityType.Builder.<KK_TBFEntity2>create(KK_TBFEntity2::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_TBFEntity3> TBF3 = register("tbf3", EntityType.Builder.<KK_TBFEntity3>create(KK_TBFEntity3::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_TBFEntity4> TBF4 = register("tbf4", EntityType.Builder.<KK_TBFEntity4>create(KK_TBFEntity4::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	...
	public static EntityType<KK_SwordfishEntity> SWORDFISH = register("swordfish", EntityType.Builder.<KK_SwordfishEntity>create(KK_SwordfishEntity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_SwordfishEntity2> SWORDFISH2 = register("swordfish2", EntityType.Builder.<KK_SwordfishEntity2>create(KK_SwordfishEntity2::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_SwordfishEntity3> SWORDFISH3 = register("swordfish3", EntityType.Builder.<KK_SwordfishEntity3>create(KK_SwordfishEntity3::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<KK_SwordfishEntity4> SWORDFISH4 = register("swordfish4", EntityType.Builder.<KK_SwordfishEntity4>create(KK_SwordfishEntity4::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	...
	public static EntityType<Gyorai61cmEntity2> GYORAI61_2 = register("gyorai2", EntityType.Builder.<Gyorai61cmEntity2>create(Gyorai61cmEntity2::new, EntityClassification.MISC)
			.size(1.0F, 1.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<Gyorai61cmEntity3> GYORAI61_3 = register("gyorai3", EntityType.Builder.<Gyorai61cmEntity3>create(Gyorai61cmEntity3::new, EntityClassification.MISC)
			.size(1.0F, 1.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<Gyorai61cmEntity4> GYORAI61_4 = register("gyorai4", EntityType.Builder.<Gyorai61cmEntity4>create(Gyorai61cmEntity4::new, EntityClassification.MISC)
			.size(1.0F, 1.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
