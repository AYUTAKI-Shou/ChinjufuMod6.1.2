...
public class SmeltingRecipe_CM {
	...
	public static void register() {
		...
		/*生酒の火入れ*/
		GameRegistry.addSmelting(Items_Teatime.NAMASAKEBOT, new ItemStack(Items_Teatime.SHINSAKEBOT, 1), 0.5F);
		...
		/* ピザ */
		GameRegistry.addSmelting(new ItemStack(Items_Teatime.KOMUGI, 1, 8), new ItemStack(Items_Teatime.PIZZA), 0.1F);
