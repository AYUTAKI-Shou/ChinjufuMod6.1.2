...
public class CMEvents {
	...
	public static void soundKKBreak(World worldIn, PlayerEntity playerIn) {
		worldIn.playSound(null, playerIn.getPosX(), playerIn.getPosY(), playerIn.getPosZ(), SoundEvents.ENTITY_ITEM_BREAK, SoundCategory.MASTER, 1.0F, 1.0F); }
	
	public static void textKKError(World worldIn, PlayerEntity playerIn) {
		worldIn.playSound(null, playerIn.getPosX(), playerIn.getPosY(), playerIn.getPosZ(), SoundEvents_CM.ERROR, SoundCategory.MASTER, 1.0F, 1.0F);
	...
	public static void soundChisel(IWorld iworld, PlayerEntity playerIn, BlockPos blockpos) {
		iworld.playSound(playerIn, blockpos, SoundEvents.BLOCK_STONE_BREAK, SoundCategory.BLOCKS, 1.0F, 0.8F); }
