...
public class RenderTypes_CM {
	...
	public static void register() {
		...
		RenderTypeLookup.setRenderLayer(ChinjufuModBlocks.WAKE_WATER3, cutout);
		...
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_SAKENAMA, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_SAKE, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_SAKEJUKU, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_CIDER, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_CIDERJUKU, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_WINE, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_WINEJUKU, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_MEAD, trans);
		RenderTypeLookup.setRenderLayer(Kitchen_Blocks.KIT_MEADJUKU, trans);
