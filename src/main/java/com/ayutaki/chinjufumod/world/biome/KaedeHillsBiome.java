...
public class KaedeHillsBiome extends Biome {

	public KaedeHillsBiome() {
		...
		/* 木 */
		Features_CM.addKaedeandOakHills(this);
		...
		/** 高所のため豚は半減 **/
		this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(EntityType.PIG, 5, 4, 4));
		...
		this.addSpawn(EntityClassification.MONSTER, new Biome.SpawnListEntry(EntityType.CREEPER, 35, 4, 4));
		this.addSpawn(EntityClassification.MONSTER, new Biome.SpawnListEntry(EntityType.ENDERMAN, 7, 1, 4));
		this.addSpawn(EntityClassification.MONSTER, new Biome.SpawnListEntry(EntityType.WITCH, 3, 1, 1));
